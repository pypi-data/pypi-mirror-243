...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_7 = QtWidgets.QLabel(parent=self.previewDelayWidget)
        self.label_7.setObjectName("label_7")
        self.previewDelayBox.addWidget(self.label_7)
        self.previewDelay = QtWidgets.QSpinBox(parent=self.previewDelayWidget)
        ...
        self.steps = QtWidgets.QLineEdit(parent=self.groupBox_2)
        ...
        self.stepsOn = QtWidgets.QCheckBox(parent=self.groupBox_2)
        self.stepsOn.setObjectName("stepsOn")
        self.gridLayout_2.addWidget(self.stepsOn, 3, 0, 1, 1, QtCore.Qt.AlignmentFlag.AlignLeft)
        self.allow_empty = QtWidgets.QCheckBox(parent=self.groupBox_2)
        self.allow_empty.setObjectName("allow_empty")
        self.gridLayout_2.addWidget(self.allow_empty, 5, 0, 1, 1, QtCore.Qt.AlignmentFlag.AlignLeft)
