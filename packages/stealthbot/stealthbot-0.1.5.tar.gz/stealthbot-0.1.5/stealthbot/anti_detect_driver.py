...
class StealthDriver(webdriver.Chrome):
    ...
    def get_json_from_page(self):
        try:
            # Cerca un'occorrenza di una stringa JSON nel page_source
            # Assumiamo che il JSON sia racchiuso tra parentesi graffe
            # print page_source
            json_data = re.sub(r'<[^>]*>', '', self.page_source)
