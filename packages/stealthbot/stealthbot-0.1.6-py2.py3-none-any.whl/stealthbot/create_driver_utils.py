...
def do_create_driver(tiny_profile, profile, window_size, user_agent, proxy, is_eager, headless, lang, block_images,
                     beep):
    ...
    about = AboutBrowser(window_size=driver_attributes['window_size'], user_agent=driver_attributes['user_agent'],
                         profile=driver_attributes['profile'], proxy=proxy, lang=lang, beep=beep, is_new=True)
    driver.about = about
