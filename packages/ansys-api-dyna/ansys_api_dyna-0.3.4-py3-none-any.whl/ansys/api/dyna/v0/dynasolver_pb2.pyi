...
class DynaSolverStartLocal(google.protobuf.message.Message):
    ...
    PRSET_FIELD_NUMBER: builtins.int
    exename: builtins.bytes = ...
    input: builtins.bytes = ...
    nproc: builtins.int = ...
    memory: builtins.int = ...
    prset: builtins.bytes = ...
    def __init__(self,
        *,
        exename : builtins.bytes = ...,
        input : builtins.bytes = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["exename",b"exename","input",b"input","memory",b"memory","nproc",b"nproc","prset",b"prset"]) -> None: ...
