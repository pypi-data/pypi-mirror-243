...
class PromptTuner:
    ...
    _wml_training_metadata: dict = None
    ...
    def run(self,
        ...
        **Example**
        ...
        self._initialize_wml_training_metadata(training_data_references, test_data_references=None,
                                               training_results_reference=training_results_reference)

        tuning_details = self._client.training.run(meta_props=self._wml_training_metadata, asynchronous=background_mode)
    ...
    def _initialize_wml_training_metadata(self,
        ...
        if test_data_references:
            self._wml_training_metadata[self._client.training.ConfigurationMetaNames.TEST_DATA_REFERENCES] = [
    ...
    def get_params(self) -> dict:
        ...
        **Example**
        .. code-block:: python
            ...
            experiment = TuneExperiment(wml_credentials, ...)
            prompt_tuner = experiment.prompt_tuner(...)
