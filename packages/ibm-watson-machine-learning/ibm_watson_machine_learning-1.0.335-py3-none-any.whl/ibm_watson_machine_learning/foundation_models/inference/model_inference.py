...
class ModelInference(BaseModelInference):
    ...
    **Example**
    ...
    def generate(self,
        ...
        :param guardrails: If True then potentially hateful, abusive, and/or profane language (HAP) detection and Personally Identifiable Information (PII) 
                           filter are toggle on for both prompt and generated text, defaults to False
        ...
        :param guardrails_pii_params: meta props for PII moderations, use ``ibm_watson_machine_learning.metanames.GenTextModerationsMetaNames().show()``
                                      to view the list of MetaNames
        :type params: dict
