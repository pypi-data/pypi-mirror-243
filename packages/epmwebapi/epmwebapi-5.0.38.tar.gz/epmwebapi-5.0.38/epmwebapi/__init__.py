...
Copyright © 2018 **Elipse Software**.
Distributed under the MIT License. Please check the accompanying file LICENSE.txt or a copy at http://opensource.org/licenses/MIT.
"""
