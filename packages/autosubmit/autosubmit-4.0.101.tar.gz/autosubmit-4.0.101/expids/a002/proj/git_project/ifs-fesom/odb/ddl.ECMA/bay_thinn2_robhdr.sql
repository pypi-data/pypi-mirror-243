//
//-- ODB/SQL file 'bay_thinn2_robhdr.sql'
//
...
CREATE VIEW bay_thinn2_robhdr AS
  ...
  WHERE  (obstype@hdr == 7)
    AND  (report_status.passive@hdr + report_status.rejected@hdr + report_status.blacklisted@hdr == 0)
