...
//   1     2    3     4
  obsvalue, fg_depar, an_depar, fc_depar@fcdiagnostic_body[1], fc_depar@fcdiagnostic_body[2], obs_error,
//   5        6          7          8         9   
  fg_error, hires@update[min(10,$nmxupd)], 
//   10              11               12
...
// --------- Auxiliary part of sql request (only used in odbread.F90)
  radcurv@gnssro, retrtype
//   29      30
FROM hdr, modsurf, gnssro, sat, body, update[min(10,$nmxupd)], errstat, fcdiagnostic, fcdiagnostic_body[1:2]
WHERE (($body_max == -1) OR
