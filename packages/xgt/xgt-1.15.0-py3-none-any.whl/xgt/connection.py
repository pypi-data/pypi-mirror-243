...
class Connection(object):
  ...
  def __init__(self, host='127.0.0.1', port=4367, flags=None,
               auth = NoAuth(), default_namespace = 'default'):
    """
  ...
  def _arrow_init_helper(self, host, port):
    ...
    if (self.ssl):
      ...
      if (self.ssl_use_mtls):
        client_key = open(self.ssl_root_dir + '/private/client.key.pem',
                          'rb').read()
        client_cert = open(self.ssl_root_dir + '/certs/client.cert.pem',
                           'rb').read()
  ...
  def get_frames(self,names=None, namespace=None, frame_type=None):
    """
  ...
  def create_table_frame(self, name, schema, frame_labels = None,
    ...
    frame_labels : dictionary
      ...
      By default, no labels are required.
    row_label_universe :  array
      An array of all possible labels to be used for rows inside this table
      frame.
      A maximum of 128 labels are supported for rows in each frame.
      By default, no row labels are required.
    attempts : int
  ...
  def create_vertex_frame(self, name, schema, key, frame_labels = None,
    ...
    frame_labels : dictionary
      ...
      By default, no labels are required.
    row_label_universe :  array
      An array of all possible labels to be used for rows inside this vertex
      frame.
      A maximum of 128 labels are supported for rows in each frame.
      By default, no row labels are required.
    attempts : int
  ...
  def create_edge_frame(self, name, schema, source, target, source_key,
    ...
    frame_labels : dictionary
      ...
      By default, no labels are required.
    row_label_universe :  array
      An array of all possible labels to be used for rows inside this edge
  ...
  def drop_frames(self, frames, attempts = 10):
    """
    Drop a VertexFrame, EdgeFrame, or TableFrame.
