...
def  create_parser():
    ...
    parser_complete_workflow.add_argument("assembly", type=str, help="Path to the assembly file.")
    parser_complete_workflow.add_argument("pileup", type=str, help="Path to the modkit pileup file.")
    parser_complete_workflow.add_argument("bins", type=str, help="Path file specifying which bin contigs belong. (two column tsv: contig, bin)")
    parser_complete_workflow.add_argument("output", type=str, help="Path to the output file.")
