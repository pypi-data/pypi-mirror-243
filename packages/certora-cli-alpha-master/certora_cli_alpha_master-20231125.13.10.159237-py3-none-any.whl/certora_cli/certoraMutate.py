...
def get_dir_from_certora_internal(_dir: str) -> Path:
    return Path(CERTORA_INTERNAL_ROOT) / _dir
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--applied_mutants_dir",
...
class CertoraMutate:
    def __init__(self, args: argparse.Namespace):
        ...
        self.applied_mutants_dir = args.applied_mutants_dir
    ...
    def validate_empty_directories(self) -> None:
        ...
        if self.applied_mutants_dir:
            self.applied_mutants_dir = get_dir_from_certora_internal(self.applied_mutants_dir)
            validate_non_existent_dir(self.applied_mutants_dir, "applied mutations directory")
        else:
