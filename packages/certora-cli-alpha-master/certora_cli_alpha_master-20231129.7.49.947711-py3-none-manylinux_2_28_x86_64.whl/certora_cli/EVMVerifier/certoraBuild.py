    ...
    def collect_for_file(self,
        ...
        if not is_vyper:
            ...
            if self.context.packages is not None:
                remappings = self.context.packages
        ...
        for error in standard_json_data.get("errors", []):
            ...
            if error.get("severity", None) == "error":
                ...
                if 'errorCode' in error and error['errorCode'] == '6275':  # 6275 the error code of solc compiler for missing file
            ...
            for idx, orig_file in srclist.items():
                ...
                if new_path is None:
                    ...
                    if (orig_file == file_abs_path and
                       (Util.get_certora_sources_dir() / build_arg_contract_file).exists()):
