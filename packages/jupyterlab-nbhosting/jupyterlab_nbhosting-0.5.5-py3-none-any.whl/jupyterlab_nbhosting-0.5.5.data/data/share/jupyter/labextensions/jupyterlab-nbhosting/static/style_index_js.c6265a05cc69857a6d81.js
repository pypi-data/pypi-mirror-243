...
`, "",{"version":3,"sources":["webpack://./style/base.css"],"names":[],"mappings":"AAAA;;;CAGC;;AAED;EACE,8BAA8B;EAC9B,2BAA2B;EAC3B,8BAA8B;AAChC;;AAEA;;;CAGC;AACD;EACE,wBAAwB;AAC1B;;AAEA,wCAAwC;AACxC;EACE,yCAAyC;AAC3C;;AAEA;EACE,0CAA0C;AAC5C;;AAEA;EACE,0CAA0C;AAC5C;;AAEA;EACE,yCAAyC;AAC3C;;AAEA;;;;CAIC;AACD;EACE,aAAa;AACf;;AAEA;;;;;CAKC;AACD;EACE,WAAW;EACX,aAAa;EACb,sBAAsB;EACtB,oBAAoB;AACtB;;AAEA;EACE,yCAAyC;;EAEzC;IACE,6BAA6B;EAC/B;AACF;;AAEA;;EAEE,wCAAwC;;EAExC;IACE,4BAA4B;EAC9B;;EAEA,kDAAkD;EAClD,YAAY;;EAEZ;IACE,SAAS;EACX;;EAEA;IACE,aAAa;IACb,iBAAiB;IACjB,6BAA6B;;IAE7B;MACE,aAAa;IACf;EACF;;EAEA;;;;;;GAMC;EACD;IACE,8CAA8C;IAC9C,6BAA6B;EAC/B;AACF;;AAEA;EACE,uCAAuC;;EAEvC;IACE,2BAA2B;EAC7B;;EAEA,YAAY;;EAEZ;IACE,SAAS;EACX;;EAEA;IACE,aAAa;IACb,iBAAiB;IACjB,6BAA6B;;IAE7B;MACE,aAAa;IACf;EACF;;EAEA;IACE,yCAAyC;IACzC,4BAA4B;EAC9B;AACF;;AAEA;;;CAGC;AACD;EACE,mBAAmB;AACrB;;AAEA;EACE,gCAAgC;;EAEhC;IACE,iBAAiB;EACnB;;EAEA;IACE,iBAAiB;EACnB;;EAEA;IACE,8BAA8B;IAC9B,kBAAkB;EACpB;;EAEA;IACE,kBAAkB;IAClB,iBAAiB;IACjB,8BAA8B;EAChC;AACF","sourcesContent":["/*\n    See the JupyterLab Developer Guide for useful CSS Patterns:\n    https://jupyterlab.readthedocs.io/en/stable/developer/css.html\n*/\n\nbody {\n  --nbh-menubar-color: aliceblue;\n  --nbh-topbar-color: #e0e9f2;\n  --nbh-trusted-color: aliceblue;\n}\n\n/*\n\n  ---------- header ----------\n*/\n.jp-WindowedPanel-inner {\n  margin-top: 0 !important;\n}\n\n/* set color for the 2 remaining lines */\n#menu-panel-wrapper > * {\n  background-color: var(--nbh-topbar-color);\n}\n\n#jp-MainMenu {\n  background-color: var(--nbh-menubar-color);\n}\n\nbutton.jp-NotebookTrustedStatus {\n  background-color: var(--nbh-trusted-color);\n}\n\n.jp-Toolbar.jp-NotebookPanel-toolbar {\n  background-color: var(--nbh-topbar-color);\n}\n\n/*\n  kernel switcher\n  there may be a smarter way to do this,\n  see the jupterlab gitter and schema/plugin.json.kernelname\n*/\n.jp-Toolbar-item.jp-KernelName {\n  display: none;\n}\n\n/*\n\n  ---------- execution indicator ----------\n  the  is the bottom right widget in the header\n  we use this to make it conspicuous when the kernel is down\n*/\n.jp-Notebook-ExecutionIndicator {\n  width: 32px;\n  display: flex;\n  flex-direction: column;\n  align-items: stretch;\n}\n\n.jp-Notebook-ExecutionIndicator[data-status='idle'] {\n  background-color: var(--jp-accent-color0);\n\n  & circle {\n    fill: var(--jp-accent-color3);\n  }\n}\n\n.jp-Notebook-ExecutionIndicator[data-status='disconnected'],\n.jp-Notebook-ExecutionIndicator[data-status='connecting'] {\n  background-color: var(--jp-error-color1);\n\n  & circle {\n    fill: var(--jp-error-color3);\n  }\n\n  /* add a more explicit label when kernel is down */\n  width: 250px;\n\n  & svg {\n    margin: 0;\n  }\n\n  & :first-child {\n    display: flex;\n    flex-wrap: nowrap;\n    justify-content: space-around;\n\n    & > svg {\n      stroke: black;\n    }\n  }\n\n  /* without the > here, things are a little off\n     what I mean id to add an after on the first child\n     of the element with the data-status attribute above\n     BUT\n     without > it will add an after on ANY first child\n     inside the hierarchy\n  */\n  & > :first-child::after {\n    content: 'Kernel is down, reload your page !!';\n    color: var(--jp-error-color3);\n  }\n}\n\n.jp-Notebook-ExecutionIndicator[data-status='busy'] {\n  background-color: var(--jp-warn-color1);\n\n  & path {\n    fill: var(--jp-warn-color3);\n  }\n\n  width: 250px;\n\n  & svg {\n    margin: 0;\n  }\n\n  & :first-child {\n    display: flex;\n    flex-wrap: nowrap;\n    justify-content: space-around;\n\n    & > svg {\n      stroke: black;\n    }\n  }\n\n  & > :first-child::after {\n    content: 'Kernel is busy, please wait !!';\n    color: var(--jp-warn-color3);\n  }\n}\n\n/*\n\n the look of the dialogs for our 3 extra functions\n*/\n.nbh-dialog-button {\n  border-radius: 10px;\n}\n\n.nbh-dialog {\n  --nbh-tocopy-color: rgb(109 7 7);\n\n  & .nbh-larger {\n    font-size: larger;\n  }\n\n  & #try-share-url {\n    margin-left: 40px;\n  }\n\n  & #share-url {\n    color: var(--nbh-tocopy-color);\n    font-size: x-small;\n  }\n\n  & #student-id {\n    font-size: x-large;\n    font-weight: bold;\n    color: var(--nbh-tocopy-color);\n  }\n}\n"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=style_index_js.c6265a05cc69857a6d81.js.map