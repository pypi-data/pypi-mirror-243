...
def add(
    video: str, model_name: str, model_version: str = "latest"
) -> str:
...
def details(model_name: str, model_version: str = "latest"):
    ...
    if response.ok:
        ...
        print(f"[bold red]Model details details have not been found")
        return


def fetch(
    model_name: str, model_version: str = "latest", name: str = ""
):
