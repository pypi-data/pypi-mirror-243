...
from .CONST import CURRENT_SYSTEM_DEFAULT_ENCODING, PLATFORM, CURRENT_USERNAME


def CmdLine(cmd: str, encoding=''):
    """
    执行cmd命令时可以查看输出的内容
    :param cmd: str 命令
    ...
    """
    if encoding=='':
        encoding = CURRENT_SYSTEM_DEFAULT_ENCODING  # 当前系统所使用的默认字符编码
