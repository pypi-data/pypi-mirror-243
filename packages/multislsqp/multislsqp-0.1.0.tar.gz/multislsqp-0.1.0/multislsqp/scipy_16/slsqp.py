...
This code is compatible with version 1.{6,7}.x of SciPy. 
...
from multislsqp.scipy_16._numdiff import approx_derivative
from multislsqp.scipy_16.optimize import _prepare_scalar_function
