...
This code is compatible with version 1.5.x of SciPy. 
...
from scipy.optimize.optimize import (OptimizeResult, _check_unknown_options,MemoizeJac)

from scipy.optimize._constraints import old_bound_to_new

from multislsqp.scipy_15._numdiff import approx_derivative
from multislsqp.scipy_15.optimize import _prepare_scalar_function
...
def minimise_slsqp_cmp(func, x0, args=(), jac=None, bounds=None,
    ...
    # ScalarFunction
    fx = sf.fun(x)
    g = np.concatenate([sf.grad(x),np.zeros([nbPoint,1])],axis=1)
    ...
    return Res, {'nfev':sf.nfev,'njev':sf.nfev}
