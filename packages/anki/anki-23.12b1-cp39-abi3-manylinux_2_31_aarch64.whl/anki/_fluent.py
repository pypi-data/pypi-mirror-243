...
be at least 10x smaller than your review limit. '''
    ...
    def deck_config_optimizing_preset(self, current_count: int, total_count: int) -> str:
        ...
        return self._translate(11, 102, {"current_count": current_count, "total_count": total_count})
    ...
    def deck_config_percent_of_reviews(self, reviews: int, pct: str) -> str:
        ...
        return self._translate(11, 104, {"reviews": reviews, "pct": pct})
...
sort orders preferable. '''
    ...
    def deck_config_reviews_too_low(self, cards: int, expected: FluentVariable) -> str:
        ...
        return self._translate(11, 121, {"cards": cards, "expected": expected})
    ...
    def deck_config_seconds_to_show_answer(self, ) -> str:
        r''' Seconds to show answer '''
        return self._translate(11, 125, {})


    def deck_config_seconds_to_show_answer_tooltip(self, ) -> str:
        r''' The number of seconds to wait before automatically revealing the answer. Set to 0 to disable. '''
        return self._translate(11, 126, {})


    def deck_config_seconds_to_show_question(self, ) -> str:
        r''' Seconds to show question '''
        return self._translate(11, 127, {})


    def deck_config_seconds_to_show_question_tooltip(self, ) -> str:
        r''' The number of seconds to wait before automatically advancing to the next question. Set to 0 to disable. '''
...
- `Today only`: Make a temporary change to this deck's limit. '''
    ...
    def deck_config_updating_cards(self, current_cards_count: int, total_cards_count: int) -> str:
        ...
        return self._translate(11, 160, {"current_cards_count": current_cards_count, "total_cards_count": total_cards_count})


    def deck_config_used_by_decks(self, decks: int) -> str:
        r''' used by {$decks} decks '''
        return self._translate(11, 161, {"decks": decks})
...
class LegacyTranslationEnum:
    ...
    DECK_CONFIG_OPTIMIZE_BUTTON = (11, 101)
    DECK_CONFIG_OPTIMIZING_PRESET = (11, 102)
    DECK_CONFIG_ORDERING_TITLE = (11, 103)
    DECK_CONFIG_PERCENT_OF_REVIEWS = (11, 104)
    DECK_CONFIG_PLEASE_SAVE_YOUR_CHANGES_FIRST = (11, 105)
    DECK_CONFIG_RELEARNING_STEPS = (11, 106)
    DECK_CONFIG_RELEARNING_STEPS_ABOVE_MINIMUM_INTERVAL = (11, 107)
    DECK_CONFIG_RELEARNING_STEPS_TOOLTIP = (11, 108)
    DECK_CONFIG_REMOVE_GROUP = (11, 109)
    DECK_CONFIG_RENAME_GROUP = (11, 110)
    DECK_CONFIG_RESCHEDULE_CARDS_ON_CHANGE = (11, 111)
    DECK_CONFIG_RESCHEDULE_CARDS_ON_CHANGE_TOOLTIP = (11, 112)
    DECK_CONFIG_RESCHEDULE_CARDS_WARNING = (11, 113)
    DECK_CONFIG_REVERT_BUTTON_TOOLTIP = (11, 114)
    DECK_CONFIG_REVIEW_LIMIT_TOOLTIP = (11, 115)
    DECK_CONFIG_REVIEW_MIX_MIX_WITH_REVIEWS = (11, 116)
    DECK_CONFIG_REVIEW_MIX_SHOW_AFTER_REVIEWS = (11, 117)
    DECK_CONFIG_REVIEW_MIX_SHOW_BEFORE_REVIEWS = (11, 118)
    DECK_CONFIG_REVIEW_SORT_ORDER = (11, 119)
    DECK_CONFIG_REVIEW_SORT_ORDER_TOOLTIP = (11, 120)
    DECK_CONFIG_REVIEWS_TOO_LOW = (11, 121)
    DECK_CONFIG_SAVE_AND_OPTIMIZE = (11, 122)
    DECK_CONFIG_SAVE_BUTTON = (11, 123)
    DECK_CONFIG_SAVE_TO_ALL_SUBDECKS = (11, 124)
    DECK_CONFIG_SECONDS_TO_SHOW_ANSWER = (11, 125)
    DECK_CONFIG_SECONDS_TO_SHOW_ANSWER_TOOLTIP = (11, 126)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION = (11, 127)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP = (11, 128)
    DECK_CONFIG_SHARED_PRESET = (11, 129)
    DECK_CONFIG_SHOW_ANSWER_TIMER_TOOLTIP = (11, 130)
    DECK_CONFIG_SHOW_REMINDER = (11, 131)
    DECK_CONFIG_SKIP_QUESTION_WHEN_REPLAYING = (11, 132)
    DECK_CONFIG_SM2_RETENTION = (11, 133)
    DECK_CONFIG_SM2_RETENTION_TOOLTIP = (11, 134)
    DECK_CONFIG_SMALLER_IS_BETTER = (11, 135)
    DECK_CONFIG_SORT_ORDER_ASCENDING_DIFFICULTY = (11, 136)
    DECK_CONFIG_SORT_ORDER_ASCENDING_EASE = (11, 137)
    DECK_CONFIG_SORT_ORDER_ASCENDING_INTERVALS = (11, 138)
    DECK_CONFIG_SORT_ORDER_CARD_TEMPLATE_THEN_RANDOM = (11, 139)
    DECK_CONFIG_SORT_ORDER_DECK_THEN_DUE_DATE = (11, 140)
    DECK_CONFIG_SORT_ORDER_DESCENDING_DIFFICULTY = (11, 141)
    DECK_CONFIG_SORT_ORDER_DESCENDING_EASE = (11, 142)
    DECK_CONFIG_SORT_ORDER_DESCENDING_INTERVALS = (11, 143)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_DECK = (11, 144)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_RANDOM = (11, 145)
    DECK_CONFIG_SORT_ORDER_GATHER = (11, 146)
    DECK_CONFIG_SORT_ORDER_RANDOM = (11, 147)
    DECK_CONFIG_SORT_ORDER_RANDOM_NOTE_THEN_TEMPLATE = (11, 148)
    DECK_CONFIG_SORT_ORDER_RELATIVE_OVERDUENESS = (11, 149)
    DECK_CONFIG_SORT_ORDER_TEMPLATE_THEN_GATHER = (11, 150)
    DECK_CONFIG_STARTING_EASE_TOOLTIP = (11, 151)
    DECK_CONFIG_STEPS_TOO_LARGE_FOR_FSRS = (11, 152)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER = (11, 153)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER_TOOLTIP = (11, 154)
    DECK_CONFIG_TAB_DESCRIPTION = (11, 155)
    DECK_CONFIG_TIMER_TITLE = (11, 156)
    DECK_CONFIG_TITLE = (11, 157)
    DECK_CONFIG_TODAY_ONLY = (11, 158)
    DECK_CONFIG_UNABLE_TO_DETERMINE_DESIRED_RETENTION = (11, 159)
    DECK_CONFIG_UPDATING_CARDS = (11, 160)
    DECK_CONFIG_USED_BY_DECKS = (11, 161)
    DECK_CONFIG_WAIT_FOR_AUDIO = (11, 162)
    DECK_CONFIG_WAIT_FOR_AUDIO_TOOLTIP = (11, 163)
    DECK_CONFIG_WEIGHTS = (11, 164)
    DECK_CONFIG_WEIGHTS_TOOLTIP = (11, 165)
    DECK_CONFIG_WHICH_DECK = (11, 166)
    DECK_CONFIG_WILL_REQUIRE_FULL_SYNC = (11, 167)
