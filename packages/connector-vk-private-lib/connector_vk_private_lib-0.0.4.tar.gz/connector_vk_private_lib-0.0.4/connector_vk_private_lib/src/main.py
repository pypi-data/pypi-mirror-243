...
from config.main import VK_ACCESS_TOKEN, VK_GROUP_OWNER_ID, VK_GROUP_DONORS, VK_FRIEND_GROUP, OWNER_ID, \
...
from interfaces.main import BaseConfig
from service.main import Connector
