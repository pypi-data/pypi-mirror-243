...
from connector_vk_savarety.connector_vk_private_lib.src import VK_ACCESS_TOKEN, VK_GROUP_OWNER_ID, VK_GROUP_DONORS, VK_FRIEND_GROUP, OWNER_ID, \
...
from connector_vk_savarety.connector_vk_private_lib.src.service.main import Connector
