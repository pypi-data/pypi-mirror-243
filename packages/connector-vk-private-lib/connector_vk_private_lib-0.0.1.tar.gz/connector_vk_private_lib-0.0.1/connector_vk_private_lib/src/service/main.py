...
from connector_vk_savarety.connector_vk_private_lib.src.interfaces.main import BaseConfig, \
    URLQueryPost, \
    URLQueryUserInfo, \
    URLQueryMessageSend, \
    URLQueryWallGet, \
    ...
    URLQueryCommentsGet, \
    URLQueryGroupGet
from connector_vk_savarety.connector_vk_private_lib.src.interfaces.groups import ResponseGetGroups
from connector_vk_savarety.connector_vk_private_lib.src.interfaces.wall import ResponseGetWall
from connector_vk_savarety.connector_vk_private_lib.src.interfaces.video import ResponseGetVideo
