...
class Aggregable(Except):
    ...
    '''
    def __init__(self: Self, *errs: Exception, eager: bool = False, **kwargs) -> None:
        self.errs = list(errs)
        self.eager = eager
        super().__init__(*errs, eager = self.eager, **kwargs)
        
        if eager and len(errs) > 0: self.call()
