...
## Uncomment and set cache configuration as needed.
#CACHE_TYPE = getenv("CHILL_CACHE_TYPE", default="FileSystemCache")
#CACHE_DEFAULT_TIMEOUT = int(getenv("CHILL_CACHE_DEFAULT_TIMEOUT", default="300"))
#CACHE_THRESHOLD = int(getenv("CHILL_CACHE_THRESHOLD", default="500"))
