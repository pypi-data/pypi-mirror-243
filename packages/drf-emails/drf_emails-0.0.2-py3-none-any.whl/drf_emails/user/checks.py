# Check that settings user is drf_emails.user.abstracts.AbstractUser instance (for verified and unique email)
# Check that emails are drf_emails.user.email.CodeVerifyEmail instances
