...
'''
	python3 insurance.py shows/essential_nutrients/recipe/formulate/status_1.py
'''
...
def check_1 ():
	...
	walnut_mass_and_mass_eq_grams = Fraction ("84238347589283870046299/112589990684262400000")
	walnut_energy_food_calories = Fraction ("154133/50")
	walnut_multiplier = 10

	vegan_pizza_2672996_mass_and_mass_eq_grams = Fraction ("1351491697361075527451/22517998136852480000")
