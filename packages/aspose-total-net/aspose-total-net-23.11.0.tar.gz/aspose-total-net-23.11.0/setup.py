...
REQUIRES = ["aspose-3d==23.11.0",
            "aspose-barcode-for-python-via-net==23.10",
            "aspose-cad==23.10",
            "aspose-cells-python==23.11.1",
            "aspose-diagram-python==23.11",
            "Aspose.Email-for-Python-via-NET==23.10",
            "aspose-finance==23.11",
            "aspose-imaging-python-net==23.10.0",
            "aspose-ocr-python-net==23.10.1",
            "aspose-pdf==23.11.0",
            "Aspose.Slides==23.10.0",
            "aspose-tasks==23.11.0",
