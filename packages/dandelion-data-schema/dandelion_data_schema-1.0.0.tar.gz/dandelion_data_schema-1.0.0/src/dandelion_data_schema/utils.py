...
from .dataset import ModalityType
...
def load_dicom_folder(folder_path: Path) -> Record:
    ...
    # create a Record object from the list of dicom files
    # TODO: load in metadata from DICOM
    return Record(
        record_name=folder_path.name,
        age=0,
        sex='Male',
        race='White',
        weight=0,
