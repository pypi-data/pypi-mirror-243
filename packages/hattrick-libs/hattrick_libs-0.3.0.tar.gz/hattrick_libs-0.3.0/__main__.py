...
from libs import do_hattrick_request
from libs import get_teamdetails
from libs import get_flags
...
def main():
    ...
    request_token, request_token_secret, authorize_url = do_hattrick_request.fetch_authorize_url()
    ...
    status = session.get('https://chpp.hattrick.org/oauth/check_token.ashx')
    ...
    # # Example I:
    # teams_dict = get_flags.get_my_flags()
