...
def chat_in_cmd(apikeys:list, newchat=False):
    print("\n\033[0m您已进入命令行聊天模式, 该模式使用'gpt-4-1106-preview'模型, 请确保您的apikey支持该模型.", end='')
    gpt = Chat(api_key=AKPool(apikeys), model='gpt-4-1106-preview', MsgMaxCount=30)
    if not newchat:
