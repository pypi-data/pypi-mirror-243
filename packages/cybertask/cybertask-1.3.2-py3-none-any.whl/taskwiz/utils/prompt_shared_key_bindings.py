...
# edit previous response in text editor
@prompt_shared_key_bindings.add("escape", "p")
def _(_):
...
def _(event):
    ...
    filename = os.path.join(config.taskWizAIFolder, "temp", "current_input.txt")
