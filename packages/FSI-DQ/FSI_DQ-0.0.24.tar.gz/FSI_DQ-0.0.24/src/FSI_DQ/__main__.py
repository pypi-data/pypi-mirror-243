...
class DataQuality:
    ...
    def main(self):
        ...
        if self.choice['AnomalyDetection']==1:
            ...
            self.write_delta(result_sp, path,self.partition_field,'overwrite',1)
        ...
        if self.choice['Standardization']==1:
            ...
            self.write_delta(result, self.dq_path+"/tandardizationResult/",self.partition_field,'overwrite',1)
