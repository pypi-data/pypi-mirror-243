...
class DataQuality:
    ...
    def main(self):
        ...
        if self.choice['DQRules']==1:
            ...
            self.write_delta(result_dq, self.dq_path+"/DQRules/",self.partition_field,'overwrite', parts=1)
        ...
        if self.choice['AnomalyDetection']==1:
            ...
            self.write_delta(result_sp, self.dq_path+"/AnomalyDetectionResult/",self.partition_field,'overwrite', parts=1)
        ...
        if self.choice['Standardization']==1:
            ...
            self.write_delta(result, self.dq_path+"/StandardizationResult/",self.partition_field,'overwrite', parts=1)
