...
import deseqpyodide
from deseqpyodide.grid_search import grid_fit_alpha
from deseqpyodide.grid_search import grid_fit_beta
from deseqpyodide.grid_search import grid_fit_shrink_beta
...
def load_example_data(
    ...
    # Load data
    datasets_path = Path(deseqpyodide.__file__).parent.parent / "datasets"
