...
class model(LightningModule):
    ...
    def get_distance_ratio(self):
        ...
        mean_tree_distance = self.train_data.distance_matrix.mean()
        self.encoder.distance_ratio = (mean_tree_distance / mean_init_distance / 10).item()
    ...
    def train_dataloader(self) -> DataLoader:
        ...
        if self.current_model != -1:
            ...
            print(f'Distance ratio is {self.encoder.distance_ratio}')
