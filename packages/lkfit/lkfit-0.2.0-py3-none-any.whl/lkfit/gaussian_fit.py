...
def fit_gaussian_2d(
    ...
    Returns:
        ...
        i and j. w is FHWM if return_fwhm is true, otherwsie it is sigma.
    """
    if dbg_plot:
        plot = True
    ...
    if not isnone(crop_area) or crop_to_fit_region:
        if not isnone(crop_area):
