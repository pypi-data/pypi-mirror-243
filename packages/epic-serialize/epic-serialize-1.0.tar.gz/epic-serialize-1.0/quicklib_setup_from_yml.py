...
ql_setup_kwargs = {'name': 'epic-serialize', 'description': 'Easy serialization of Python objects with multiprocessing support', 'long_description': {'filename': 'README.md', 'content_type': 'text/markdown'}, 'author': 'Uri Sternfeld, Assaf Ben-David, Yonatan Perry', 'license': 'MIT License', 'url': 'https://github.com/Cybereason/epic-serialize', 'python_requires': '>=3.10', 'top_packages': ['epic'], 'version_module_paths': ['epic/serialize'], 'install_requires': ['epic-common', 'epic-logging'], 'classifiers': ['Development Status :: 4 - Beta', 'Intended Audience :: Developers', 'Operating System :: POSIX :: Linux', 'Operating System :: MacOS :: MacOS X', 'Operating System :: Microsoft :: Windows', 'Programming Language :: Python :: 3 :: Only', 'Programming Language :: Python :: 3.10']}    
