...
def compute_quadrupole_moment(
    ...
    **Keyword Arguments:**
    ...
    # will break if occ_model is not found
    ...
    if isinstance(density_matrix_unmask, dict):
        try:
            # pq index denotes the whole 1-dm_1
...
def nuc_part_qm(basis):
    ...
    **Arguments**
    basis
        a GOBasis instance. Contains the nuclear coordinates
    """
