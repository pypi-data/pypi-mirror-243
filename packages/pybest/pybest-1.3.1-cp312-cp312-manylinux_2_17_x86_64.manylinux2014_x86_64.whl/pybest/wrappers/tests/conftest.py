...
test_opccd_dm = [
    (
        ...
        ROOpCCD,
        {
            ...
            "dipole_lccsd": [-0.01807735, 2.20762975, 0.00000000],
        },
    ),
    (
        "he",
...
def mol_generation_oopccd(request, linalg):
...
def mol_generation_oopccd_ncore(linalg, request):
    """Generate molecule for pCCD-based calculations with frozen core orbitals"""
    mol = Molecule(
        linalg, "cc-pvdz", "test/water.xyz", alpha=0, ncore=request.param
    )
    mol.do_scf(RHF)
    mol.do_pccd(ROOpCCD)
    # Return molecule
