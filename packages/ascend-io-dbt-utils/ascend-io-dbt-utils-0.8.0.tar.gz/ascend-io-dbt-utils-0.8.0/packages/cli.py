...
def ascend_options(f):
    ...
    f = click.option('--dataplane-type', required=False, help='Ascend dataplane type, envvar=ASCEND_DATAPLANE_TYPE"', default="snowflake", envvar='ASCEND_DATAPLANE_TYPE', type=click.Choice(['snowflake', 'bigquery']))(f)
    return f
