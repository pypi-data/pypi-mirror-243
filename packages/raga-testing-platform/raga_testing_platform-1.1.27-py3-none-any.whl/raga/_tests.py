...
<<<<<<< HEAD
from raga import TestSession, ModelABTestRules, FMARules, LQRules, EventABTestRules, Filter, OcrRules, OcrAnomalyRules, LC
=======
from raga import TestSession, ModelABTestRules, FMARules, LQRules, EventABTestRules, Filter, OcrRules, OcrAnomalyRules, \
    LC
>>>>>>> dd2657e21a84664573e6c9f94bd2d4bb2f3c71f7
...
def labelling_quality_test_validation_PB(test_session:TestSession, dataset_name:str, test_name:str, trainModelColumnName:str, fieldModelColumnName:str, type:str, output_type:str, embeddingTrainColName:str, embeddingFieldColName:str, rules:LC):
    from raga.constants import INVALID_RESPONSE, INVALID_RESPONSE_DATA, REQUIRED_ARG_V2
    ...
    assert isinstance(rules, LC) and rules, f"{REQUIRED_ARG_V2.format('rules', 'str')}"
    return dataset_id
