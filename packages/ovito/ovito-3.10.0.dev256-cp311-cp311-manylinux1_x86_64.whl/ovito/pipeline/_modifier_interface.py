...
class ModifierInterface(traits.api.HasTraits):
    ...
    @abc.abstractmethod
    def modify(self, data: DataCollection, *, frame: int, input_slots: Dict[str, ModifierInterface.InputSlot], data_cache: DataCollection, pipeline_node: ovito.pipeline.ModificationNode, **kwargs: Any):
        """
    ...
    if os.environ.get('OVITO_SPHINX_BUILD', False):
        ...
        @abc.abstractmethod
        def input_caching_hints(self, frame: int, *, input_slots: Dict[str, InputSlot], pipeline_node: ovito.pipeline.ModificationNode, **kwargs: Any) -> Sequence[int] | Mapping[InputSlot, int | Sequence[int]]:
            """
        ...
        @abc.abstractmethod
        def compute_trajectory_length(self, *, input_slots: Dict[str, InputSlot], data_cache: DataCollection, pipeline_node: ovito.pipeline.ModificationNode, **kwargs: Any) -> int:
            """
