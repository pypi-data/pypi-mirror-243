...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_AUTHORIZER'].methods_by_name['DecisionTree']._options = None
  ...
  _globals['_AUTHORIZER'].methods_by_name['Is']._options = None
  ...
  _globals['_AUTHORIZER'].methods_by_name['Query']._options = None
  _globals['_AUTHORIZER'].methods_by_name['Query']._serialized_options = b'\222A\215\001\n\nAuthorizer\022\022Query (authorized)\0323Executes a rego query on the loaded policy runtime.*\020authorizer.queryb$\n\024\n\020AuthorizerAPIKey\022\000\n\014\n\010TenantID\022\000\202\323\344\223\002\030\"\023/api/v2/authz/query:\001*'
  _globals['_AUTHORIZER'].methods_by_name['Compile']._options = None
  _globals['_AUTHORIZER'].methods_by_name['Compile']._serialized_options = b'\222A\224\001\n\nAuthorizer\022\024Compile (authorized)\0326Executes a partial query on the loaded policy runtime.*\022authorizer.compileb$\n\024\n\020AuthorizerAPIKey\022\000\n\014\n\010TenantID\022\000\202\323\344\223\002\032\"\025/api/v2/authz/compile:\001*'
  _globals['_AUTHORIZER'].methods_by_name['ListPolicies']._options = None
  ...
  _globals['_AUTHORIZER'].methods_by_name['GetPolicy']._options = None
  ...
  _globals['_AUTHORIZER'].methods_by_name['Info']._options = None
  ...
  _globals['_AUTHORIZER']._serialized_end=6005
