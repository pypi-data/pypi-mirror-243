...
def get_augmented_targets(target_files: TargetFiles, target_augmentations: AugmentationRules) -> AugmentedTargets:
...
def get_mixups_from_target_augmentations(target_augmentations: AugmentationRules) -> list[int]:
    """Get mixup values used

    :return: Mixup values used
    """
    return list(set([target_augmentation.mixup for target_augmentation in target_augmentations]))
