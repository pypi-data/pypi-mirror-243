...
enabled_models = ["whisper", "llama2-7b-chat", "mpt-7b-instruct", "sdxl-base", "txt2img", "sunoai-bark"]  # "falcon-7b-instruct", "falcon-40b-instruct", "mpt-30B-instruct", "img2img", "pix2pix", "deploy-llm"]
