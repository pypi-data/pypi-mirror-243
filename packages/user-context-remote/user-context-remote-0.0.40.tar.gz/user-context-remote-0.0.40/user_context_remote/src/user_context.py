...
class UserContext:
    ...
    def _initialize(self, user_identifier: str = None, password: str = None, user_JWT: str = None):
        ...
        self.subsctiption_id = 5 # TODO temp solution, so we can debug
        if (user_identifier is not None and password is not None):
            self.user_JWT = None
    ...
    def _set_subscription_id(self, subscription_id: int) -> None:
        self.subscription_id = subscription_id

    def get_effective_subscription_id(self, profile_id: int) -> None:
        #MiniLogger.warning("user-context-python-package Please make sure get_effective_subscription_id()")
	      return self.subsctiption_id
