...
# TODO Use python-sdk to get and check the environment variables instead of those two statements
...
class UserContext:
    ...
    def get_effective_profile_preferred_lang_code(self) -> str:
        ...
        #MiniLogger.end(GET_CURENT_LANG_CODE_METHOD_NAME,object={"profilePreferredLangCode": self.profilePreferredLangCode})
        return self.profilePreferredLangCode

    def _set_effective_profile_preferred_lang_code(self, profilePreferredLangCode: LangCode) -> None:
        _SET_CURRENT_LANG_CODE_METHOD_NAME = "_set_current_lang_code"
        #MiniLogger.start(_SET_CURRENT_LANG_CODE_METHOD_NAME,object={"profilePreferredLangCode": profilePreferredLangCode.value})
        self.profilePreferredLangCode = profilePreferredLangCode.value
    ...
    def get_effective_subscription_id(self) -> None:
        ...
        MiniLogger.warning("user-context-python-package "+_GET_EFFECTIVE_SUBSCRIPTION_ID_METHOD_NAME+" Please make sure get_effective_subscription_id() subscription_id="+str(self.subscription_id))
    ...
    def _authenticate_by_user_identification_and_password(self, user_identifier: str, password: str) -> str:
        ...
        try:
            ...
            if output.status_code != HTTPStatus.OK:
                MiniLogger.error(_AUTHENTICATE_BY_USER_IDENTIFICATION_AND_PASSWORD_METHOD_NAME + " output.status_code != HTTPStatus.OK " + output.text)
    ...
    # TODO Shall we make this private?
    def get_user_data_login_response(self, validate_jwt_response: str) -> None:
        ...
        if "userDetails" in validate_jwt_response.json()["data"]:
            ...
            if "subscriptionId" in userDetails:
                ...
                MiniLogger.end(_GET_USER_DATA_LOGIN_RESPONSE_METHOD_NAME + " Got subscription_id from the cloud. subscription_id="+ subscription_id, object={"subscription_id": subscription_id})
