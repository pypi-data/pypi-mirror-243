...
class UserContext:
    ...
    def get_effective_subscription_id(self) -> None:
        ...
        MiniLogger.warning("user-context-python-package "+_GET_EFFECTIVE_SUBSCRIPTION_ID_METHOD_NAME+" Please make sure get_effective_subscription_id() subscription_id="+self.subscription_id)
