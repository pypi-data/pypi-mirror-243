...
class AEOM:
    ...
    def __init__(self, k=10, eps=0.5, min_samples=2, method='default', sorting="pca", metric='euclidean', 
    ...
    def fit(self, data):
        ...
        elif self.method == 'kpp':
            self.groups_, self.corelist_ = kpp_seeding(self.data, self.k, 
    ...
    def merging(self, data, agg_labels, splist, min_samples, cluster_selection_method="eom", 
