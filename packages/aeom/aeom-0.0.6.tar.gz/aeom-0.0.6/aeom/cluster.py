...
class AEOM:
    ...
    def __init__(self, k=10, eps=0.5, min_samples=2, method='kpp', sorting="pca", metric='euclidean', sample_weight=None, n_trials=None,
                 selection_method="eom", allow_single_cluster=False, cluster_epsilon=0.0, max_cluster_size=None, 
                 post_alloc=True, memory=True, random_state=42, verbose=1): 
        ...
        if self.memory:
            self.kpp_seeding = kpp_seeding_memory
        else:
            self.kpp_seeding = kpp_seeding
    ...
    def fit(self, data):
        ...
        if self.method == 'greedy':
            ...
            self.groups_, self.corelist_ = self.kpp_seeding(self.data, self.k, 
