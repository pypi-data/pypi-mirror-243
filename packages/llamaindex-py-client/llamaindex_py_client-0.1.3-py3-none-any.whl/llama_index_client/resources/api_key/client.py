...
class ApiKeyClient:
    ...
    def generate_key(self, *, name: typing.Optional[str] = OMIT) -> ApiKey:
        ...
        Parameters:
            - name: typing.Optional[str]. <span style="white-space: nowrap">`<= 70 characters`</span>
        """
    ...
    def update_existing_api_key(
        self, api_key_id: str, *, name: typing.Optional[str] = OMIT
    ) -> ApiKey:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            "PUT",
            urllib.parse.urljoin(
                f"{self._client_wrapper.get_base_url()}/", f"api/api_key/{api_key_id}"
            ),
            json=jsonable_encoder(_request),
            headers=self._client_wrapper.get_headers(),
            timeout=60,
