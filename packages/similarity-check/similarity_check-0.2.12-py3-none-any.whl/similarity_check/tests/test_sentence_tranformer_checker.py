from similarity_check.utils import _get_enviroment_variables, _get_s3_resource
...
def test_stc_match_accuracy():
    ...
    df_match, _ = stc.match(X, source_mapping=[('new_text', 'text', 1)])
...
def test_stc_match_only_include():
    ...
    df_match, _ = stc.match(X, source_mapping=[('new_text', 'text', 1)], topn=10)
