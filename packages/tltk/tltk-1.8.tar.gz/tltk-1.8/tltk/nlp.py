...
# -*- coding: utf-8 -*-
#########################################################
## Thai Language Toolkit : version  1.7.1
...
#    print(TextOption,UDParse)
    ...
    if Classifier == "level":
        input_data = TranformData([txtfeatures])
        df = pd.DataFrame(input_data)

        input_df = df.sort_index(axis=1)

        # Make predictions
        [predicted_level] = loaded_model.predict(input_df)
