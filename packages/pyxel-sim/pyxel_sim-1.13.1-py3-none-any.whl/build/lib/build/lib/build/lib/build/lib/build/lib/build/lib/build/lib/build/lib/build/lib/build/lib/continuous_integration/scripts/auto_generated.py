...
class ModelPhotonCollectionSimpleCollectionArguments(Mapping[str, Any]):
    ...
    def __iter__(self) -> Iterator[str]:
        return iter(('pixel_scale', 'aperture', 'filter_band'))
    def __getitem__(self, item: Any) -> Any:
        if item in tuple(self):
            return getattr(self, item)
        else:
...
#
# Model: Charge Generation / Load Qe Curve
#
@schema(title='Parameters')
@dataclass
class ModelChargeGenerationLoadQeCurveArguments(Mapping[str, Any]):
    filename: Union[str, pathlib.Path] = field(
        metadata=schema(
            title='filename'
...
@schema(
    title="Model 'load_qe_curve'"
    ,description='Apply wavelength dependent QE with loading a file.'
)
@dataclass
class ModelChargeGenerationLoadQeCurve:
    name: str
    arguments: ModelChargeGenerationLoadQeCurveArguments
    func: Literal['pyxel.models.charge_generation.load_qe_curve'] = 'pyxel.models.charge_generation.load_qe_curve'
    enabled: bool = True
...
class DetailedDetectionPipeline(DetectionPipeline):
    ...
    photon_collection: Optional[
        Sequence[Union[ModelPhotonCollectionIllumination, ModelPhotonCollectionLoadImage, ModelPhotonCollectionLoadPsf, ModelPhotonCollectionOpticalPsf, ModelPhotonCollectionShotNoise, ModelPhotonCollectionSimpleAperture, ModelPhotonCollectionSimpleCollection, ModelPhotonCollectionStripePattern, ModelPhotonCollectionWavelengthDependenceAirs, ModelLoadDetector, ModelSaveDetector, ModelFunction]]
    ...
    charge_generation: Optional[
        Sequence[Union[ModelChargeGenerationApdGain, ModelChargeGenerationChargeBlocks, ModelChargeGenerationChargeDeposition, ModelChargeGenerationChargeDepositionInMct, ModelChargeGenerationConversionWithQeMap, ModelChargeGenerationCosmix, ModelChargeGenerationDarkCurrent, ModelChargeGenerationDarkCurrentRule07, ModelChargeGenerationDarkCurrentSaphira, ModelChargeGenerationLoadCharge, ModelChargeGenerationLoadQeCurve, ModelChargeGenerationRadiationInducedDarkCurrent, ModelChargeGenerationSimpleConversion, ModelChargeGenerationSimpleDarkCurrent, ModelLoadDetector, ModelSaveDetector, ModelFunction]]
