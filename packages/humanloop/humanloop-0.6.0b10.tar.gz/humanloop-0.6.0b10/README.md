...
[![PyPI](https://img.shields.io/badge/PyPI-v0.6.0beta.10-blue)](https://pypi.org/project/humanloop/0.6.0-beta.10)
...
```sh
pip install humanloop==0.6.0-beta.10
```
...
Deserialize a model config from a request.
...
Serialize a model config from a request.
