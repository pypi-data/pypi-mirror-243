...
from e2enetworks.constants import BASE_GPU_URL, INSTANCE_TYPE, headers
...
class Notebooks:
    ...
    def create(self, name, plan, image_id, instance_type, disk_size_in_gb=30, notebook_type="new", notebook_url=""):
