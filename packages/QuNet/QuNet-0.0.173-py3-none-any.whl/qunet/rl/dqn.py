...
class DQN:
    ...
    def multi_agent_testing(self, model, episodes = 1000, epsilon=0, info="", sufix="", verbose=1):   
    ...
    def multi_agent_testing_dir(self, dir="", episodes = 1000, epsilon=0, info="", verbose=1, count=10):   
        fnames = []
        ...
        for fname in fnames:
            ...
            self.multi_agent_testing(model, episodes = episodes, epsilon=epsilon, info=info, sufix=fname)
