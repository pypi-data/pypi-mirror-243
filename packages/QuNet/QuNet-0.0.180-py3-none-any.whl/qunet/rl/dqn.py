...
class DQN:
    ...
    def multi_agent_training(self, episodes = 100000, steps=-1, reset_steps=-1, stat1 = 10, stat2 = 100, plots = -1, start_episode_check=-1, check_rate=1., fname=""):
