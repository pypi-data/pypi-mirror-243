...
class ConfigOut(object):
    ...
    def __init__(self, last_updated=None, site=None, features=None, wip_features=None, signed_url=False, auth=None, open_tracing=None, created=None, modified=None):  # noqa: E501
