  ...
  return class Toolbar extends React.Component<IProperties, IState> {
    ...
    toggleCode() {
      InteractionRecorder.sendInteraction({
        click_type: 'ON',
        signal_origin: DashboardClickOrigin.TOC_TOOLBAR_CODE
      });
    ...
    toggleMarkdown() {
      InteractionRecorder.sendInteraction({
        click_type: 'ON',
        signal_origin: DashboardClickOrigin.TOC_TOOLBAR_MARKDOWN
      });
    ...
    toggleNumbering() {
      InteractionRecorder.sendInteraction({
        click_type: 'ON',
        signal_origin: DashboardClickOrigin.TOC_TOOLBAR_NUMBERED
      });
    ...
    toggleShowVisuDashboard() {
      InteractionRecorder.sendInteraction({
        click_type: 'ON',
        signal_origin: DashboardClickOrigin.TOC_TOOLBAR_SHOW_HIDE
      });
    ...
    refreshDashboard() {
      InteractionRecorder.sendInteraction({
        click_type: 'ON',
        signal_origin: DashboardClickOrigin.TOC_TOOLBAR_REFRESH
      });
