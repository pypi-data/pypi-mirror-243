...
`noneSymbol: str | None` (_command line option:_ `--none-symbol`) [`None`]
...
variable `exitOnError` is true; the corresponding
command line option is `-k`/`--keep-going` which sets it to false.
...
Welcome to EmPy version 4.0.</pre>
...
Welcome to EmPy version 4.0, in CPython/3.10.12, on Linux (POSIX), with x86_64.</pre>

For diagnostic details (say, to report a potential problem to the
developer), run:

<pre class="shell"><b><i>% em.py -Z # or: --details</i></b>
Welcome to EmPy version 4.0, in CPython/3.10.12, on Linux (POSIX), with x86_64.
Details:
...
<pre class="shell"><b><i>% ./test.sh tests/sample</i></b>
tests/sample/sample.em (python3) [PASS]
...
<pre class="shell"><b><i>% wc setup.py emdoc.py emhelp.py emlib.py em.py test.sh LEGACY.md LICENSE.md README.md ANNOUNCE.md HELP.md README.md.em</i></b>
    69    266   2164 setup.py
   407   1110  13748 emdoc.py
   944   4127  40278 emhelp.py
  1044   3144  33572 emlib.py
  5767  20286 212553 em.py
   728   2603  18622 test.sh
  2693  15053 100731 LEGACY.md
    14    230   1520 LICENSE.md
  5169  22864 156719 README.md
   533   2735  18913 ANNOUNCE.md
   870   4817  43625 HELP.md
  5513  25654 177395 README.md.em
 23751 102889 819840 total</pre>
<pre class="shell"><b><i>% sha1sum setup.py emdoc.py emhelp.py emlib.py em.py test.sh LEGACY.md LICENSE.md README.md ANNOUNCE.md HELP.md README.md.em</i></b>
4a4d0dcca5989e91f1f21b474395bb5446cca9ae  setup.py
d2c0e0f3166858299df4ab1241542cf4d921c754  emdoc.py
b9a0585ccd4bdedb3ae1d83e5eba795d53ad4e79  emhelp.py
58490ea43bdac1ffd43d17c0eaa1b95411f8b6c0  emlib.py
b8ed9e0039515e7cf68ccfc69d874e7202044fe7  em.py
a9a89259ba05c07a9999adb652034c54f83b0a82  test.sh
16d9b2e9fccfc373175ad1239d2493a3646b299e  LEGACY.md
1b09e5254cb5a907ebbc9dd150a858d8ae8a7d60  LICENSE.md
c41b51d22bc7f121924f58e38b84a786288fa9e4  README.md
1a4ce4ef042fe11d84d11b5049d5e43939867781  ANNOUNCE.md
959aad8fd01e1d56633e54d280c9dfab18a7ca8a  HELP.md
a608c143ecf7e541c7582badd973eb28e2725711  README.md.em</pre>
...
- Using EmPy with threads, each of which may be creating arbitrary
  ...
  or use `-n`/`--no-proxy` and process all output yourself
...
: A very large refresh, revamp and expansion of the EmPy system and
  ...
  [release announcement](http://www.alcyone.com/software/empy/ANNOUNCE.html) and the
  [Full list of changes between EmPy 3._x_ and 4.0
  section](http://www.alcyone.com/software/empy/ANNOUNCE.html#full-list-of-changes-between-empy-3-x-and-4-0)
  for the full list.
...
_This documentation for EmPy version 4.0 was generated from README.md.em (SHA1 `a608c143ecf7e541c7582badd973eb28e2725711`, 177395 bytes) at 2023-11-29 16:29:00 with EmPy version 4.0, in CPython/3.10.12, on Linux (POSIX), with x86_64._
