...
from nextpy.build import imports
from nextpy.build import format
from nextpy.build.imports import ImportVar
from nextpy.utils.serializers import serializer
from nextpy.utils.vars import Var, get_unique_variable_name
...
class DataEditor(NoSSRComponent):
    ...
    def create(cls, *children, **props) -> Component:
        ...
        Returns:
            The DataEditor component.&
        """
        from nextpy.frontend.dom.elements import Div
