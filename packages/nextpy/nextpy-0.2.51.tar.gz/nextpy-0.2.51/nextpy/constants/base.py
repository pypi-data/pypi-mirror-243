...
class Templates(SimpleNamespace):
    ...
    template_dir = os.path.join(Nextpy.ROOT_DIR, Nextpy.MODULE_NAME, "frontend/templates/apps")
...
class Next(SimpleNamespace):
    ...
    print(f"Turbo Compilation upgrade set for 2024. Brace for puns while we buffer.\n{random_joke} 😂\n")
