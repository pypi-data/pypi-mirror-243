...
#ifndef YY_LIBPHDI_XML_SCANNER_LIBPHDI_XML_PARSER_H_INCLUDED
...
#endif
#if YYDEBUG
extern int libphdi_xml_scanner_debug;
#endif
...
extern YYSTYPE libphdi_xml_scanner_lval;


int libphdi_xml_scanner_parse (void *parser_state);


#endif /* !YY_LIBPHDI_XML_SCANNER_LIBPHDI_XML_PARSER_H_INCLUDED  */
/* Symbol kind.  */
...
yyreduce:
  ...
  case 15: /* xml_tag_close: XML_TAG_CLOSE  */
		...
		if( ( ( (libphdi_xml_parser_state_t *) parser_state )->current_tag->name_size != ( (yyvsp[0].string_value).length + 1 ) )
