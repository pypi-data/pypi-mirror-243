...
def parse(to_parse_args: list[str]) -> SVN2GitOptions:
    ...
    if parsed_args.allow_store_plaintext_password and (not parsed_args.username or not parsed_args.password):
    ...
    if parsed_args.allow_store_plaintext_password and not parsed_args.realm:
