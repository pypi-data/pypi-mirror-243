...
class GitAdapter(object):
    ...
    def get_commit_history(self):
        """
        Retrieves the commit history of the repository and saves it to a temporary JSON file.
        ...
        commit_info_list = [
            {
                ...
                'author': "{autor_name} <{author_email}>".format(
                    autor_name=commit.author.name, author_email=commit.author.email
                ),
