...
setup(
    name='masterchicken',
    version='0.0.6',
    description='Basic math calculation with a CSV advanced reader and writer',
    ...
    python_requires=">=3.9",
    install_requires=['bottle-websocket', 'bottle', 'build', 'cmake', 'distlib', 'docutils', 'numpy', 'packaging', 'pandas', 'pyarrow', 'readme-renderer', 'setuptools', 'urllib3', 'wheel'],
    package_data={
