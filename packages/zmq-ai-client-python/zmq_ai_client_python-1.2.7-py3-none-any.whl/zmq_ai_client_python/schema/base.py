...
def encoder_default(obj: Any) -> Any:
    ...
    :return: A serialized representation of the object, converting UUIDs to bytes, datetimes to timestamps, and Enums to their values.
    """
...
def json_serializer(obj):
    ...
    :param obj: The object to be serialized.
    :return: A JSON-friendly representation of the object, converting UUIDs to strings, datetimes to ISO format, and Enums to their names.
    """
    if isinstance(obj, UUID):
        return str(obj)
    if isinstance(obj, datetime):
...
class Base(ABC):
    ...
    def to_json_str(self) -> str:
        ...
        """
        return json.dumps(asdict(self), default=json_serializer, indent=4)
    ...
    def decode_map(cls) -> Dict[str, Any]:
        ...
        :return: A dictionary where keys are field names and values are their corresponding data types or decoding functions.
        """
        return {}
