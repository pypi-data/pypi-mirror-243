...
from .pagenations import SampleCursorPagination
...
class SampleViewSet(
    ...
    @action(detail=False, methods=["GET"], url_path="additional-list", url_name="additional-list")
    def additional_list(self, request, *args, **kwargs):
        """추가 액션"""
        pass

    @action(detail=True, methods=["GET"], permission_classes=[AllowAny], serializer_class=SampleSerializer)
