...
def decode_aligments(alignment_file):
    ...
    try:
        ...
        print('\nSomething went wrong - decode_aligments. Check the input or contact us!')
        return None
...
def write_aligments(decoded_aligment_file, path = None, name = 'aligments_file'):
    ...
    try:
        ...
        print('\nSomething went wrong - write_aligments. Check the input or contact us!')
...
def DisplayAligment(alignment_file, color_scheme="Taylor", wrap_length=80, show_grid=True, show_consensus=True):
    ...
    try:
        ...
        print('\nSomething went wrong - DisplayAligment. Check the input or contact us!')
        return None
