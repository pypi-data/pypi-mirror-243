...
def MuscleMultipleSequenceAlignment(fasta_string, gapopen = 10, gapextend = 0.5, output = None, source = _cwd):
    ...
    Args:
       ...
       gapopen (int) -  [https://www.ncbi.nlm.nih.gov/books/NBK279684/table/appendices.T.blastn_application_options/] Default: 10 
       gapextend (float) - [https://www.ncbi.nlm.nih.gov/books/NBK279684/table/appendices.T.blastn_application_options/] Default:  0.5 
...
def FindRNAi(sequence, metadata, length = 23, n = 200, max_repeat_len = 3, max_off = 1, species = 'human', output = None, database_name = "refseq_select_rna",  evalue = 1e-3, outfmt =  5, word_size = 7, max_hsps = 0, reward = 1, penalty = -3, gapopen = 5, gapextend = 2, dust = "no", extension = 'xml', source = _cwd):
    ...
    Args:
       ...
       evalue (float) - [https://www.ncbi.nlm.nih.gov/books/NBK279684/table/appendices.T.options_common_to_all_blast/] Default: 1e-3
       outfmt (int) - [https://www.ncbi.nlm.nih.gov/books/NBK279684/table/appendices.T.options_common_to_all_blast/] Default: 5
       word_size (int) - [https://www.ncbi.nlm.nih.gov/books/NBK279684/table/appendices.T.options_common_to_all_blast/] Default: 7
       max_hsps (int) - [https://www.ncbi.nlm.nih.gov/books/NBK279684/table/appendices.T.options_common_to_all_blast/] Default: 0
       reward (int) - [https://www.ncbi.nlm.nih.gov/books/NBK279684/table/appendices.T.options_common_to_all_blast/] Default: 1
       penalty (int) - [https://www.ncbi.nlm.nih.gov/books/NBK279684/table/appendices.T.options_common_to_all_blast/] Default: -3
       gapopen (int) - [https://www.ncbi.nlm.nih.gov/books/NBK279684/table/appendices.T.options_common_to_all_blast/] Default: 5
       gapextend (int) - [https://www.ncbi.nlm.nih.gov/books/NBK279684/table/appendices.T.options_common_to_all_blast/] Default: 2
       dust (str) - [https://www.ncbi.nlm.nih.gov/books/NBK279684/table/appendices.T.options_common_to_all_blast/] Default: "no"
...
def load_metadata(codons:str() = pkg_resources.resource_filename('JBioSeqTools', 'data/codons.xlsx'), vectors:str() = pkg_resources.resource_filename('JBioSeqTools', 'data/vectors.xlsx'), linkers:str() = pkg_resources.resource_filename('JBioSeqTools',  'data/linkers.xlsx'), regulators:str() = pkg_resources.resource_filename('JBioSeqTools', 'data/regulators.xlsx'), fluorescent_tag:str() = pkg_resources.resource_filename('JBioSeqTools',  'data/fluorescent_tag.xlsx'), backbone:str() = pkg_resources.resource_filename('JBioSeqTools', 'data/backbone.xlsx'), promoters:str() = pkg_resources.resource_filename('JBioSeqTools', 'data/promoters.xlsx'), restriction:str() = pkg_resources.resource_filename('JBioSeqTools', 'data/restriction_enzymes.xlsx'),  polya:str() = pkg_resources.resource_filename('JBioSeqTools', 'data/polya.xlsx'), marker:str() = pkg_resources.resource_filename('JBioSeqTools', 'data/selectors.xlsx'),  rnai:str() = pkg_resources.resource_filename('JBioSeqTools', 'data/rnai_scoring.xlsx'), capacity:str() = pkg_resources.resource_filename('JBioSeqTools', 'data/vector_capacity.xlsx'), utr5:str() = pkg_resources.resource_filename('JBioSeqTools', 'data/vector_capacity.xlsx'), utr3:str() = pkg_resources.resource_filename('JBioSeqTools', 'data/vector_capacity.xlsx')):
    ...
    Args:
       The values ought to be default for proper work!
    ...
    try:
        ...
        metadata = {'codons':codons, 'vectors':vectors, 'linkers':linkers, 'regulators':regulators, 'fluorescent_tag':fluorescent_tag, 'backbone':backbone, 'promoters':promoters, 'restriction':restriction, 'polya_seq':polya, 'selection_markers':marker, 'rnai':rnai, 'capacity':capacity, 'utr5':utr5, 'utr3':utr3}
