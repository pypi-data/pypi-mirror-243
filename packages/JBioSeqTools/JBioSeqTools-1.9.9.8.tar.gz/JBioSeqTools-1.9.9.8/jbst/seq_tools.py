...
def load_metadata(linkers = True, loops = True, regulators = True, fluorescent_tag = True, promoters = True,  polya = True, marker = True, utr5 = True, utr3 = True, source = _cwd):
    ...
    try:
        ...
        if utr5 == True: 
            utr5 = os.path.join(source, 'data/vector_capacity.xlsx')
        ...
        if utr3 == True: 
            ...
            utr3 = os.path.join(source, 'data/vector_capacity.xlsx')
