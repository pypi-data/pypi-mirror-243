...
class Network(object):
    ...
    def __init__(self, active_state=None, data_center_id=None, external_ip_address=None, gateway=None, id=None, init_state=None, internal_ip_address=None, ip_range=None, price_hr=None, short_state=None, size=None, _configuration=None):  # noqa: E501
