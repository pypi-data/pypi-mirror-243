...
PARSER_c.add_argument(
    '--grpci',
    help='Int in group c. (default=None)',
    dest='excc_int',
    type=int,
)
PARSER_c.add_argument(
    '--grpcf',
    help='Float in group c. (default=None)',
    dest='excc_float',
    type=float,
)
PARSER_d.add_argument(
    '--grpdi',
    help='Int in group d. (default=None)',
    dest='excd_int',
    type=int,
)
PARSER_d.add_argument(
    '--grpdf',
    help='Float in group d. (default=None)',
    dest='excd_float',
    type=int,
)
...
def main() -> NoReturn:  # pragma: no cover
    ...
    from tests.declinate.cli2_groups.declinate import command
    runargs = {
