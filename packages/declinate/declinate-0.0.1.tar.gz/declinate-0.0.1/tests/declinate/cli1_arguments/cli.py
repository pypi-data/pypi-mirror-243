...
PARSER.add_argument(
    '--deffalse',
    help='A bool usually false.',
    dest='deffalse_boolean',
    action='store_true',
)
PARSER.add_argument(
    '--deftrue',
    help='A bool usually true.',
    dest='deftrue_boolean',
    action='store_false',
)
PARSER.add_argument(
    '--opt',
    help='An optional int. (default=42)',
    dest='optional_number',
    type=int,
)
PARSER.add_argument(
    'helpover',
...
def main() -> NoReturn:  # pragma: no cover
    ...
    from tests.declinate.cli1_arguments.declinate import command
    runargs = {
