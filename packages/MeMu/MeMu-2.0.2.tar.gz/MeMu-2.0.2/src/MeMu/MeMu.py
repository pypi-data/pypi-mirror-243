...
class Memu:
    def __init__(self):
        ...
        self.font_path = resources.resource_filename(__name__, 'Gbboot-ALpM.ttf')
        self.custom_font = font.Font(family="G.B.BOOT", name="G.B.BOOT")
        self.image_path = resources.resource_filename(__name__, 'bg.png')
        self.icon_path = resources.resource_filename(__name__, 'icon.ico')
