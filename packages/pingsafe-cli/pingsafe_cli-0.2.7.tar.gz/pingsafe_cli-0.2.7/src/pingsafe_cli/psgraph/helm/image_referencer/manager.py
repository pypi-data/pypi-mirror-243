...
from pingsafe_cli.psgraph.helm.image_referencer.provider.helm import HelmProvider
...
class HelmImageReferencerManager(GraphImageReferencerManager):
    ...
    def __init__(self, graph_connector: Union[Graph, DiGraph], original_root_dir: str, temp_root_dir: str):
