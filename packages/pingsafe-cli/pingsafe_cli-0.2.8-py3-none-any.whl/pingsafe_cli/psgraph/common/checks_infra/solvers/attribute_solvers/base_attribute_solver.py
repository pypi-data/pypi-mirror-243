...
from pingsafe_cli.psgraph.common.graph.graph_builder.graph_components.block_types import BlockType
from pingsafe_cli.psgraph.common.util.var_utils import is_terraform_variable_dependent
from pingsafe_cli.psgraph.terraform.graph_builder.graph_components.block_types import BlockType as TerraformBlockType

if TYPE_CHECKING:
    from bc_jsonpath_ng import JSONPath
    from pingsafe_cli.psgraph.common.typing import LibraryGraph
