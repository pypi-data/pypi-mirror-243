...
from pingsafe_cli.psgraph.common.util.parser_utils import TERRAFORM_NESTED_MODULE_PATH_SEPARATOR_LENGTH, \
...
from pingsafe_cli.psgraph.common.graph.graph_builder.graph_components.attribute_names import CustomAttributes
from pingsafe_cli.psgraph.terraform.graph_builder.graph_components.block_types import BlockType
from pingsafe_cli.psgraph.terraform.graph_builder.variable_rendering.vertex_reference import TerraformVertexReference
...
def get_referenced_vertices_in_value(
    ...
    if isinstance(value, str):
        value_len = len(value)
        if PINGSAFE_RENDER_MAX_LEN and 0 < PINGSAFE_RENDER_MAX_LEN < value_len:
