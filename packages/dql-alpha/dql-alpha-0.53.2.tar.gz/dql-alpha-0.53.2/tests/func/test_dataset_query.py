...
def test_row_generator_with_new_columns_empty_values(
    ...
    new_col_values_empty = tuple(t.default_value() for c, t in new_columns)
...
def test_json_loader(cloud_test_catalog):
    ...
    col_default_values = tuple(t.default_value() for _, t in json_output)
