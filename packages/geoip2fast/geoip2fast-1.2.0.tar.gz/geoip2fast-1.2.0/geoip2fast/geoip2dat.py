...
# -*- coding: utf-8 -*-
"""
GeoIP2Dat v1.2.0 - DAT file update for GeoIP2Fast
"""
"""
...
reservedNetworks = {
    ...
    ##──── If you want to include the networks of your private network, you can include them at the end of this dictionary ────────
    # "10.10.0.0/16":      {"17":"Internal Network - BR - São Paulo - sa-east-1"},
    # "10.20.0.0/16":      {"18":"Internal Network - US - North Virginia - us-east-1"},
    # "10.20.0.0/16":      {"19":"Internal Network - US - Ohio - us-east-2"},
    }
    ...
    with elapsed_timer() as elapsed_total:
        ...
        with elapsed_timer() as elapsed:
            ...
            database = [ __DAT_VERSION__,  # integer
                        ...
                        mainList           # list of lists [mainIndex,listNamesCountry,listFirstIP,listIDCountryCodes,listNetlength]
            ]
...
def main_function():
    ...
    # HIDDEN
    # optional1.add_argument('--mini',dest="mini",action='store_true',default=False,help=SUPPRESS) # for future use
    # optional1.add_argument("--source-info",dest='sourceinfo',action="store",metavar="<text>",default="",help="Provide data source information to be written in the dat file. Default: "+DEFAULT_SOURCE_INFO+"YYYYMMDD")
