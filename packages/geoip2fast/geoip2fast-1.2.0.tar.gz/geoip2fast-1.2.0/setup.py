...
setup(
    ...
    project_urls={
        ...
        "Legacy v1.1.9 DAT files": "https://github.com/rabuchaim/geoip2fast/releases/tag/LEGACY_v1.1.9",
    },    
    ...
    zip_safe = False,
    package_data={
        'geoip2fast': ['CHANGELOG','geoip2fast.dat.gz','geoip2fast-ipv6.dat.gz','geoip2fast-asn.dat.gz','geoip2fast-asn-ipv6.dat.gz',
                       'tests/geoip2fast_test.py','tests/speed_test.py','tests/coverage_test.py','tests/compare_with_mmdb.py','tests/random_test.py','tests/geoipcli.py'],
    },
    entry_points={
        'console_scripts': [
