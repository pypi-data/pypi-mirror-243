...
class LayerNextClient:
    ...
    def auto_tag_collection(
        ...
        _automatic_analysis_client.model_tag_collection(
            collection_id, model_id, input_resolution,confidence_threshold,session_id,job_name)
    ...
    def generate_auto_tags_to_metalake(
        ...
        _automatic_analysis_client.model_tag_population(
            item_type, model_id, input_resolution, confidence_threshold,session_id,job_name)
    ...
    def generate_embeddings_for_collection(
        ...
        _automatic_analysis_client.embedding_model_inference_collection(
            collection_id, model_id, query, filters, session_id, job_name)
        return {"jobId": job_id}
    ...
    def generate_embeddings_to_metalake(
        ...
        _automatic_analysis_client.model_embedding_population(
            item_type, model_id, query, filters, session_id, job_name)
