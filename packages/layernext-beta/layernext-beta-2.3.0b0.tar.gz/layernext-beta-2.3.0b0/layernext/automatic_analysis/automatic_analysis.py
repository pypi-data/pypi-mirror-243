...
class AutomaticAnalysis:
    ...
    def tagger_detail_send(self, application, collection_id, item_type, model_id, input_resolution,confidence_threshold,session_id,job_name):
    ...
    def annotater_detail_send(self,application,project_id,model_id, annotation_type,session_id,job_name, **kwargs):
    ...
    def embedding_detail_send(self, collection_id, model_id, application,item_type, query, filters, session_id, job_name):
