...
class AutomaticAnalysisClient:
    ...
    def model_tag_collection(
        ...
        try:
            ...
            self.automatic_analysis.tagger_detail_send(
                application, collection_id, item_type, model_id, input_resolution, confidence_threshold,session_id,job_name)
        except ValueError as e:
            print(f"ValueError: {e}")
    ...
    def model_annotate_collection(
        ...
        try:
            ...
            self.automatic_analysis.annotater_detail_send(
                application,project_id,model_id, annotation_type,session_id,job_name, **kwargs)
        except ValueError as e:
            print(f"ValueError: {e}")
    ...
    def embedding_model_inference_collection(
        ...
        item_type=""
        self.automatic_analysis.embedding_detail_send(
            collection_id, model_id, application,item_type, query, filters, session_id,job_name)
