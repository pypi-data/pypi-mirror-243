...
# 
# File: gpt_api.py
# Description: GPT API. This file contains the OPENAI_GPT_Config class
...
class OPENAI_GPT(object):
    ...
    def __init__(self, **kwargs):
        ...
        # get path to environment variables
        env_file_path = self.kwargs['env_file_path']
    ...
    # process text data
    def load_strings(self, data):
        '''
        Load strings.
        It loads the strings to be processed.
    ...
    # load embeddings
    def load_embeddings_from_csv(self, embeddings_path, columns=[], **kwargs):
        '''
