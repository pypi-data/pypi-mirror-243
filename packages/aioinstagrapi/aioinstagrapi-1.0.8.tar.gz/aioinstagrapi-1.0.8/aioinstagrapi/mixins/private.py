...
class PrivateRequestMixin:
    ...
    @retry(retry=retry_if_exception_type(httpx.TimeoutException), stop=stop_after_attempt(10), wait=wait_random(1,3))
        ...
        try:
            ...
            if data:  # POST
                ...
                async with httpx.AsyncClient(
                    ...
                    headers=req_headers, 
                    verify=False,
                    timeout=Timeout(None, connect=15),
                    ...
                    response = await client.post(
                        url=api_url, data=data, params=params, 
                    )
            else:  # GET
                async with httpx.AsyncClient(
                    proxies=self.proxies, 
