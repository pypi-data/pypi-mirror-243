...
class MongoDB(BaseDB):
    ...
    def connect(self) -> MongoClient:
        ...
        try:
            ...
            if (
                self.db_connection_config.mongo_db_config.database is not None
                and self.db_connection_config.mongo_db_config.database != ""
                and self.db is None
            ):
                self.set_db(self.db_connection_config.mongo_db_config.database)
