...
def take_screenshot_by_xpath_in_tablet(url, element_xpath, element_name, componentName,folder="baseline"):
    try:
        ...
        options.add_argument("start-maximized")
        options.add_argument("--headless")
        options.add_argument("--window-size=720,1024")
        ...
        driver.set_window_size(720,web_page_height)
...
def take_screenshot_by_xpath_in_mobile(url, element_xpath, element_name, componentName,folder="baseline"):
    try:
        ...
        options.add_argument("start-maximized")
        options.add_argument("--headless")
        options.add_argument("--window-size=660,1280")
        ...
        driver.set_window_size(660,web_page_height)
...
def assert_elements_screenshots(self, url, section_xpaths, element_name, componentName, folder="baseline",screenSize='desktop'):
