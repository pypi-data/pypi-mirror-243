...
def take_screenshots_by_xpath(url, elements_xpaths, componentName, folder="baseline"):
    for key, value in elements_xpaths.items():        
        take_screenshot_by_xpath(url, value, key, componentName,folder)

def take_screenshot_by_xpath(url, element_xpath, element_name, componentName,folder="baseline"):
    try:
...
def assert_elements_screenshots(self, url, section_xpaths, element_name, componentName, folder="baseline"):
