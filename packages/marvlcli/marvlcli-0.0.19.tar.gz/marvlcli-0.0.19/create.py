...
def vm(name, flavor, image, userdata, netid):
    file_name_with_path = pkg_resources.resource_filename(__name__, 'package_data/myuserdata_marv_default.txt')

    filename= userdata if userdata is not None else file_name_with_path
