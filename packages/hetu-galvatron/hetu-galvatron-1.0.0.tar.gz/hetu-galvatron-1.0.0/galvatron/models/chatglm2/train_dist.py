...
from galvatron.models.chatglm2.ChatGLMModel_hybrid_parallel import get_hybrid_parallel_configs, construct_hybrid_parallel_model
...
def train(args):
    ...
    # from galvatron.models.chatglm2 import chatglm2_model_hp
    # model = chatglm2_model_hp(config, args)
