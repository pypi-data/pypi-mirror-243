...
from galvatron.models.vit.arguments import model_args, layernum_arg_names
from galvatron.models.vit.hf_configs import vit_hf_configs, set_model_config, model_name
