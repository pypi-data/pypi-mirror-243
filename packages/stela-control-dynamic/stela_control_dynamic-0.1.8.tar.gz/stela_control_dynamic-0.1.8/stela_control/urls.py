...
urlpatterns = [
    ...
    path('dycontent/honors', views.siteHonors, name="site-honors"),
    path('dycontent/gallery', views.siteGallery, name="site-gallery"),
    path('dycontent/staff', views.siteStaff, name="site-staff"),
