...
class Invoice(BaseModelAbstract, models.Model):
    ...
    interest = models.DecimalField(
        ...
        help_text="This is the amount that goes to the Financier as "
                  "interest/profit"
    )
    ...
    buyer_amount = models.DecimalField(
        decimal_places=2, max_digits=30, default=0,
        help_text="This is the amount that will be paid back by the Buyer"
    )
    seller_amount = models.DecimalField(
        decimal_places=2, max_digits=30, default=0,
        help_text="This is the amount that is sent to SME"
    )
    financier_amount = models.DecimalField(
        decimal_places=2, max_digits=30, default=0,
        help_text="This is the amount paid by Financier"
    )
