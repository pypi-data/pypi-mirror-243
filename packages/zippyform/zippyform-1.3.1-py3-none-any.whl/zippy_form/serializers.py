...
class AccountSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        primary_payment_gateway = attrs.get('timezone', None)
...
class AccountPaymentUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Account
        fields = ['id', 'meta_detail', 'is_payment_collect_enabled', 'primary_payment_gateway',
...
class AccountProfileUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Account
        fields = ['id', 'name', 'admin_email', 'timezone']
...
class FormPaymentSettingsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'payment_type', 'payment_mode', 'currency', 'price', 'tax', 'form', 'account', 'redirect_url',
