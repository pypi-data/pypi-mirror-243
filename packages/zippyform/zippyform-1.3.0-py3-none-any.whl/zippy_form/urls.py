...
from zippy_form.views import form_list, create_form, update_form, delete_form, \
    ...
    create_account, account_list, form_submission_details, delete_form_submission_detail, create_webhook, webhook_list, \
    ...
    get_form_active_number_fields

urlpatterns = [
    path('builder/account/list', account_list),
    path('builder/account/create', create_account),
    path('builder/account/<uuid:account_id>/update-payment-details', update_accountt_payment_details),
    ...
    path('builder/<uuid:form_id>/submission/<uuid:form_submission_id>/delete', delete_form_submission_detail),
    ...
    path('builder/form/payment_settings/<uuid:form_id>/<payment_gateway>/<payment_mode>/details', get_form_payment_settings),
