...
def tint_flip(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Switch tint colors :File: `startup/bl_ui/properties_grease_pencil_common.py\:881 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_ui/properties_grease_pencil_common.py#L881>`__
