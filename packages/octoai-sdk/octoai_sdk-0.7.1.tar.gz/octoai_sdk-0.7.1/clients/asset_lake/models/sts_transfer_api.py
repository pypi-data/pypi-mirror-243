...
class StsTransferApi(BaseModel):
    ...
    __properties = ["aws_access_key_id", "aws_secret_access_key", "aws_session_token", "s3_bucket", "s3_endpoint_url", "s3_key", "s3_url", "type"]
    ...
    def to_dict(self):
        ...
        if self.aws_session_token is None and "aws_session_token" in self.__fields_set__:
