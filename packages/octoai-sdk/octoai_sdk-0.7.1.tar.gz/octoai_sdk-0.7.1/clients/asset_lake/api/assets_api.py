...
from pydantic.v1 import StrictBool, StrictInt, StrictStr
...
class AssetsApi:
    ...
    @validate_arguments
    def list_assets_v1_assets_get(self, name : Optional[StrictStr] = None, is_public : Optional[StrictBool] = None, data_type : Optional[DataType] = None, asset_type : Optional[AssetType] = None, engine : Optional[BaseEngine] = None, limit : Optional[StrictInt] = None, offset : Optional[StrictInt] = None, get_preview_urls : Optional[StrictBool] = None, asset_ids : Optional[StrictStr] = None, owner : Optional[StrictStr] = None, **kwargs) -> ListAssetsResponse:  # noqa: E501
    ...
    @validate_arguments
    def list_assets_v1_assets_get_with_http_info(self, name : Optional[StrictStr] = None, is_public : Optional[StrictBool] = None, data_type : Optional[DataType] = None, asset_type : Optional[AssetType] = None, engine : Optional[BaseEngine] = None, limit : Optional[StrictInt] = None, offset : Optional[StrictInt] = None, get_preview_urls : Optional[StrictBool] = None, asset_ids : Optional[StrictStr] = None, owner : Optional[StrictStr] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List Assets  # noqa: E501
