...
class CreateAssetRequest(BaseModel):
    ...
    __properties = ["asset_type", "data", "description", "is_public", "name", "transfer_api_type"]
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.transfer_api_type is None and "transfer_api_type" in self.__fields_set__:
