...
class ImageGenerationRequest(BaseModel):
    ...
    __properties = ["prompt", "prompt_2", "negative_prompt", "negative_prompt_2", "checkpoint", "vae", "textual_inversions", "loras", "sampler", "height", "width", "cfg_scale", "steps", "num_images", "seed", "init_image", "mask_image", "strength", "style_preset", "use_refiner", "high_noise_frac", "enable_safety", "image_encoding", "force_asset_download", "force_asset_gpu_copy"]
