...
DATA_ONE_OF_SCHEMAS = ["CheckpointData", "FileData", "LoraData", "TextualInversionData", "VAEData", "VolumeData"]
...
class Data(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Union[CheckpointData, FileData, LoraData, TextualInversionData, VAEData, VolumeData]
    else:
        actual_instance: Any
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in Data with oneOf schemas: CheckpointData, FileData, LoraData, TextualInversionData, VAEData, VolumeData. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in Data with oneOf schemas: CheckpointData, FileData, LoraData, TextualInversionData, VAEData, VolumeData. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Data:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into Data with oneOf schemas: CheckpointData, FileData, LoraData, TextualInversionData, VAEData, VolumeData. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Data with oneOf schemas: CheckpointData, FileData, LoraData, TextualInversionData, VAEData, VolumeData. Details: " + ", ".join(error_messages))
        else:
            return instance
