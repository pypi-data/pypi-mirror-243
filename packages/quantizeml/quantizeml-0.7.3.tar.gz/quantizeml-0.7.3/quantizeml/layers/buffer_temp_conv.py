...
from .recorders import TensorRecorder, NonTrackVariable
...
@tf.keras.utils.register_keras_serializable()
class QuantizedBufferTempConv(BufferTempConv):
    ...
    def call(self, inputs):
        ...
        fifo_q = FixedPoint.quantize(self.fifo, inputs.value_bits, inputs.frac_bits)
        # Align FIFO
        fifo_aligned = self._align_fifo(fifo_q)
...
@register_aligned_inputs
@tf.keras.utils.register_keras_serializable()
class QuantizedDepthwiseBufferTempConv(DepthwiseBufferTempConv):
