...
project = 'ByteBlower RFC 2544 Test Case'
copyright = f'{date.today().year!s}, Excentis NV'
author = 'Excentis NV'

# The full version, including alpha/beta/rc tags
release = metadata.version('byteblower-test-cases-rfc-2544')
