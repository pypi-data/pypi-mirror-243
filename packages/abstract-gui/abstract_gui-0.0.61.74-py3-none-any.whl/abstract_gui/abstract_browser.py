    ...
    def get_scan_browser_layout(section=None,extra_buttons=[]):
        ...
        return [
            [make_component("Text",'Directory to scan:'), make_component("InputText",os.getcwd(),key=text_to_key(text='dir',section=section)),
             ...
             [[make_component("Checkbox",'all',default=True, enable_events=True,key=text_to_key(text='scan mode all',section=section))],
              [make_component("Checkbox",'files',default=False, enable_events=True,key=text_to_key(text='scan mode files',section=section))],
              [make_component("Checkbox",'folders',default=False,enable_events=True,key=text_to_key(text='scan mode folders',section=section))]]],
