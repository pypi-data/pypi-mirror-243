...
class AbstractBrowser:
    ...
    def get_scan_browser_layout(section=None, extra_buttons=[]):
        ...
        checkboxes_layout = [
            [sg.Checkbox('All', default=True, key=text_to_key(text='scan mode all',section=section))],
            [sg.Checkbox('Files', key=text_to_key(text='file browser',section=section))],
        ...
        return [
            [sg.Text('Directory to scan:'), sg.InputText(os.getcwd(),key=text_to_key(text='dir',section=section)), sg.Column([browser_buttons_layout])],
