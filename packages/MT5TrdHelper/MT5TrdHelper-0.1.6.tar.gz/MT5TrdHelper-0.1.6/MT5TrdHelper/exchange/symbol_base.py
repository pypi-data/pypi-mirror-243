...
class Symbol(_ContextAwareBase, Connection):
    ...
    def time(self) -> datetime:
        ...
        """
        return pd.to_datetime(self._data('time')[-2], unit='s')
    ...
    def low(self) -> float:
        ...
        """
        return self._data('low', self.needed_bar, self.needed_bar)
    ...
    def high(self) -> float:
        ...
        last low price for defined timeframe, by default daily
        """
        return self._data('high', self.needed_bar, self.needed_bar)
    ...
    def open(self) -> float:
        ...
        """
        return self._data('open', self.needed_bar, self.needed_bar)
    ...
    def real_volume(self) -> float:
        ...
        """
        return self._data('real_volume', self.needed_bar, self.needed_bar)
    ...
    def volume(self) -> float:
        ...
        """
        return self._data('volume', self.needed_bar, self.needed_bar)
    ...
    def copy_rates_from_pos(self, start_pos=0, to_pos=500):
        """
        ...
        with self.connected:
            bars = copy_rates_from_pos(
                self.name, self.timeframe, start_pos=start_pos, to_pos=to_pos)

            return bars

    def get_rates_bar(self, ohlcv: bool = True, start_postion=0, datetime_from: Union[datetime, int] = None, datetime_to: Union[datetime, int] = None,):
        """
        This will get array of bar data, if you want dataframe use make_ohlcv function
