...
import datetime, time, sys, os, json, jq, regex as re, random, threading, concurrent.futures, subprocess, asyncio
...
class ChadExtractor:
	...
	async def __browser_requests(self, records):
		...
		try:
			...
			browser = await pw.chromium.launch(headless = True, proxy = self.__proxy)
...
class Validate:
	...
	def __basic(self):
		...
		print("Chad Extractor v4.5 ( github.com/ivan-sincek/chad )")
		print("")
