...
python3 -m pip install dist/google_chad-4.5-py3-none-any.whl
...
There is a 4 seconds delay between starting headless browsers; otherwise, it would be very resources-intensive.
...
```fundamental
Chad v4.5 ( github.com/ivan-sincek/chad )
...
```fundamental
Chad Extractor v4.5 ( github.com/ivan-sincek/chad )
