...
from automation import (
    ...
    generate_rubric_from_use_case,
    generate_use_case_from_shadow_traffic,
    TestResult,
    PromptEvaluation,
)
import click
...
class FarsightAI:
    ...
    def get_best_system_prompts(
        ...
        if not rubric or not reference_answer:
            print("Generating your use case...")
            ...
            if not click.confirm(
                "Does this paragraph describe your use case?", default=True
            ):
                print(
                    "Please edit this use case and recall this function with it included as a use_case parameter"
                )

            if not rubric:
                print("Generating your rubric ...")
                ...
                # """
                print(rubric)
                if not click.confirm("Does this rubric make sense?", default=True):
                    print(
                        "Please edit this rubric and recall this function with it included as a rubric parameter"
                    )
            if not reference_answer:
                print("Generating your reference answer ...")
        ...
        print("Starting your prompt generation and evaluation ...")
        problems_str = ""
        prev_prompts_and_scores = ""
            ...
            for i in tqdm(
                ...
                for j in tqdm(
                    ...
                    if match:
                        ...
                        score = int(match.group(1))
                        score_sum += score
                        test_results.append(TestResult(test_input, output, score))
                    else:
                        print("Score not found in the input string.")
