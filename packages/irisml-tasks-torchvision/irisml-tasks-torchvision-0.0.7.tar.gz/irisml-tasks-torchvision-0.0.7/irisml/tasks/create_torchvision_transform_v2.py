...
class Task(irisml.core.TaskBase):
    ...
    Config:
        ...
        task_type (str): A task type. One of "classification_multiclass", "classification_multilabel", "object_detection", "phrase_grounding".
    """
    VERSION = '0.1.0'
    ...
    class Config:
        ...
        task_type: Literal['classification_multiclass', 'classification_multilabel', 'object_detection', 'phrase_grounding'] = 'classification_multiclass'
