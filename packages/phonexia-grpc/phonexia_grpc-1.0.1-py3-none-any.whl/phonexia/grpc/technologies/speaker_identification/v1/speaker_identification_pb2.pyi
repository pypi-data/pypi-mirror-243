...
class ExtractRequest(google.protobuf.message.Message):
    ...
    def config(self) -> global___ExtractConfig:
        """Voiceprint extration configuration."""
    def __init__(
        self,
        *,
...
class ExtractConfig(google.protobuf.message.Message):
    ...
    AUDIO_TIME_RANGE_FIELD_NUMBER: builtins.int
    @property
    def audio_time_range(self) -> phonexia.grpc.common.core_pb2.TimeRange:
        """Time range of the audio to extract voiceprints from. If omitted, the
        voiceprint is extracted from the whole audio. If <code>start</code> is omitted, the
        voiceprint is extracted from the beginning of the audio. If <code>end</code> is omitted,
        the voiceprint is extracted till the end of the audio.
        """
    def __init__(
        self,
        *,
        audio_time_range: phonexia.grpc.common.core_pb2.TimeRange | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["audio_time_range", b"audio_time_range"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["audio_time_range", b"audio_time_range"]) -> None: ...
