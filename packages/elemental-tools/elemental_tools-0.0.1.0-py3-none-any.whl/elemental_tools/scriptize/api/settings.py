...
from elemental_tools.scriptize.config import app_name, envi, db_url, logger, database_name
from elemental_tools.scriptize.api.config import root_user

if "install" in __name__:
	from elemental_tools.logger import Logger
	logger = Logger(app_name=f'{os.path.basename(__name__)}', owner='installation').log

from elemental_tools.scriptize.exceptions import SettingMissing
