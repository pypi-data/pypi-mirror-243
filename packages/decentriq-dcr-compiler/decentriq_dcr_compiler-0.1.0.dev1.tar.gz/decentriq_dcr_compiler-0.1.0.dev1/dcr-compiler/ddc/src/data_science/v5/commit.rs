...
pub type DataScienceCommitKind5 = v2::DataScienceCommitKindV2;

#[derive(Debug, Clone, Serialize, Deserialize, JsonSchema)]
#[serde(rename_all = "camelCase")]
pub struct DataScienceCommitV5 {
    pub id: String,
    pub name: String,
    pub enclave_data_room_id: String,
    pub history_pin: String,
    pub kind: DataScienceCommitKind5,
}

impl DataScienceCommitV5 {
    pub fn downgrade(self) -> Result<v4::DataScienceCommitV4, CompileError> {
        Ok(v4::DataScienceCommitV4 {
            id: self.id,
            name: self.name,
...
fn check_mergeability(
    context: &v5::CommitCompileContextV5,
    incoming: &DataScienceCommitV5,
) -> Result<(), CompileError> {
    match &incoming.kind {
...
impl Compile for DataScienceCommitV5 {
    type CompileContext = v5::CommitCompileContextV5;
