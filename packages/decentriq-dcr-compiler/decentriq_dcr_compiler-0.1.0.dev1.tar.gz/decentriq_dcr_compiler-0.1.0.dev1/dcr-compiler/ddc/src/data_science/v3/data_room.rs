...
use crate::data_science::v3::add_node_configuration_elements;
use crate::data_science::v3::CommitCompileContextV3;
use crate::data_science::v3::DataScienceCommitV3;
use crate::data_science::v4;
use crate::data_science::v4::DataScienceDataRoomConfigurationV4;
...
#[derive(Debug, Clone, Serialize, Deserialize, JsonSchema)]
#[serde(rename_all = "camelCase")]
pub struct DataScienceDataRoomConfigurationV3 {
    pub id: String,
    pub title: String,
...
#[derive(Debug, Clone, Serialize, Deserialize, JsonSchema)]
#[serde(rename_all = "camelCase")]
pub struct InteractiveDataScienceDataRoomV3 {
    pub initial_configuration: DataScienceDataRoomConfigurationV3,
    pub commits: Vec<DataScienceCommitV3>,
    pub enable_automerge_feature: bool,
}

fn compile_configuration(
    configuration: DataScienceDataRoomConfigurationV3,
    enable_interactivity: bool,
) -> Result<(DataRoom, CommitCompileContextV3), CompileError> {
    ...
    for node in configuration.nodes {
        add_node_configuration_elements(node, &mut configuration_elements, &enclave_specifications_map, &nodes_map)?;
    }
    ...
    let output_context = CommitCompileContextV3 {
        nodes_map,
...
impl Compile for DataScienceDataRoomV3 {
    ...
    fn compile(self, _: Self::CompileContext) -> Result<Self::CompileOutput, CompileError> {
        ...
        match self_clone {
            DataScienceDataRoomV3::Interactive(interactive_data_room) => {
            ...
            DataScienceDataRoomV3::Static(static_data_room) => {
...
impl DataScienceDataRoomV3 {
    pub fn upgrade(self) -> v4::DataScienceDataRoomV4 {
        match self {
            DataScienceDataRoomV3::Static(dcr) => {
                v4::DataScienceDataRoomV4::Static(DataScienceDataRoomConfigurationV4 {
                    id: dcr.id,
                    title: dcr.title,
                    ...
                    enable_safe_python_worker_stacktrace: dcr.enable_safe_python_worker_stacktrace,
                })
            }
            DataScienceDataRoomV3::Interactive(dcr) => {
                v4::DataScienceDataRoomV4::Interactive(v4::InteractiveDataScienceDataRoomV4 {
                    initial_configuration: DataScienceDataRoomConfigurationV4 {
                        ...
                        enclave_root_certificate_pem: dcr.initial_configuration.enclave_root_certificate_pem,
                        ...
                        enable_serverside_wasm_validation: dcr.initial_configuration.enable_serverside_wasm_validation,
                        ...
                        enable_safe_python_worker_stacktrace: dcr
                            .initial_configuration
                            .enable_safe_python_worker_stacktrace,
                    },
                    commits: dcr.commits.into_iter().map(|commit| commit.upgrade()).collect(),
