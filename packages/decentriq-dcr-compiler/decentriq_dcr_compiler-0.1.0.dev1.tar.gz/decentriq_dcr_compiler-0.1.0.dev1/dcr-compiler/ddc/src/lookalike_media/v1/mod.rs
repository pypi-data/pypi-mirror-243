...
pub const DQ_MEDIA_DCR_FILE: &str = "dq_media_dcr-0.2.0.tar.gz";
pub const DQ_MEDIA_DCR_ID: &str = "dq_media_dcr";
pub const DQ_MEDIA_DCR_TAR_GZ: &[u8] = include_bytes!("./dq_media_dcr-0.2.0.tar.gz");
...
pub struct LookalikeMediaDataRoomV1 {
    pub id: String,
    pub name: String,
...
impl LookalikeMediaDataRoomV1 {
    pub fn upgrade(self) -> LookalikeMediaDataRoom {
        LookalikeMediaDataRoom::V2(LookalikeMediaDataRoomV2 {
            id: self.id,
            name: self.name,
...
struct LookalikeMediaDataRoomCompilerV1<'a> {
    data_room: &'a LookalikeMediaDataRoomV1,
...
pub fn compile_lookalike_media_data_room_v1(data_room: &LookalikeMediaDataRoomV1) -> Result<DataRoom, CompileError> {
    LookalikeMediaDataRoomCompilerV1::new(data_room).compile()
}

fn data_room_to_data_room_config(
    _data_room: &LookalikeMediaDataRoomV1,
...
impl<'a> LookalikeMediaDataRoomCompilerV1<'a> {
    pub fn new(data_room: &'a LookalikeMediaDataRoomV1) -> Self {
            ...
            ContainerNode {
                ...
                mount_points: vec![
                    ...
                    MountPoint {
                        ...
                        dependency: validation::v2::get_validation_id(DATASET_AUDIENCES_ID),
                    },
                ...
                memory_allocation_strategy: MemoryAllocationStrategy::SqlOptimized,
                additional_dependencies: vec![
                    validation::v2::get_validation_check_id(DATASET_AUDIENCES_ID).to_string(),
