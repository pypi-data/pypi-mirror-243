...
pub type ActivationTypeV3 = v0::ActivationType;
pub type EnclaveSpecificationV3 = v0::EnclaveSpecification;
pub type MediaDataRoomConfigV3 = v0::MediaDataRoomConfig;
pub type MediaAuxiliaryStateV3 = v0::MediaAuxiliaryStateV0;
pub type DirectActivationConfigV3 = v0::DirectActivationConfigV0;
...
// Common
pub const OVERLAP_BASIC_PY: &[u8] = include_bytes!("../v3/overlap_basic.py");
// For direct activation and no activation we use the old overlap_basic.py, v3 does not support these.
pub const OVERLAP_BASIC_PY_OLD: &[u8] = include_bytes!("../v2/overlap_basic.py");

// Consentless activation
pub const CONSENTLESS_OVERLAP_INSIGHTS_PY: &[u8] = include_bytes!("../v3/consentless_overlap_insights.py");

// Direct activation
pub const DIRECT_ACTIVATION_ALL_PY: &[u8] = include_bytes!("../v3/direct_activation_all.py");
pub const DIRECT_ACTIVATION_PY: &[u8] = include_bytes!("../v3/direct_activation.py");

pub type MediaDataRoomV3 = v2::MediaDataRoomV2;

struct MediaDataRoomCompilerV3<'a> {
    data_room: &'a MediaDataRoomV3,
...
pub fn compile_media_data_room_v3(data_room: &MediaDataRoomV3) -> Result<DataRoom, CompileError> {
    MediaDataRoomCompilerV3::new(data_room).compile()
}

fn data_room_to_data_room_config(data_room: &MediaDataRoomV3) -> CompileResult<MediaDataRoomConfigV3> {
...
impl<'a> MediaDataRoomCompilerV3<'a> {
    pub fn new(data_room: &'a MediaDataRoomV3) -> Self {
    ...
    pub fn compile(mut self) -> CompileResult<DataRoom> {
        ...
        match &self.data_room.activation_type {
            None => {}
            Some(ActivationTypeV3::Direct) => {
                self.add_direct_activation_nodes()?;
            }
            Some(ActivationTypeV3::Consentless) => {
    ...
    fn add_common_nodes(&mut self) -> CompileResult<()> {
        ...
        let overlap_basic_script = match &self.data_room.activation_type {
            None => OVERLAP_BASIC_PY_OLD,
            Some(ActivationTypeV3::Consentless) => OVERLAP_BASIC_PY,
            Some(ActivationTypeV3::Direct) => OVERLAP_BASIC_PY_OLD,
        };
        self.configuration_elements.push(ConfigurationElement {
                ...
                node: Some(compute_node::Node::Branch(ComputeNodeBranch {
                    config: prost::Message::encode_length_delimited_to_vec(&DriverTaskConfig {
                        driver_task_config: Some(driver_task_config::DriverTaskConfig::StaticContent(
                            StaticContentConfig { content: overlap_basic_script.to_vec() },
                        )),
                    }),
                    dependencies: vec![],
            ...
            element: Some(configuration_element::Element::ComputeNode(ComputeNode {
                ...
                node: Some(compute_node::Node::Branch(ComputeNodeBranch {
                        ...
                        configuration: Some(container_worker_configuration::Configuration::Static(StaticImage {
                            ...
                            mount_points: vec![
                                ...
                                MountPoint {
                                    ...
                                    dependency: validation::v1::get_validation_id("dataset_advertiser"),
                                },
                                MountPoint {
                                    path: "dataset_publisher".into(),
                                    dependency: validation::v1::get_validation_id("dataset_publisher"),
                                },
                            ],
                    ...
                    dependencies: vec![
                        ...
                        validation::v1::get_validation_id("dataset_advertiser"),
                        validation::v1::get_validation_id("dataset_publisher"),
                        validation::v1::get_validation_check_id("dataset_advertiser"),
                        validation::v1::get_validation_check_id("dataset_publisher"),
                    ],
        ...
        self.add_permissions(vec![
            ...
            (P::execute_compute(&validation::v1::get_validation_report_id("dataset_advertiser")), [true, __, __, __]),
            (P::retrieve_compute_result(&validation::v1::get_validation_report_id("dataset_advertiser")), [
                true, __, __, __,
            ]),
            (P::execute_compute(&validation::v1::get_validation_report_id("dataset_publisher")), [__, true, __, __]),
            (P::retrieve_compute_result(&validation::v1::get_validation_report_id("dataset_publisher")), [
                __, true, __, __,
            ]),
        ...
        self.configuration_elements.push(ConfigurationElement {
            ...
            element: Some(configuration_element::Element::ComputeNode(ComputeNode {
                ...
                node: Some(compute_node::Node::Branch(ComputeNodeBranch {
                    config: prost::Message::encode_length_delimited_to_vec(&ContainerWorkerConfiguration {
                        configuration: Some(container_worker_configuration::Configuration::Static(StaticImage {
                            command: ["python3", "/input/consentless_overlap_insights.py"]
                                .iter()
                                .map(|s| s.to_string())
                                .collect::<Vec<_>>(),
                            mount_points: vec![
                                MountPoint {
                                    path: "consentless_overlap_insights.py".into(),
...
pub fn convert_data_room_v2_to_v3(data_room: v2::MediaDataRoomV2) -> CompileResult<MediaDataRoomV3> {
    Ok(MediaDataRoomV3 { ..data_room })
}
