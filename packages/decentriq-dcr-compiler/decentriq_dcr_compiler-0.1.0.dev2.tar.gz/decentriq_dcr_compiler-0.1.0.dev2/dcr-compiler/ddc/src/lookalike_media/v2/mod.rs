...
pub struct LookalikeMediaDataRoomV2 {
    pub id: String,
    pub name: String,
...
impl LookalikeMediaDataRoomV2 {
    pub fn try_upgrade(self) -> CompileResult<LookalikeMediaDataRoom> {
        Ok(LookalikeMediaDataRoom::V3(LookalikeMediaDcrWrapper {
            features: vec![],
            consumes: Requirements {
                ...
                required: vec![
                    ...
                    RequirementFlag::from_matching_id_format(&self.matching_id_format)?,
                    RequirementFlag::from_matching_id_hashing_algorithm(self.hash_matching_id_with.as_ref())?,
                ],
            },
            compute: LookalikeMediaDcrComputeOrUnknown::Known(LookalikeMediaDcrCompute::V0(
                LookalikeMediaDcrComputeV0 {
                    ...
                    rate_limit_publish_data_window_seconds: 0,
                    rate_limit_publish_data_num_per_window: 0,
                },
            )),
        }))
    }
...
struct LookalikeMediaDataRoomCompilerV2<'a> {
    data_room: &'a LookalikeMediaDataRoomV2,
...
pub fn compile_lookalike_media_data_room_v2(data_room: &LookalikeMediaDataRoomV2) -> Result<DataRoom, CompileError> {
    LookalikeMediaDataRoomCompilerV2::new(data_room).compile()
}

fn data_room_to_data_room_config(
    _data_room: &LookalikeMediaDataRoomV2,
...
impl<'a> LookalikeMediaDataRoomCompilerV2<'a> {
    pub fn new(data_room: &'a LookalikeMediaDataRoomV2) -> Self {
