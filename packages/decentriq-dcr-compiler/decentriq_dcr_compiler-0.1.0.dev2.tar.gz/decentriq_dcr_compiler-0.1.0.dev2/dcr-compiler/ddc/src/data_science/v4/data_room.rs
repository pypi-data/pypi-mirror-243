...
#[derive(Debug, Clone, Serialize, Deserialize, JsonSchema)]
#[serde(rename_all = "camelCase")]
pub struct DataScienceDataRoomConfigurationV4 {
    pub id: String,
    pub title: String,
...
#[derive(Debug, Clone, Serialize, Deserialize, JsonSchema)]
#[serde(rename_all = "camelCase")]
pub struct InteractiveDataScienceDataRoomV4 {
    pub initial_configuration: DataScienceDataRoomConfigurationV4,
    pub commits: Vec<v4::DataScienceCommitV4>,
    pub enable_automerge_feature: bool,
}

fn compile_configuration(
    configuration: DataScienceDataRoomConfigurationV4,
    enable_interactivity: bool,
) -> Result<(DataRoom, v4::CommitCompileContextV4), CompileError> {
    ...
    for node in configuration.nodes {
        v4::add_node_configuration_elements(
    ...
    for participant in configuration.participants.iter() {
        v4::add_participant_permission_configuration_elements(
            participant.clone(),
    ...
    let output_context = v4::CommitCompileContextV4 {
        nodes_map,
...
impl Compile for DataScienceDataRoomV4 {
    ...
    type OutputContext = v4::CommitCompileContextV4;

    fn compile(self, _: Self::CompileContext) -> Result<Self::CompileOutput, CompileError> {
        let self_clone = self.clone();
        match self_clone {
            DataScienceDataRoomV4::Interactive(interactive_data_room) => {
            ...
            DataScienceDataRoomV4::Static(static_data_room) => {
...
impl DataScienceDataRoomV4 {
    pub fn upgrade(self) -> v5::DataScienceDataRoomV5 {
        match self {
            DataScienceDataRoomV4::Static(dcr) => {
                v5::DataScienceDataRoomV5::Static(v5::DataScienceDataRoomConfigurationV5 {
                    id: dcr.id,
                    title: dcr.title,
                    ...
                    enable_allow_empty_files_in_validation: false,
                })
            }
            DataScienceDataRoomV4::Interactive(dcr) => {
                v5::DataScienceDataRoomV5::Interactive(v5::InteractiveDataScienceDataRoomV5 {
                    initial_configuration: v5::DataScienceDataRoomConfigurationV5 {
