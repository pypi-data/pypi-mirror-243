...
pub type DataScienceCommitKind4 = v2::DataScienceCommitKindV2;

#[derive(Debug, Clone, Serialize, Deserialize, JsonSchema)]
#[serde(rename_all = "camelCase")]
pub struct DataScienceCommitV4 {
    pub id: String,
    pub name: String,
    pub enclave_data_room_id: String,
    pub history_pin: String,
    pub kind: DataScienceCommitKind4,
}

impl DataScienceCommitV4 {
    pub fn downgrade(self) -> Result<v3::DataScienceCommitV3, CompileError> {
        Ok(v3::DataScienceCommitV3 {
            id: self.id,
            name: self.name,
    ...
    pub fn upgrade(self) -> v5::DataScienceCommitV5 {
...
fn check_mergeability(
    context: &v4::CommitCompileContextV4,
    incoming: &DataScienceCommitV4,
) -> Result<(), CompileError> {
    match &incoming.kind {
        v2::DataScienceCommitKindV2::AddComputation(v2::AddComputationCommitV2 {
            node,
            analysts: _,
...
impl Compile for DataScienceCommitV4 {
    type CompileContext = v4::CommitCompileContextV4;
    ...
    fn compile(self, mut context: Self::CompileContext) -> Result<Self::CompileOutput, CompileError> {
        ...
        match self.kind {
            v2::DataScienceCommitKindV2::AddComputation(add_computation_commit) => {
