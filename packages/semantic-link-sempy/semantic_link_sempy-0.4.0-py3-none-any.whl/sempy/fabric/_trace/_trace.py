...
from sempy.fabric._utils import dotnet_to_pandas_date, clr_to_pandas_dtype
...
class Trace():
    ...
    def add_events(self, event_schema: Dict[str, List[str]]) -> None:
        ...
        for event_type, columns in event_schema.items():
            ...
            try:
                self._trace_collector.AddEvent(event_type, columns)
    ...
    def get_trace_logs(self) -> pd.DataFrame:
        ...
        return self._convert_dtypes(df)
    ...
    def _convert_dtypes(self, df):
        ...
        for col_property in column_properties:
            ...
            col_type = property_info.PropertyType.Name
