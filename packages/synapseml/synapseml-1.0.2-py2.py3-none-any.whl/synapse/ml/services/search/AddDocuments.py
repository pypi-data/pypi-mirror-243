...
class AddDocuments(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="AddDocuments_21dbb828d07a_error",
        handler=None,
        indexName=None,
        outputCol="AddDocuments_21dbb828d07a_output",
        serviceName=None,
        ...
        self._setDefault(errorCol="AddDocuments_21dbb828d07a_error")
        self._setDefault(outputCol="AddDocuments_21dbb828d07a_output")
