...
class TextAnalyze(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TextAnalyze_c9fc6fbe4dfd_error",
        ...
        outputCol="TextAnalyze_c9fc6fbe4dfd_output",
        ...
        self._setDefault(errorCol="TextAnalyze_c9fc6fbe4dfd_error")
        ...
        self._setDefault(outputCol="TextAnalyze_c9fc6fbe4dfd_output")
