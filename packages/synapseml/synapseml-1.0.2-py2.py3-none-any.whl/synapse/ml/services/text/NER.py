...
class NER(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="NER_44ca69eb6feb_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="NER_44ca69eb6feb_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="NER_44ca69eb6feb_error")
        self._setDefault(outputCol="NER_44ca69eb6feb_output")
