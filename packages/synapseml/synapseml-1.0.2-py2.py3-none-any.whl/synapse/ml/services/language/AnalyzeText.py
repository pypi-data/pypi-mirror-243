...
class AnalyzeText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="AnalyzeText_a80c6c78e608_error",
        handler=None,
        kind=None,
        language=None,
        languageCol=None,
        ...
        outputCol="AnalyzeText_a80c6c78e608_output",
        piiCategories=None,
        ...
        self._setDefault(errorCol="AnalyzeText_a80c6c78e608_error")
        self._setDefault(outputCol="AnalyzeText_a80c6c78e608_output")
