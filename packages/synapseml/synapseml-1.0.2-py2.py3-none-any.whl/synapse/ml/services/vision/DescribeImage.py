...
class DescribeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DescribeImage_b45d0c209ba2_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        outputCol="DescribeImage_b45d0c209ba2_output",
        ...
        self._setDefault(errorCol="DescribeImage_b45d0c209ba2_error")
        self._setDefault(outputCol="DescribeImage_b45d0c209ba2_output")
