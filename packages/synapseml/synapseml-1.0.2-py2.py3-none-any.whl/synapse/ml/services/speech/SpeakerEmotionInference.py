...
class SpeakerEmotionInference(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="SpeakerEmotionInference_24634020df2c_error",
        handler=None,
        locale=None,
        localeCol=None,
        outputCol="SpeakerEmotionInference_24634020df2c_output",
        ...
        self._setDefault(errorCol="SpeakerEmotionInference_24634020df2c_error")
        self._setDefault(outputCol="SpeakerEmotionInference_24634020df2c_output")
