...
class CheckPointInPolygon(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="CheckPointInPolygon_aafa97f54213_error",
        handler=None,
        latitude=None,
        latitudeCol=None,
        longitude=None,
        longitudeCol=None,
        outputCol="CheckPointInPolygon_aafa97f54213_output",
        ...
        self._setDefault(errorCol="CheckPointInPolygon_aafa97f54213_error")
        self._setDefault(outputCol="CheckPointInPolygon_aafa97f54213_output")
