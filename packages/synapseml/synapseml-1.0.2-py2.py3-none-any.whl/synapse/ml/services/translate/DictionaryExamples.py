...
class DictionaryExamples(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DictionaryExamples_797a026febd0_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryExamples_797a026febd0_output",
        ...
        self._setDefault(errorCol="DictionaryExamples_797a026febd0_error")
        self._setDefault(outputCol="DictionaryExamples_797a026febd0_output")
