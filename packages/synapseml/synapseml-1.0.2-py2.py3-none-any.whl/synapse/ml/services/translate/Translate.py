...
class Translate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Translate_2758f7bcea5d_error",
        fromLanguage=None,
        ...
        outputCol="Translate_2758f7bcea5d_output",
        ...
        self._setDefault(errorCol="Translate_2758f7bcea5d_error")
        self._setDefault(outputCol="Translate_2758f7bcea5d_output")
