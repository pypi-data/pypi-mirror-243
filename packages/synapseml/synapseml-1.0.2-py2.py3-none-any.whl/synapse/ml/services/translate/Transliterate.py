...
class Transliterate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Transliterate_48202db8072a_error",
        fromScript=None,
        fromScriptCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="Transliterate_48202db8072a_output",
        ...
        self._setDefault(errorCol="Transliterate_48202db8072a_error")
        self._setDefault(outputCol="Transliterate_48202db8072a_output")
