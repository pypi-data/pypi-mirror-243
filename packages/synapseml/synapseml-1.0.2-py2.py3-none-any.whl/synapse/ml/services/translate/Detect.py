...
class Detect(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Detect_a134474ea907_error",
        handler=None,
        outputCol="Detect_a134474ea907_output",
        ...
        self._setDefault(errorCol="Detect_a134474ea907_error")
        self._setDefault(outputCol="Detect_a134474ea907_output")
