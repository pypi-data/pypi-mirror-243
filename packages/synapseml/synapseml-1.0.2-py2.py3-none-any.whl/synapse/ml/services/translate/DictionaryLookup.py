...
class DictionaryLookup(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DictionaryLookup_520def9e02ba_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryLookup_520def9e02ba_output",
        ...
        self._setDefault(errorCol="DictionaryLookup_520def9e02ba_error")
        self._setDefault(outputCol="DictionaryLookup_520def9e02ba_output")
