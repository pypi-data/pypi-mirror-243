...
class GetCustomModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="GetCustomModel_3c11f51e7a87_error",
        handler=None,
        includeKeys=None,
        includeKeysCol=None,
        modelId=None,
        modelIdCol=None,
        outputCol="GetCustomModel_3c11f51e7a87_output",
        ...
        self._setDefault(errorCol="GetCustomModel_3c11f51e7a87_error")
        self._setDefault(outputCol="GetCustomModel_3c11f51e7a87_output")
