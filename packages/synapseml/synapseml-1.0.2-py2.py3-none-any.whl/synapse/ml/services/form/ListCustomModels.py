...
class ListCustomModels(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="ListCustomModels_48c0e9dae7eb_error",
        handler=None,
        op=None,
        opCol=None,
        outputCol="ListCustomModels_48c0e9dae7eb_output",
        ...
        self._setDefault(errorCol="ListCustomModels_48c0e9dae7eb_error")
        self._setDefault(outputCol="ListCustomModels_48c0e9dae7eb_output")
