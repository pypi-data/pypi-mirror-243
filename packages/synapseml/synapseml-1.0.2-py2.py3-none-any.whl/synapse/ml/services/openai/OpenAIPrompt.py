...
class OpenAIPrompt(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIPrompt_cff90fd95171_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAIPrompt_cff90fd95171_output",
        postProcessing="",
        ...
        self._setDefault(errorCol="OpenAIPrompt_cff90fd95171_error")
        self._setDefault(outputCol="OpenAIPrompt_cff90fd95171_output")
