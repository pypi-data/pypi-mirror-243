...
class OpenAIEmbedding(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="OpenAIEmbedding_ec6c6682ce8b_error",
        handler=None,
        outputCol="OpenAIEmbedding_ec6c6682ce8b_output",
        ...
        self._setDefault(errorCol="OpenAIEmbedding_ec6c6682ce8b_error")
        self._setDefault(outputCol="OpenAIEmbedding_ec6c6682ce8b_output")
