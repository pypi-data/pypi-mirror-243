...
class OpenAIChatCompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIChatCompletion_559de93f76d1_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAIChatCompletion_559de93f76d1_output",
        ...
        self._setDefault(errorCol="OpenAIChatCompletion_559de93f76d1_error")
        self._setDefault(outputCol="OpenAIChatCompletion_559de93f76d1_output")
