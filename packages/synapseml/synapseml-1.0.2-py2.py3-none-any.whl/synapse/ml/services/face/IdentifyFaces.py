...
class IdentifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="IdentifyFaces_2d67cd7fcdb2_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        ...
        outputCol="IdentifyFaces_2d67cd7fcdb2_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="IdentifyFaces_2d67cd7fcdb2_error")
        self._setDefault(outputCol="IdentifyFaces_2d67cd7fcdb2_output")
