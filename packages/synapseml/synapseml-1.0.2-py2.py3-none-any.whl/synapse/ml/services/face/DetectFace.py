...
class DetectFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DetectFace_5cb14cfc864f_error",
        handler=None,
        imageUrl=None,
        imageUrlCol=None,
        outputCol="DetectFace_5cb14cfc864f_output",
        ...
        self._setDefault(errorCol="DetectFace_5cb14cfc864f_error")
        self._setDefault(outputCol="DetectFace_5cb14cfc864f_output")
