...
class VerifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="VerifyFaces_b8eef7f109b2_error",
        faceId=None,
        faceIdCol=None,
        faceId1=None,
        faceId1Col=None,
        ...
        outputCol="VerifyFaces_b8eef7f109b2_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="VerifyFaces_b8eef7f109b2_error")
        self._setDefault(outputCol="VerifyFaces_b8eef7f109b2_output")
