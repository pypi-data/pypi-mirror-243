...
class FindSimilarFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="FindSimilarFace_c4ede99987c8_error",
        faceId=None,
        faceIdCol=None,
        faceIds=None,
        faceIdsCol=None,
        ...
        mode=None,
        modeCol=None,
        outputCol="FindSimilarFace_c4ede99987c8_output",
        ...
        self._setDefault(errorCol="FindSimilarFace_c4ede99987c8_error")
        self._setDefault(outputCol="FindSimilarFace_c4ede99987c8_output")
