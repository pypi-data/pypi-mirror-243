...
class SimpleDetectMultivariateAnomaly(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaModel):
    ...
    def __init__(
        ...
        endTime=None,
        errorCol="SimpleDetectMultivariateAnomaly_3312ea5a129d_error",
        handler=None,
        ...
        modelId=None,
        outputCol="SimpleDetectMultivariateAnomaly_3312ea5a129d_output",
        pollingDelay=300,
        startTime=None,
        ...
        self._setDefault(errorCol="SimpleDetectMultivariateAnomaly_3312ea5a129d_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="SimpleDetectMultivariateAnomaly_3312ea5a129d_output")
