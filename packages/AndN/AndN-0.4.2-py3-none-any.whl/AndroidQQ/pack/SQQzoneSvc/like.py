...
from AndroidQQ.struct.cooperation import createQmfUpstream
from AndroidQQ.struct import PackHead_QMF
from AndroidQQ.struct.NS_MOBILE_OPERATION import operation_like_req
...
def SQQzoneSvc_like(info):
    def _operation_like_req():
        ...
        busi_param = {
            ...
            97: '&feedtype1=1&feedtype2=3&feedtype3=1&org_uniq_key=&sUniqId=3031658705_311_d170b3b4af8866656e750e00&fExposUniqId=&colorexptid=0&colorstrategyid=0',
            156: 'appid:311 typeid:0 feedtype:2 hostuin:226554375 feedskey:d170b3b4af8866656e750e00 ',
            4: '',
            5: 'http://user.qzone.qq.com/3031658705/mood/d170b3b4af8866656e750e00',
            101: '0=&1=&2=&3=&4=3031658705&5=&6=0&7=&8=&9=&10=0&76=',
            6: 'http://user.qzone.qq.com/3031658705/mood/d170b3b4af8866656e750e00',
            104: '',
            141: '',
            142: '5',
            207: '0',
            ...
            23: '0',
            184: '5555555',
            121: '&feedtype1=1&feedtype2=3&feedtype3=1&org_uniq_key=&sUniqId=3031658705_311_d170b3b4af8866656e750e00&fExposUniqId=&colorexptid=0&colorstrategyid=0'}

        OperationLikeReq = operation_like_req(uin=226554375,
                                              curkey='http://user.qzone.qq.com/3031658705/mood/d170b3b4af8866656e750e00',
                                              unikey='http://user.qzone.qq.com/3031658705/mood/d170b3b4af8866656e750e00',
                                              action=0,
                                              appid=311,
        ...
        print('111',OperationLikeReq.hex())
