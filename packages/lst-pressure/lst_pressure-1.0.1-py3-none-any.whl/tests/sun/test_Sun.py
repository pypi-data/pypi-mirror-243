...
from lstpressure.sun.sun_providers import MeerKATProvider
from lstpressure.sun.sun_providers.normalize_intervals import normalize_interval
from lstpressure.sun.sun_providers.astral_provider.AstralProvider import (
    normalize_interval,
    AstralProvider,
)
from conf import SunProvider
...
def test_Sun_with_MeerKATProvider(yyyymmdd, expected_results):
    sun = Sun(yyyymmdd=yyyymmdd, provider=SunProvider.MEERKAT)
