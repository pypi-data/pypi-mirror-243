...
from .sun_providers import SunProvider, AstralProvider, MeerKATProvider
...
from conf import SunProvider as SunProvider, Conf

conf = Conf()

provider_mapping = {SunProvider.ASTRAL: AstralProvider, SunProvider.MEERKAT: MeerKATProvider}
...
class Sun:
    ...
    def __init__(
        ...
        provider: Optional[SunProvider] = conf.SUN_PROVIDER,
    ) -> None:
        """
        ...
        provider: Optional[SunProvider]
            A sun/time provider for customizing class calculations. Defaults to AstralProvider.
