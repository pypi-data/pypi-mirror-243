...
class Conf:
    ...
    def __init__(self) -> None:
        ...
        self._sun_provider = os.environ.get("SUN_PROVIDER", SunProvider.ASTRAL)
    ...
    @property
    def SUN_PROVIDER(self) -> bool:
        return self._sun_provider

    @SUN_PROVIDER.setter
    def SUN_PROVIDER(self, value: SunProvider) -> None:
