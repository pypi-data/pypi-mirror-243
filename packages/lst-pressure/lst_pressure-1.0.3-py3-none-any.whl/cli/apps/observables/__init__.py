...
from ..aggregate import parse_sql_query, execute_csvsql
...
class Observables(AppInterface):
    ...
    def build(self) -> Self:
        ...
        self.parser_sub.add_argument(
            ...
            type=str,
            metavar="",
            help='Apply a SQL aggregation to the CSV before printing to a file/stdout. The CSV is provided as a relation called "stdin"',
        )
