...
class weight_reader:
    ...
    def __init__(self, df, kind):
        ...
        self._d_wgt_pat               = {}
        self._d_d_arr_wgt             = {} 
        self._l_supported_weight      = ['pid', 'trk', 'gen', 'lzr', 'hlt', 'rec', 'qsq', 'bts', 'bdt']
    ...
    def _skip_corr(self):
        ...
        2. When none of the weights are 1s, except for bootstrapping and q2
        ...
        for wgt, (ver, sys) in self._d_wgt_ver.items():
            if wgt not in ['bts', 'qsq'] and sys == '000':
                return True 
