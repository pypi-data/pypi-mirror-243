...
class data_extraction:
    ...
    def read_from_upc_s3(self, bucket_name=cred.bucket_name, file_name=cred.upc_tier_str):
    ...
    def upload_to_rs(self, bucket_name, file_name): # prophet/Deployment/DS_Collab/winegrowing_research/GQI/model_outputs/gqi_calc.csv
        rs_push_query = """
