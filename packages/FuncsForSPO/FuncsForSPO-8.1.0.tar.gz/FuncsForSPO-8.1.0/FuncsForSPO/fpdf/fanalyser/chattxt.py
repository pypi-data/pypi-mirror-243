"""DEPRECATED USE FuncsForSPO.openai.assistants.assistants"""
...
def chatpdf2(prompts: dict, text: str, api_key: str, model: str = "gpt-4-1106-preview", temperature: float = 0.8, max_tokens: int | None = None, sleep_per_request: int | float = 0, qa_template: str | None = None, chunk_size: int = 4000):
    """
    # DEPRECATED USE FuncsForSPO.openai.assistants.assistants
