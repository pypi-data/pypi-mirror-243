...
It's main functionality is to simulate and validate the S/C pointing timeline,
...
OSVE is available from the Python Package Index repository. Install iy by running the
following command:
...
The libraries are available under the [docs directory](osve/deliveries) directory.
