...
class MiddleWare:
    ...
    # Need `QElectronInfo` and `QNodeSpecs` in own module.
    # Can't import these objects here because of circular imports.
    def run_circuits_async(
        self,
        qscripts: List[QuantumScript],
        executors: List[CloudQExecutor],
        qelectron_info,  # NOTE: missing type
        qnode_specs,  # NOTE: missing type
    ) -> str:
        """
