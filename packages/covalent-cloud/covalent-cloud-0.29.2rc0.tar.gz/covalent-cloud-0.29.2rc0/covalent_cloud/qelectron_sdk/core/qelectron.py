...
"""
Define the QElectron decorator.
"""
...
from ..core.qresult_utils import get_original_shots
from ..core.qinfo import QElectronInfo
...
CloudQExecutors = Union[CloudQExecutor, CloudQCluster, List[CloudQExecutor]]


def qelectron(
    qnode: Optional[qml.QNode] = None,
    *,
    executors: Optional[CloudQExecutors] = None,
    name: Optional[str] = None,
    description: Optional[str] = None,
    selector: str = "random",
) -> Union[QNodeQE, Callable]:
    ...
    executors.set_shots(qelectron_info.device_shots)
