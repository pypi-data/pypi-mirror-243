class OODAPrompts:
    ...
    DECOMPOSE_INTO_SUBTASKS = (
        ...
        " order. If it does not need to be broken down, return an empty list of subtasks. Return a"
        ' JSON dictionary {"content": "your thinking here", "subtasks": ["subtask 1", "subtask 2",'
        " ...]}"
    )
