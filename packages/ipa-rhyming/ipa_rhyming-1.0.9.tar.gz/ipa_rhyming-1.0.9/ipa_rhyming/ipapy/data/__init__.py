...
from ..compatibility import hex_to_unichr
from ..ipachar import IPAConsonant
from ..ipachar import IPAVowel
from ..ipachar import IPADiacritic
from ..ipachar import IPASuprasegmental
from ..ipachar import IPATone
...
def load_data_file(
    ...
    with io.open('ipa.dat', "r", encoding="utf-8") as f:
        for line in f:
            line = line.strip()
