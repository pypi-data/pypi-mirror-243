...
def btn_ff_gen_frame():
	...
	return sg.Frame(title=None, 
		...
		[sg.Text('select log files', text_color="yellow"), 
			sg.InputText('', key='ff_log_files'), sg.FilesBrowse(key='btn_ff_log_files') ],
		[sg.Checkbox('convert normal capture file to capture_it format before start', key='ff_convert_to_cit', default=False, text_color='yellow')],
		[sg.Checkbox('rearrange columns as per standard sequence', key='ff_rearrange', default=True, text_color='yellow')],
		[sg.Checkbox('rearrange columns as per standard sequence', key='ff_rearrange', default=True, text_color='yellow')],
		[sg.Checkbox('skip parsed excel outputs', key='ff_skip_txtfsm', default=True, text_color='yellow')],
