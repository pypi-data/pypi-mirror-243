...
class BinaryTree:
    ...
    def find_greater_than_or_equal_to(self, value: Any) -> list:
        return self.find_equal_to(value) + self.find_greater_than(value)
    ...
    def find_less_than_or_equal_to(self, value: Any) -> list:
        return self.find_less_than(value) + self.find_equal_to(value)
