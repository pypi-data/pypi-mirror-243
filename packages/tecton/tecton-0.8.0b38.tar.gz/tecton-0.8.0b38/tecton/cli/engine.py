        ...
        **kwargs,
        ...
        def callback(
            ...
            if yes and safety_checks:
                msg = (
                    "The flag --yes is an alias for --no-safety-checks. Please use one of --yes or --no-safety-checks."
                )
        ...
        params = [
            ...
            click.Option(
                ["--config"],
                help="Path to the repo config yaml file. Defaults to the tecton.yaml file at the Tecton repo root.",
                default=None,
