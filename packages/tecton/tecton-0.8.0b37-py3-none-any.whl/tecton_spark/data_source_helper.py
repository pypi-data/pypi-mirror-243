...
def get_ds_dataframe(
    ...
    if consume_streaming_data_source:
        ...
        if data_source.type == DataSourceType.STREAM_WITH_BATCH:
            ...
            # Since 0.8, data source schema is optionally derived. If all feature views that depends on a data source have `run_query_validation=False`, the data source schema is not derived.
            if schema:
