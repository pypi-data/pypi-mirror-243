...
def trial_plot(trial_plot_info_input, signal_dir_input, output_dir, image_name_input=None, gaze_csv_dir=None,
               trial_name=None):
    ...
    output_image_dir = os.path.join(output_dir, output_image_name)
    ...
    if len(rows2) > 0:
        ...
        print(f"Trial plot has been saved at:{output_image_dir}")
    else:
...
def summary_plot(folder_dir_input, summary_plot_info_input, output_dir_input=None, image_name_input=None,
    ...
    if output_dir_input:
        display_output_dir = output_dir_input
                    ...
                    for row_index, plot_info in enumerate(final_plot_array):
                        ...
                        for column_index, info in enumerate(info_array):
                            ...
                            axs[row_index, column_index].plot(x_array, qp_array, color=qp_line_color,
                                                              linewidth=qp_line_thickness)
                            axs[row_index, column_index].set_title(axs_title, fontsize=20)
...
def tidy_plot(folder_dir_input, tidy_plot_info_input, output_file_dir_input=None):
...
def progress_plot(folder_dir_input, progress_plot_info_input, output_file_dir_input=None):
