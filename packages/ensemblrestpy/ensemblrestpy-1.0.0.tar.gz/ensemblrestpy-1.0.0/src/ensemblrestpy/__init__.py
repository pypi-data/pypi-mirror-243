...
def archive(id: str, callback=None, response_format="json"):
    return get(endpoint=f"archive/id/{id}", params=dict(callback=callback), response_format=response_format)


@archive.register
def _(id: list, callback=None, response_format="json"):
    return post(endpoint="archive/id", params=dict(callback=callback), response_format=response_format,
                json={"id": id}, )


def cafe_tree(id: str, callback=None, compara=None, nh_response_format=None, response_format="json"):
    return get(f"cafe/genetree/id/{id}",
               params=dict(callback=callback, compara=compara, nh_response_format=nh_response_format),
               response_format=response_format, )


def cafe_tree_member_id(id: str, callback=None, compara=None, db_type=None, nh_response_format=None, object_type=None,
                        species=None, response_format="json"):
    return get(f"cafe/genetree/member/id/{id}",
               params=dict(callback=callback, compara=compara, db_type=db_type, nh_response_format=nh_response_format,
...
def cafe_tree_member_symbol(species: str, symbol: str, callback=None, compara=None, db_type=None, external_db=None,
                            nh_response_format=None, object_type=None, response_format="json"):
    return get(f"cafe/genetree/member/symbol/{species}/{symbol}",
               params=dict(callback=callback, compara=compara, db_type=db_type, external_db=external_db,
                           nh_response_format=nh_response_format, object_type=object_type, ),
               response_format=response_format, )


def cafe_tree_species_member_id(id: str, species: str, callback=None, compara=None, db_type=None,
                                nh_response_format=None, object_type=None, response_format="json"):
...
def genetree(id: str, aligned=None, callback=None, cigar_line=None, clusterset_id=None, compara=None,
             nh_response_format=None, prune_species=None, prune_taxon=None, sequence=None, response_format="json"):
    return get(f"genetree/id/{id}",
               params=dict(aligned=aligned, callback=callback, cigar_line=cigar_line, clusterset_id=clusterset_id,
                           compara=compara, nh_response_format=nh_response_format, prune_species=prune_species,
                           prune_taxon=prune_taxon, sequence=sequence, ), response_format=response_format, )


def genetree_member_id(id: str, aligned=None, callback=None, cigar_line=None, clusterset_id=None, compara=None,
                       db_type=None, nh_response_format=None, object_type=None, prune_species=None, prune_taxon=None,
                       sequence=None, species=None, response_format="json"):
    return get(f"genetree/member/id/{id}",
               params=dict(aligned=aligned, callback=callback, cigar_line=cigar_line, clusterset_id=clusterset_id,
                           compara=compara, db_type=db_type, nh_response_format=nh_response_format,
                           object_type=object_type, prune_species=prune_species, prune_taxon=prune_taxon,
                           sequence=sequence, species=species, ), response_format=response_format, )


def genetree_member_symbol(species: str, symbol: str, aligned=None, callback=None, cigar_line=None, clusterset_id=None,
                           compara=None, db_type=None, external_db=None, nh_response_format=None, object_type=None,
                           prune_species=None, prune_taxon=None, sequence=None, response_format="json"):
    return get(f"genetree/member/symbol/{species}/{symbol}",
               params=dict(aligned=aligned, callback=callback, cigar_line=cigar_line, clusterset_id=clusterset_id,
                           compara=compara, db_type=db_type, external_db=external_db,
                           nh_response_format=nh_response_format, object_type=object_type, prune_species=prune_species,
                           prune_taxon=prune_taxon, sequence=sequence, ), response_format=response_format, )


def genetree_species_member_id(id: str, species: str, aligned=None, callback=None, cigar_line=None, clusterset_id=None,
                               compara=None, db_type=None, nh_response_format=None, object_type=None,
                               prune_species=None, prune_taxon=None, sequence=None, response_format="json"):
...
def homology_ensemblgene(id: str, aligned=None, callback=None, cigar_line=None, compara=None, format=None,
                         sequence=None, target_species=None, target_taxon=None, type=None, response_format="json"):
    return get(f"homology/id/{id}",
               params=dict(aligned=aligned, callback=callback, cigar_line=cigar_line, compara=compara,
                           response_format=response_format, sequence=sequence, target_species=target_species,
...
def homology_symbol(species: str, symbol: str, aligned=None, callback=None, cigar_line=None, compara=None,
    ...
    return get(f"homology/symbol/{species}/{symbol}",
               params=dict(aligned=aligned, callback=callback, cigar_line=cigar_line, compara=compara,
                           external_db=external_db, response_format=response_format, sequence=sequence,
...
def info_genomes_division(division: str, callback=None, expand=None, response_format="json"):
    return get(f"info/genomes/division/{division}", params=dict(callback=callback, expand=expand),
               response_format=response_format, )
...
def lookup(id: str, callback=None, db_type=None, expand=None, format=None, mane=None, phenotypes=None, species=None,
    ...
    return get(f"lookup/id/{id}",
               params=dict(callback=callback, db_type=db_type, expand=expand, response_format=response_format,
                           mane=mane, phenotypes=phenotypes, species=species, utr=utr, ),
               response_format=response_format, )
...
def symbol_lookup(symbol: str, species: str, callback=None, expand=None, format=None, response_format="json"):
    return get(f"lookup/symbol/{species}/{symbol}",
               params=dict(callback=callback, expand=expand, response_format=response_format),
               response_format=response_format, )


@symbol_lookup.register
def _(symbol: list, species: str, callback=None, expand=None, format=None, response_format="json"):
    return post(f"lookup/symbol/{species}",
                params=dict(callback=callback, expand=expand, response_format=response_format),
...
def overlap_region(species: str, region: str, feature: str, biotype=None, callback=None, db_type=None, logic_name=None,
...
def phenotype_accession(species: str, accession: str, callback=None, include_children=None, include_pubmed_id=None,
...
def phenotype_gene(species: str, gene: str, callback=None, include_associated=None, include_overlap=None,
...
def phenotype_region(species: str, region: str, callback=None, feature_type=None, include_pubmed_id=None,
...
def probe(species: str, microarray: str, probe: str, callback=None, gene=None, transcripts=None,
          response_format="json"):
...
def probe_set(species: str, microarray: str, probe_set: str, callback=None, gene=None, transcripts=None,
              response_format="json"):
...
def sequence_id(id: str, callback=None, db_type=None, end=None, expand_3prime=None, expand_5prime=None, format=None,
    ...
    return get(f"sequence/id/{id}",
               params=dict(callback=callback, db_type=db_type, end=end, expand_3prime=expand_3prime,
                           expand_5prime=expand_5prime, response_format=response_format, mask=mask,
                           mask_feature=mask_feature, multiple_sequences=multiple_sequences, object_type=object_type,
                           species=species, start=start, type=type, ), response_format=response_format, )
...
def sequence_region(region: str, species: str, callback=None, coord_system=None, coord_system_version=None,
    ...
    return get(f"sequence/region/{species}/{region}",
               params=dict(callback=callback, coord_system=coord_system, coord_system_version=coord_system_version,
                           expand_3prime=expand_3prime, expand_5prime=expand_5prime, response_format=response_format,
                           mask=mask, mask_feature=mask_feature, ), response_format=response_format, )
...
class Ensembl:
    ...
    def cafe_tree(self, id: str, callback=None, compara=None, nh_response_format=None, response_format="json"):
        return self.get(f"cafe/genetree/id/{id}",
                        params=dict(callback=callback, compara=compara, nh_response_format=nh_response_format),
                        response_format=response_format, )

    def cafe_tree_member_id(self, id: str, callback=None, compara=None, db_type=None, nh_response_format=None,
                            object_type=None, species=None, response_format="json"):
        return self.get(f"cafe/genetree/member/id/{id}",
                        params=dict(callback=callback, compara=compara, db_type=db_type,
                                    nh_response_format=nh_response_format, object_type=object_type, species=species, ),
                        response_format=response_format, )

    def cafe_tree_member_symbol(self, species: str, symbol: str, callback=None, compara=None, db_type=None,
                                external_db=None, nh_response_format=None, object_type=None, response_format="json"):
    ...
    def genetree(self, id: str, aligned=None, callback=None, cigar_line=None, clusterset_id=None, compara=None,
        ...
        return self.get(f"genetree/id/{id}", params=dict(aligned=aligned, callback=callback, cigar_line=cigar_line,
                                                         ...
                                                         prune_species=prune_species, prune_taxon=prune_taxon,
                                                         sequence=sequence, ), response_format=response_format, )

    def genetree_member_id(self, id: str, aligned=None, callback=None, cigar_line=None, clusterset_id=None,
                           compara=None, db_type=None, nh_response_format=None, object_type=None, prune_species=None,
                           prune_taxon=None, sequence=None, species=None, response_format="json"):
        return self.get(f"genetree/member/id/{id}",
    ...
    def genetree_member_symbol(self, species: str, symbol: str, aligned=None, callback=None, cigar_line=None,
                               clusterset_id=None, compara=None, db_type=None, external_db=None,
                               nh_response_format=None, object_type=None, prune_species=None, prune_taxon=None,
                               sequence=None, response_format="json"):
        return self.get(f"genetree/member/symbol/{species}/{symbol}",
                        params=dict(aligned=aligned, callback=callback, cigar_line=cigar_line,
                                    clusterset_id=clusterset_id, compara=compara, db_type=db_type,
                                    external_db=external_db, nh_response_format=nh_response_format,
                                    object_type=object_type, prune_species=prune_species, prune_taxon=prune_taxon,
                                    sequence=sequence, ), response_format=response_format, )

    def genetree_species_member_id(self, id: str, species: str, aligned=None, callback=None, cigar_line=None,
                                   clusterset_id=None, compara=None, db_type=None, nh_response_format=None,
    ...
    def homology_ensemblgene(self, id: str, aligned=None, callback=None, cigar_line=None, compara=None, format=None,
                             sequence=None, target_species=None, target_taxon=None, type=None, response_format="json"):
    ...
    def info_genome(self, name: str, callback=None, expand=None, response_format="json"):
        return self.get(f"info/genomes/{name}", params=dict(callback=callback, expand=expand),
                        response_format=response_format, )
    ...
    def _(self, symbol: list, species: str, callback=None, expand=None, format=None, response_format="json"):
        return self.post(f"lookup/symbol/{species}",
                         params=dict(callback=callback, expand=expand, response_format=response_format),
                         response_format=response_format, json={"symbols": symbol}, )
    ...
    def overlap_region(self, species: str, region: str, feature: str, biotype=None, callback=None, db_type=None,
    ...
    def phenotype_accession(self, species: str, accession: str, callback=None, include_children=None,
    ...
    def phenotype_gene(self, species: str, gene: str, callback=None, include_associated=None, include_overlap=None,
                       include_pubmed_id=None, include_review_status=None, include_submitter=None, non_specified=None,
                       trait=None, tumour=None, response_format="json"):
    ...
    def phenotype_region(self, species: str, region: str, callback=None, feature_type=None, include_pubmed_id=None,
                         include_review_status=None, include_submitter=None, non_specified=None, only_phenotypes=None,
                         trait=None, tumour=None, response_format="json"):
    ...
    def probe(self, species: str, microarray: str, probe: str, callback=None, gene=None, transcripts=None,
              response_format="json"):
    ...
    def probe_set(self, species: str, microarray: str, probe_set: str, callback=None, gene=None, transcripts=None,
                  response_format="json"):
    ...
    def sequence_id(self, id: str, callback=None, db_type=None, end=None, expand_3prime=None, expand_5prime=None,
        ...
        return self.get(f"sequence/id/{id}",
                        params=dict(callback=callback, db_type=db_type, end=end, expand_3prime=expand_3prime,
                                    expand_5prime=expand_5prime, response_format=response_format, mask=mask,
                                    mask_feature=mask_feature, multiple_sequences=multiple_sequences,
    ...
    def _(self, id: list, callback=None, db_type=None, end=None, expand_3prime=None, expand_5prime=None, format=None,
        ...
        return self.post(f"sequence/id",
                         params=dict(callback=callback, db_type=db_type, end=end, expand_3prime=expand_3prime,
                                     expand_5prime=expand_5prime, response_format=response_format, mask=mask,
                                     mask_feature=mask_feature, object_type=object_type, species=species, start=start,
                                     type=type, ), response_format=response_format, json={"ids": id}, )
    ...
    def sequence_region(self, region: str, species: str, callback=None, coord_system=None, coord_system_version=None,
        ...
        return self.get(f"sequence/region/{species}/{region}", params=dict(callback=callback, coord_system=coord_system,
                                                                           ...
                                                                           response_format=response_format, mask=mask,
    ...
    def referenceSets(self, accession=None, callback=None, pageSize=None, pageToken=None, response_format="json"):
        return self.post(f"ga4gh/referencesets/search", params=dict(
...
if __name__ == "__main__":
    ...
    # print(features_id("ENST00000408937.7"))
    # print(features_post(parentId="ENSG00000176515.1", pageSize=5, featureSetId="", featureTypes=[], start=39657458, end=39753127, referenceName="20"))
    ...
    print(ensembl.taxonomy_id("9606"))  # print(ensembl.taxonomy_name('human'))
