...
SOURCE_ROOT = os.path.join("src", "nano-lib-py-work-module", "BLAKE2")
SOURCE_FILES = {
...
def create_work_extension(source_name="ref", iset=None, build_platform=None):
    source_path = os.path.join(
        "src", "nano-lib-py-work-module", "BLAKE2", source_name
    )
    module_suffix = iset if iset else "ref"

    return Extension(
        "nano-lib-py._work_{}".format(module_suffix),
        include_dirs=[source_path],
        sources=[
            os.path.join("src", "nano-lib-py-work-module", "work.c")
...
EXTENSIONS_TO_BUILD.append(
    Extension(
        "nano-lib-py._nbase32",
        include_dirs=[os.path.join("src", "nano-lib-py-nbase32-module")],
        sources=[
            os.path.join("src", "nano-lib-py-nbase32-module", "nbase32.c"),
            os.path.join("src", "nano-lib-py-nbase32-module", "bit_array.c")
        ],
...
setup(
    ...
    packages=["nano-lib-py"],
    package_data={"": ["LICENSE"]},
    package_dir={"nano-lib-py": "src/nano-lib-py"},
