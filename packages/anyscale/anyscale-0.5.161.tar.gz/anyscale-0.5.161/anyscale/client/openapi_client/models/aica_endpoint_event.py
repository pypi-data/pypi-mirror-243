...
class AicaEndpointEvent(object):
    ...
    def __init__(self, id=None, service_event_id=None, aica_endpoint_id=None, timestamp=None, event_type=None, level=None, scope=None, message=None, cluster_event_id=None, cluster_state_transition_id=None, local_vars_configuration=None):  # noqa: E501
