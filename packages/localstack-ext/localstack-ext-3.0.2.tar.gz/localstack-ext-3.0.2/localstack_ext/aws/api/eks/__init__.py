...
class EksApi:
    ...
    def disassociate_identity_provider_config(
        ...
        principals <https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_terms-and-concepts.html>`__.
    ...
    def list_eks_anywhere_subscriptions(
        ...
        :param next_token: The nextToken value to include in a future ListEksAnywhereSubscriptions
        request.
