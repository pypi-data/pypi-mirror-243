...
@pro_aws_provider()
def ram():from localstack_ext.services.ram.provider import RamProvider as A;B=A();return Service.for_provider(B,dispatch_table_factory=MotoFallbackDispatcher)
@pro_aws_provider()
...
def get_sqs_provider():
	global sqs_provider
	if not sqs_provider:from localstack.services import edge;from localstack.services.sqs import query_api as A;from localstack_ext.services.sqs.provider import SqsProvider as B;A.register(edge.ROUTER);sqs_provider=B()
	return sqs_provider
@pro_aws_provider()
def sqs():return Service.for_provider(get_sqs_provider())
@pro_aws_provider(_F)
def sqs_query():A=Service.for_provider(get_sqs_provider(),custom_service_name=_F);return A
