...
class BackupApi:
    ...
    def list_backup_jobs(
        ...
        :param by_message_category: This returns a list of backup jobs for the specified message category.
    ...
    def list_copy_jobs(
        ...
        and Coordinated Universal Time (UTC).
        :param by_parent_job_id: This is a filter to list child (nested) jobs based on parent job ID.
        :param by_message_category: This parameter returns the job count for the specified message category.
