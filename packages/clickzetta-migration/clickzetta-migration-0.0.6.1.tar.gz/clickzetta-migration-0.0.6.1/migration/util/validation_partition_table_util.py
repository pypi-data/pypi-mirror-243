...
def process_partition_filter(source_table: str, destination_table: str, partition_columns: list, partition_values: list, is_source_partition: bool, is_dest_partition: bool):
...
def count_validation(source_table: str, destination_table: str, source: Source, destination: Destination, is_source_partition: bool, is_dest_partition: bool, partition_columns: list, partition_values: list):
    try:
        source_table, destination_table = process_partition_filter(source_table, destination_table, partition_columns, partition_values, is_source_partition, is_dest_partition)
