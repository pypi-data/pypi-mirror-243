...
class MissionApiStub(object):
    ...
    def __init__(self, channel):
        ...
        self.LockMissionAreaOfInterest = channel.unary_unary(
                ...
                request_serializer=global__vo__grpc__service_dot_protos_dot_mission__api__pb2.LockMissionAreaOfInterestRequest.SerializeToString,
                response_deserializer=global__vo__grpc__service_dot_protos_dot_mission__api__pb2.LockMissionAreaOfInterestResponse.FromString,
                )
...
def add_MissionApiServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'LockMissionAreaOfInterest': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=global__vo__grpc__service_dot_protos_dot_mission__api__pb2.LockMissionAreaOfInterestRequest.FromString,
                    response_serializer=global__vo__grpc__service_dot_protos_dot_mission__api__pb2.LockMissionAreaOfInterestResponse.SerializeToString,
            ),
...
class MissionApi(object):
    ...
    def LockMissionAreaOfInterest(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/MissionApi/LockMissionAreaOfInterest',
            global__vo__grpc__service_dot_protos_dot_mission__api__pb2.LockMissionAreaOfInterestRequest.SerializeToString,
            global__vo__grpc__service_dot_protos_dot_mission__api__pb2.LockMissionAreaOfInterestResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
