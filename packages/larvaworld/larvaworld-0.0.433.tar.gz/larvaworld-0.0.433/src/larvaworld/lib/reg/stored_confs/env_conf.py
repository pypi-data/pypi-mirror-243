...
def Env_dict():
    ...
    d = {
        ...
        'odor_gradient': E.rect((0.1, 0.06), f=FC.su(pos=(0.04, 0.0), odor=Odor.oG(2)), o='G'),
        'mid_odor_gaussian': E.rect((0.1, 0.06), f=FC.su(odor=Odor.oG()),  o='G'),
        'odor_gaussian_square': E.rect(0.2, f=FC.su(odor=Odor.oG()), o='G'),
        'mid_odor_diffusion': E.rect(0.3, f= FC.su(r=0.03, odor=Odor.oD()), o='D'),
        '4corners': E.foodNodor_4corners(),
        'food_at_bottom': E.rect(0.2,  f=FC.sg(id='FoodLine', odor=Odor.oG(), a=0.002,
        ...
        'CS_UCS_on_food': E.dish(0.1,  f=FC.CS_UCS(grid=gen.FoodGrid()), o='G'),
        'CS_UCS_on_food_x2': E.dish(0.1,  f=FC.CS_UCS(grid=gen.FoodGrid(), N=2), o='G'),
        'CS_UCS_off_food': E.dish(0.1,  f=FC.CS_UCS(), o='G'),

        'patchy_food':E.rect(0.2, f= FC.sg(N=8, scale=(0.07, 0.07), mode='periphery', a=0.001, odor=Odor.oG(2)), o='G'),
