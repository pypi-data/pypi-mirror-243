...
if TYPE_CHECKING:
    ...
    from ..models.partial_event_trigger_group_sms_tags import PartialEventTriggerGroupSmsTags
    from ..models.partial_event_trigger_group_tags import PartialEventTriggerGroupTags
