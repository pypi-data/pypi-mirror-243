...
@overload
def dos_command(command: str, block: Literal[True] = True) -> None: ...

@overload
def dos_command(command: str, block: Literal[False] = True) -> os_popen_io: ...

def dos_command(command: str, block: bool = True) -> None:
    """
    Execute DOS command.
    ...
    ----------
    command : DOS command.
    block : Whether block thread.
        - `Literal[True]` : Block thread and no return.
        - `Literal[False]` : Not block and return standard output IO isntance.

    Returns
    -------
    Command standard output IO instance.
    """
