...
class Executor(object):
    ...
    def _err_msg_notify(self, err: str):
        ...
        subhead = '{}:{}'.format(self._context.meter.pos, self._context.runtime.step)

        if self._context.mode == WorkMode.FORMAL:
            project = '{}'.format(self._context.project)
            subhead = '{} - {}:{}'.format(self._context.case.name, self._context.meter.pos, self._context.runtime.step)
