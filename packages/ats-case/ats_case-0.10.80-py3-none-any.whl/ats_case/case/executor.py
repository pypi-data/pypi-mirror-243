    ...
    def step_exec(self):
        ...
        if self.is_exec():
            try:
                ...
                logger.info(str(ae))
                dingding.send(self._context.test_sn, 'error', self._context.start_time, datetime.now(), str(ae))
                ...
                logger.error(str(e))
                dingding.send(self._context.test_sn, 'error', self._context.start_time, datetime.now(), str(e))
