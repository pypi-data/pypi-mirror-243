...
from typing import List, Union, Callable, Optional, Literal, TypedDict
...
class TaskTree:
    ...
    def __init__(self, root: Union[InteractiveTaskConfiguration, Composition]):
        ...
        if isinstance(root, Exclusive):
            self.global_type = "exclusive"
        elif isinstance(root, Pipelined):
            self.global_type = "pipelined"
        elif isinstance(root, Compatible):
            self.global_type = "compatible"
        else:
            self.global_type = "other"
