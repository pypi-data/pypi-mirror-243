...
def show_map(lat=None, lon=None, with_draw_tools=True,zoom=None):
    ...
    # # add WMTS
    # folium.WmsTileLayer('https://api.sphere.gistda.or.th/services/snippet/embed?lon=100.520670&lat=13.754267&zoom=14&locale=th&map=sphere_streets&key=test2022', 
