...
class FlatFileIntegration(GraiIntegrationImplementation):
    ...
    def __init__(
        ...
        try:
            table_name, extension = os.path.splitext(file_ref)
        except:
            table_name, extension = None, None
    ...
    def get_nodes_and_edges(self) -> Tuple[List[SourcedNode], List[SourcedEdge]]:
        ...
        nodes, edges = build_nodes_and_edges(self.file_ref, self.file_ext, self.table_name, self.file_location, self.namespace)
