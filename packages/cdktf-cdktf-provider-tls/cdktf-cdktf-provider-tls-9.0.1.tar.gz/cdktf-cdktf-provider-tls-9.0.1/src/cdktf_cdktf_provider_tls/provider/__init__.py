...
class TlsProvider(
    ...
    def __init__(
        ...
        *,
        ...
        :param alias: Alias name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tls/4.0.5/docs#alias TlsProvider#alias}
        :param proxy: proxy block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tls/4.0.5/docs#proxy TlsProvider#proxy}
        '''
        if __debug__:
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing TlsProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tls/4.0.5/docs#import import section} in the documentation of this resource for the id to use
...
class TlsProviderProxy:
    def __init__(
        ...
        *,
        ...
        '''
        :param from_env: When ``true`` the provider will discover the proxy configuration from environment variables. This is based upon ```http.ProxyFromEnvironment`` <https://pkg.go.dev/net/http#ProxyFromEnvironment>`_ and it supports the same environment variables (default: ``true``). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tls/4.0.5/docs#from_env TlsProvider#from_env}
        :param password: Password used for Basic authentication against the Proxy. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tls/4.0.5/docs#password TlsProvider#password}
        :param url: URL used to connect to the Proxy. Accepted schemes are: ``http``, ``https``, ``socks5``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tls/4.0.5/docs#url TlsProvider#url}
        :param username: Username (or Token) used for Basic authentication against the Proxy. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tls/4.0.5/docs#username TlsProvider#username}
        '''
        if __debug__:
