...
def yolo_widerface_pretrained(quantized=True):
    ...
    if quantized:
        ...
        file_hash_v2 = '8dae0dac668f6a527a2603758051835801e2a5c838e1e39ac818d7eec674bdc0'
...
def yolo_voc_pretrained(quantized=True):
    ...
    if quantized:
        ...
        file_hash_v2 = '27de83b48fb0b054e33d3bb7d2482a8528c5964be10f5f153299782e5ac5580d'
