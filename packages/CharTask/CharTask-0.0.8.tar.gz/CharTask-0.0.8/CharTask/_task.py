...
from CharTask._dicts import _load_dict, _QuietDict

def _load_json(path):
    with open(path, 'r') as f:
        return _json.load(f)

_TASKS_DICT = _load_dict('tasks')
...
class _AbstractTask:
    ...
    @property
    def required_tools(self) -> _Union[list, str]:
        return self._required_tools
    
    @property
    def required_materials(self) -> _Union[list, str]:
...
class _BaseTask(_AbstractTask):
    def __init__(
            ...
            related_ability: _Optional[str] = None,
            required_skill: _Optional[str] = None,
            required_skill_level: _Optional[int] = None,
            difficulty_class: _Optional[int] = None,
            required_time: _Optional[int] = None,
            required_tools: _Optional[list] = None,
            required_materials: _Optional[list] = None,
            required_zone: _Optional[str] = None,
            product: _Optional[str] = None,
            product_quantity: _Optional[int] = None,
            product_quality: _Optional[int] = None,
            experience_reward: _Optional[int] = None,
            gold_reward: _Optional[int] = None,
            *args, **kwargs
    )-> None:
    ...
    def _produce(self, worker):
        ...
        quality = _QUALITIES[_random.randint(0,self._product_quality)] if self._product_quality is not None else ""
