...
class Pds4MetadataOpsDataFile(BaseModel):
    ...
    __properties = ["ops:creation_date", "ops:file_name", "ops:file_ref", "ops:file_size", "ops:md5_checksum", "ops:mime_type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Pds4MetadataOpsDataFile:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Pds4MetadataOpsDataFile:
        """Create an instance of Pds4MetadataOpsDataFile from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Pds4MetadataOpsDataFile.parse_obj(obj)

        _obj = Pds4MetadataOpsDataFile.parse_obj({
