...
class PdsProduct(BaseModel):
    ...
    properties: Optional[Dict[str, conlist(StrictStr)]] = Field(None, description="propertie's values extracted from pds4 model, as a dictionnary, syntax for property name is <namespace>:<property>[<namespace>:<property>]*")
