...
class ByProductClassesApi(object):
    ...
    def class_list(self, var_class : Annotated[StrictStr, Field(..., description="syntax: one of the allowable enum values  This is a shortcut for doing a query with ... ")], fields : Annotated[Optional[conlist(StrictStr)], Field(description="syntax: fields=field1,field2,...  behavior: this parameter and the headder Accept: type determine what content is packaged for the result. While the types application/csv, application/kvp+json, and text/csv return only the fields requesteted, all of the other types have a minimal set of fields that must be returned. Duplicating a minimally required field in this parameter has not effect. The types vnd.nasa.pds.pds4+json and vnd.nasa.pds.pds4+xml have a complete set of fields that must be returned; meaning this parameter does not impact their content. When fields is not used, then the minimal set of fields, or all when minimal is an empty set, is returned.  notes: the blob fields are blocked unless specifically requrested and only for the */csv and application/kvp+csv types. ")] = None, keywords : Annotated[Optional[conlist(StrictStr)], Field(description="syntax: keyword=keyword1,keyword2,...  behavior: free text search on title and description (if set q is ignored ")] = None, limit : Annotated[Optional[conint(strict=True, ge=0)], Field(description="syntax: limit=10  behavior: maximum number of matching results returned, for pagination ")] = None, q : Annotated[Optional[StrictStr], Field(description="syntax: q=\"vid eq 13.0\"  behavior: query uses eq,ne,gt,ge,lt,le,(,),not,and,or operators. Properties are named as in 'properties' attributes, literals are strings between quotes, like \"animal\", or numbers. Detailed query specification is available at https://bit.ly/3h3D54T  note: ignored when keyword is present ")] = None, sort : Annotated[Optional[conlist(StrictStr)], Field(description="syntax: sort=asc(field0),desc(field1),...  behavior: is this implemented? ")] = None, start : Annotated[Optional[conint(strict=True, ge=0)], Field(description="syntax: start=12  behavior: offset in matching result list, for pagination ")] = None, **kwargs) -> PdsProducts:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the class_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
    ...
    def classes(self, **kwargs) -> List[str]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the classes_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.classes_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def classes_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """returns a list of the available PDS product class at this API. This is not all of the PDS product class available in the database, but simply the names that can be used in the /classes/{class} endpoints.   # noqa: E501
