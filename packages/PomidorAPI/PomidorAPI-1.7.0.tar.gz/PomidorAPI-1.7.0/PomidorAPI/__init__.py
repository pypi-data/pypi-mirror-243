...
class errors():    
    ...
    class TextLengthError(Exception):
        def __init__(self) -> None:
            self.error = "text_len must be bigger than 15 and smaller than 513"
...
if __name__ == '__main__':
    ...
    Pomidor = PomidorAPI('http://172.20.10.9:5000')
    print( Pomidor.BRSC(prompt="Когда волк волк, а другой волк не волк, то волк не волку волк, а не волк не волк, ведь он не волк, а когда волк не волк, он не волк, не волк никому не волк, только волк всем волк, даже не волку волк волк, если не волк волку не волк", text_length=500, out_lang='ru')['response'] )