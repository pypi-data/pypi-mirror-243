...
class InDirect(GenericCRUD):
    ...
    @staticmethod
    def before_call_api( external_user_id: int, api_type_id: int, endpoint: str, outgoing_body: str, outgoing_header: str):
    ...
    @staticmethod
    def after_call_api( external_user_id: int, api_type_id: int, endpoint: str, outgoing_body: str, outgoing_header: str, http_status_code: int, response_body: str, incoming_message: str, api_call_id: int, used_cache: bool):
        ...
        InDirect.update_by_id(id_column_value=api_call_id, data_json=update_data)
