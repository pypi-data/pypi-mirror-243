...
from .Exception_API import ApiTypeDisabledException,ApiTypeIsNotExistException,NotEnoughStarsForActivityException,PassedTheHardLimitException
...
class StarsLocal(GenericCRUD):
    ...
    def _get_the_action_stars_by_profile_id_action_id(profile_id, action_id)->int:
        ...
        subscription_id = user.get_effective_subscription_id(profile_id=profile_id)
