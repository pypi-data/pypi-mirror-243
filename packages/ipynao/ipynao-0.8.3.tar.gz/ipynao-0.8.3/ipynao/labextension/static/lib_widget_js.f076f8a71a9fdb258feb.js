...
class NaoRobotModel extends base_1.DOMWidgetModel {
    ...
    connect(ipAddress, requestID) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (useLegacyQiSession) {
                ...
                this.qiSession = new wsqimessaging_1.WebsocketQiSession(ipAddress);
            }
    ...
    onCommand(commandData, buffers) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (cmd) {
                case 'connect':
                    yield this.connect(commandData['ipAddress'], commandData['requestID']);
                    break;
                case 'disconnect':
                    this.disconnect();
                    break;
...
class WebsocketQiSession {
    constructor(host, port = 8443, connected, disconnected) {
        this._isConnected = false;
        var hostAndPort = `wss://${host ? host : window.location.host}:${port}`;
