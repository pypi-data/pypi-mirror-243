...
ql_setup_kwargs = {'name': 'epic-jupyter', 'description': 'Conveniences for working in Jupyter Notebook or Ipython', 'long_description': {'filename': 'README.md', 'content_type': 'text/markdown'}, 'author': 'Yonatan Perry, Assaf Ben-David, Uri Sternfeld', 'license': 'MIT License', 'url': 'https://github.com/Cybereason/epic-jupyter', 'python_requires': '>=3.10', 'top_packages': ['epic'], 'version_module_paths': ['epic/jupyter'], 'classifiers': ['Development Status :: 4 - Beta', 'Intended Audience :: Developers', 'Operating System :: POSIX :: Linux', 'Operating System :: MacOS :: MacOS X', 'Operating System :: Microsoft :: Windows', 'Programming Language :: Python :: 3 :: Only', 'Programming Language :: Python :: 3.10']}    
