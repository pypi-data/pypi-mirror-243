...
class Build(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["audit", b"audit", "branchId", b"branchId", "buildConfig", b"buildConfig", "buildId", b"buildId", "build_configuration_message", b"build_configuration_message", "build_status", b"build_status", "commitId", b"commitId", "end_date", b"end_date", "environment_id", b"environment_id", "image_name_tag", b"image_name_tag", "metrics", b"metrics", "model_schema", b"model_schema", "model_uuid", b"model_uuid", "params", b"params", "sdk_version", b"sdk_version", "steps", b"steps", "tags", b"tags"]) -> None: ...
