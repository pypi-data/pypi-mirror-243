...
class BuildSpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["Resources", b"Resources", "build_config", b"build_config", "build_env", b"build_env", "build_properties", b"build_properties", "build_properties_v1", b"build_properties_v1", "build_v1_flag", b"build_v1_flag", "cpu_resources", b"cpu_resources", "gpu_resources", b"gpu_resources", "purchase_option", b"purchase_option", "verbose", b"verbose"]) -> None: ...
