...
setup(
    ...
    author='Paul Barros Bessone',
    author_email='paulbessone@gmail.co',
    # url='https://github.com/yourusername/jellystocks',
    description='A Python library for optimizing stock portfolios using the Jellyfish Search optimization algorithm.',
    long_description="""
JellyStock
==========
