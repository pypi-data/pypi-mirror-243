...
def verify(function, args, config_dir=None, add_data_type=None, custom_checker=None, logger=None):
    ...
    logger.info("config_dir - list: {}".format(os.listdir("/opt/hostedtoolcache/Python/3.8.18/x64/lib/python3.8/site-packages/astrohack/")))
    logger.info("runner: {}".format(os.listdir("/home/runner/work/astrohack/")))
