...
from sen2like_processor_bindings.model import Sen2LikeParameters  # noqa
...
class VesselDetection(FaasProcessorBase):
    ...
    def submit_workflow(
        self,
        vessel_detection_parameters: VesselDetectionParameters,
        user_id: str,
        job_id: str,
    ):
        return super().submit_workflow(
            vessel_detection_parameters=vessel_detection_parameters.json(),
            user_id=user_id,
            job_id=job_id,
        )
