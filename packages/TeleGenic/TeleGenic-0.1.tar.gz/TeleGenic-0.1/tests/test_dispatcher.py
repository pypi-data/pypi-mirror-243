...
class TestDispatcher:
    ...
    def test_default_run_async_error_handler(self, dp, monkeypatch, block, expected_output):
    ...
    def test_default_run_async(self, monkeypatch, dp, block, expected_output):
        ...
        try:
            ...
            monkeypatch.setattr(dp, 'block', mock_run_async)
            dp.process_update(self.message_update)
