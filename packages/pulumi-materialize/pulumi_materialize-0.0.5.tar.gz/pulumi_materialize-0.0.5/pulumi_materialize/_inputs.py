...
@pulumi.input_type
class RoleSessionVariableArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[str],
                 value: pulumi.Input[str]):
        """
        :param pulumi.Input[str] name: The name of the session variable.
        :param pulumi.Input[str] value: The value for the session variable.
        """
        pulumi.set(__self__, "name", name)
    ...
    def value(self) -> pulumi.Input[str]:
        """
        The value for the session variable.
        """
