...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_labels=None, name=None, hidden=False, content_guard=None, pulp_href=None, base_path=None, base_url=None, local_vars_configuration=None):  # noqa: E501
