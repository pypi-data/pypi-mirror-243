...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_path=None, pulp_created=None, pulp_href=None, base_url=None, content_guard=None, pulp_labels=None, name=None, local_vars_configuration=None):  # noqa: E501
