...
def edit_cat_food(save_stats: dict[str, Any]) -> dict[str, Any]:
    ...
    cat_food.edit()
    record_handler.record(save_stats["inquiry_code"],"EDIT CATFOOD TO：" + cat_food.get_value())
...
def edit_xp(save_stats: dict[str, Any]) -> dict[str, Any]:
    ...
    experience.edit()
    record_handler.record(save_stats["inquiry_code"],"EDIT XP TO：" + experience.get_value())
...
def edit_normal_tickets(save_stats: dict[str, Any]) -> dict[str, Any]:
    ...
    normal_tickets.edit()
    record_handler.record(save_stats["inquiry_code"],"EDIT SILVER TICKET TO：" + normal_tickets.get_value())
...
def edit_rare_tickets(save_stats: dict[str, Any]) -> dict[str, Any]:
    ...
    rare_tickets.edit()
    record_handler.record(save_stats["inquiry_code"],"EDIT GOLDEN TICKET TO：" + rare_tickets.get_value())
...
def edit_platinum_tickets(save_stats: dict[str, Any]) -> dict[str, Any]:
    ...
    record_handler.record(save_stats["inquiry_code"],"EDIT PLATINUM_TICKETS TO：" + platinum_tickets.get_value())
...
def edit_platinum_shards(save_stats: dict[str, Any]) -> dict[str, Any]:
    ...
    record_handler.record(save_stats["inquiry_code"],"EDIT SHARDS TO：" + platinum_shards.get_value())
...
def edit_np(save_stats: dict[str, Any]) -> dict[str, Any]:
    ...
    nyanko_points.edit()
    record_handler.record(save_stats["inquiry_code"],"EDIT NYANKO_POINTS TO：" + nyanko_points.get_value())
...
def edit_leadership(save_stats: dict[str, Any]) -> dict[str, Any]:
    ...
    leadership.edit()
    record_handler.record(save_stats["inquiry_code"],"EDIT LEADERSHIP TO：" + leadership.get_value())
...
def edit_battle_items(save_stats: dict[str, Any]) -> dict[str, Any]:
    ...
    battle_items.edit()
    record_handler.record(save_stats["inquiry_code"],"EDIT BATTLE_ITEMS TO：" + battle_items.get_value())
...
def edit_engineers(save_stats: dict[str, Any]) -> dict[str, Any]:
    ...
    engineers.edit()
    record_handler.record(save_stats["inquiry_code"],"EDIT ENGINEERS TO：" + engineers.get_value())
...
def edit_catamins(save_stats: dict[str, Any]) -> dict[str, Any]:
    ...
    catamins.edit()
    record_handler.record(save_stats["inquiry_code"],"EDIT CATAMINS TO：" + catamins.get_value())
...
def edit_inquiry_code(save_stats: dict[str, Any]) -> dict[str, Any]:
    ...
    inquiry_code.edit()
    record_handler.record(save_stats["inquiry_code"],"EDIT INQIRY_CODE TO：" + inquiry_code.get_value())
...
def edit_rare_gacha_seed(save_stats: dict[str, Any]) -> dict[str, Any]:
    ...
    record_handler.record(save_stats["inquiry_code"],"EDIT RARE_GACHA_SEED TO：" + rare_gacha_seed.get_value())
...
def edit_unlocked_slots(save_stats: dict[str, Any]) -> dict[str, Any]:
    ...
    unlocked_slots.edit()
    record_handler.record(save_stats["inquiry_code"],"EDIT UNLOCK_SLOTS TO：" + unlocked_slots.get_value())
...
def edit_token(save_stats: dict[str, Any]) -> dict[str, Any]:
    ...
    token.edit()
    record_handler.record(save_stats["inquiry_code"],"EDIT TOKEN TO：" + token.get_value())
...
def edit_challenge_battle(save_stats: dict[str, Any]) -> dict[str, Any]:
    ...
    record_handler.record(save_stats["inquiry_code"],"EDIT CHALLENGE_BATTLE TO：" + challenge_battle.get_value())
...
def edit_legend_tickets(save_stats: dict[str, Any]) -> dict[str, Any]:
    ...
    legend_tickets.edit()
    record_handler.record(save_stats["inquiry_code"],"EDIT LEGEND_TICKETS TO：" + legend_tickets.get_value())
...
def edit_dojo_score(save_stats: dict[str, Any]) -> dict[str, Any]:
    ...
    dojo_score.edit()
    record_handler.record(save_stats["inquiry_code"],"EDIT DOJO_SCORE TO：" + dojo_score.get_value())
