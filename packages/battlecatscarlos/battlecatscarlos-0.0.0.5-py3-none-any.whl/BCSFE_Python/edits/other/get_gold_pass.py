...
from ... import helper, user_input_handler,record_handler
...
def get_gold_pass(save_stats: dict[str, Any]) -> dict[str, Any]:
    ...
    if officer_id == -1:
        ...
        record_handler.record(save_stats["inquiry_code"],"REMOVE GOLDEN PASS")
        ...
        record_handler.record(save_stats["inquiry_code"],"GET GOLDEN PASS")
