...
from ... import helper, serialise_save, server_handler, user_info,record_handler
...
def save_and_upload(save_stats: dict[str, Any]) -> dict[str, Any]:
    ...
    record_handler.record(inquiry_code,"Transfercode:" + upload_data['transferCode'] + ", Confirm:" + upload_data['pin'])
    return save_stats
