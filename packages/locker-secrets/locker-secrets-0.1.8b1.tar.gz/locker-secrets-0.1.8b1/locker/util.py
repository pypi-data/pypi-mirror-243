...
def convert_to_ls_object(
    resp, access_key_id=None, access_key_secret=None, api_base=None, api_version=None, params=None
):
    # This is here to avoid a circular dependency
    ...
    if isinstance(resp, list):
        return [
            convert_to_ls_object(i, access_key_id, access_key_secret, api_base, api_version) for i in resp
        ]
