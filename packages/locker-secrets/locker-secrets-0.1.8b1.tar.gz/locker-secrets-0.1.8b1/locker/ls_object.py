...
class LSObject(dict):
    ...
    def __init__(self, id=None, access_key_id=None, access_key_secret=None, api_base=None, api_version=None,
        ...
        object.__setattr__(self, "access_key_secret", access_key_secret)
    ...
    @classmethod
    def construct_from(cls, values, access_key_id, access_key_secret, api_base=None, api_version=None,
                       last_response=None):
        instance = cls(
            values.get("id"),
    ...
    def refresh_from(self, values, access_key_id=None, access_key_secret=None, partial=False,
                     api_base=None, api_version=None, last_response=None):
        self.access_key_id = access_key_id or getattr(values, "access_key_id", None)
        self.access_key_secret = access_key_secret or getattr(values, "access_key_secret", None)
        ...
        for k, v in six.iteritems(values):
            super().__setitem__(
                k,
                util.convert_to_ls_object(v, access_key_id, access_key_secret, api_base, api_version),
            )
    ...
    def _call(self, cli_, access_key_id=None, access_key_secret=None, api_base=None, api_version=None,
        ...
        access_key_secret = access_key_secret or self.access_key_secret
