...
setup(
    ...
    package_data={'herostatus': ['logo.uni','sounds/burglaralarm.wav', 'sounds/caralarm.wav', 'sounds/hiphopalarm.wav', 'sounds/sirenalarm.wav', 'sounds/nuclearalarm.wav','sounds/strongbadalarm.wav']},
    entry_points = {
