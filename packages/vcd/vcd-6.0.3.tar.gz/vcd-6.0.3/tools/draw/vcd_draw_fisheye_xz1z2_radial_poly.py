...
from . import vcd_draw_pinhole_4cams
...
def draw_scene(vcd):
    ...
    imageParams = draw.Image.Params(_color_map=colorMap)
    ...
    drawerTopView1.add_images({"CAM_LEFT": img_left}, frame_num=0)
    topView1 = drawerTopView1.draw(frame_num=0)
