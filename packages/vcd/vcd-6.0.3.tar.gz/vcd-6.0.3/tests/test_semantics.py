...
class TestBasic(unittest.TestCase):
    ...
    def test_relations(self):
        ...
        self.assertEqual(
            vcd.data["openlabel"]["relations"]["0"]["frame_intervals"][0]["frame_start"],
            0,
        )
        self.assertEqual(
    ...
    def test_scene_KITTI_Tracking_3(self):
        ...
        # "In a city, being sunny, the ego-vehicle drives in the left lane of a single-way two-
        # lanes road, Two other cars drive in the right lane.
        #
        # When the cars pass the ego-vehicle, then the ego-vehicle changes to the right lane, and
        # then the ego-vehicle drives in the right lane."
        vcd.add_metadata_properties(
            {
                "cnl_text": "In a city, being sunny, the ego-vehicle drives in the left lane "
                "of a single-way two-lanes road, Two other cars drive in the right lane. "
                "When the cars pass the ego-vehicle, then the ego-vehicle changes to the "
                "right lane, and then the ego-vehicle drives in the right lane."
            }
        )
