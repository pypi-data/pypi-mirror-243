...
def utilities()->object:
    ...
    layout.append(make_component("Tab",'RESPONSES', abstract_browser_layout(section='responses',extra_component = make_component("Frame",'file options',ensure_nested_list([[file_options_frame]]), tooltip="Settings for file processing")),key=text_to_key(text='response tab'),**expandable(size=(50, 100)))),
