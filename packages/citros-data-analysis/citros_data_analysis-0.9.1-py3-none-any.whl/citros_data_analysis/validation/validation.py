...
class Validation():
    ...
    def std_bound_test(self, limits: Union[float, list] = 1.0, n_std: int = 3, nan_passed: bool = True, std_color: str = 'b', 
        ...
        if if_nan_sigma.any() and nan_passed:
            result.where(~nan_std, True, inplace = True) #change test results to True if the value was nan
    ...
    def _get_norm(self, norm_type = 'L2'):
        ...
        if norm_type == 'L2':
            ...
            print("error: can not recognize the norm type, the allowed types are 'L2' and 'Linf'")
            norm = None
        return norm
    ...
    def set_tests(self, test_method: dict = {'std_bound' : {'limits' : 1.0, 'n_std': 3, 'nan_passed': True},
        ...
        bound_tests = {'std_bound' : self.std_bound_test, 'mean': self.mean_test, 'sid': self.sid_test,  'std': self.std_test}
