...
def test_get_batch_name():
    ...
    assert citros1.get_batch_name() == 'new_batch_name', 'get_batch_name(): batch_name is not got right'
...
def test_get_repo_name():
    ...
    assert citros1.get_repo_name() == 'new_repo_name', 'get_repo_name(): repo_name is not got right'
...
def test_get_data_structure():
    assert isinstance(citros._download_data_structure(out_format = 'str')[0], list), 'get_data_structure(): returning type is not list'
    assert citros._download_data_structure(filter_by = {'topic': ['C']}, out_format = 'str')[0][0][2] == \
        '{\n  p: float,\n  t: int,\n  x: {\n    x_1: float,\n    x_2: float,\n    x_3: float\n  },\n  y: {\n    y_1: float,\n    y_2: float,\n    y_3: float\n  },\n  note: list,\n  time: float,\n  height: float\n}',\
        'topic().get_data_structure(): data structure is wrong'
    assert citros._download_data_structure(filter_by = {'topic': ['B']}, out_format = 'str')[0][0][2] == \
        '{\n  p: float,\n  t: int,\n  x: {\n    x_1: float,\n    x_2: float,\n    x_3: float\n  },\n  y: {\n    y_1: int,\n    y_2: int,\n    y_3: float\n  },\n  note: list,\n  time: float,\n  height: float\n}',\
