...
class IcebergHistoricalConnection(HistoricalConnectionBase):
    ...
    _catalog_name: Incomplete
    _namespace_name: Incomplete
    ...
    def _build_columns_from_schema(self, table_schema: TableSchema) -> list[IcebergTableColumn]: ...
    @staticmethod
    ...
    def _get_table_description(self, table_name: str) -> list[IcebergTableColumn]: ...
    def _get_latest_snapshot_id(self, table_name: str) -> int | None: ...
    def _execute(self, stm: str, values: dict[str, Any] | None = ...) -> DataFrame: ...
    def _get_table_name(self, address: Address) -> str: ...
    def _get_full_table_name(self, address: Address) -> str: ...
