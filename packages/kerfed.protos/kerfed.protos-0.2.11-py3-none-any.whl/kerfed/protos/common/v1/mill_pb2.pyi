...
class MillSettings(google.protobuf.message.Message):
    ...
    *before* any toolpathing and will return results that are a subset
    ...
    def HasField(self, field_name: typing_extensions.Literal["machine", b"machine", "preprocess", b"preprocess"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["detail", b"detail", "machine", b"machine", "material_id", b"material_id", "preprocess", b"preprocess", "return_gcode", b"return_gcode", "return_plan", b"return_plan", "return_volume", b"return_volume", "skip_fixture_collisions", b"skip_fixture_collisions", "skip_prune", b"skip_prune", "tools", b"tools"]) -> None: ...
