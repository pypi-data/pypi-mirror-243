...
def gltf(override_context: typing.Optional[
         ...
         *,
         ...
         import_webp_texture: typing.Optional[typing.Union[bool, typing.
                                                           Any]] = False):
    ''' Load a glTF 2.0 file :File: `addons/io_scene_gltf2/__init__.py\:1827 <https://projects.blender.org/blender/blender-addons/addons/io_scene_gltf2/__init__.py#L1827>`__
