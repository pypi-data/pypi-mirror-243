...
class Client:
    ...
    def add_source(self, source_name: str, embedding_model: Optional[str] = None, metadata_fields: Optional[Dict[str, str]] = None):
        ...
        return self._request("POST", "/sources/add", data)
    ...
    def retrieve(self, query: str, top_k: int, sources: List[str], agent: str = "off", metadata: str = "off", where: dict = None, llm: str = "gpt-3.5-turbo") -> dict:
        data = {
            'query': query,
            'top_k': top_k,
            'sources': sources,
