...
def test_get_service_items_dependent(endpoint_caller, auth_mock, netorca):
    """
    Test if `netorca.get_service_items_dependent()` works the same as `netorca.caller("service_items_dependent", "get")`
    """
    status_code = 200
    result = {"result": "success"}
    ...
    result_caller = endpoint_caller.caller("service_items_dependent", "get")
    result_get_service_items_dependent = netorca.get_service_items()

    assert result_caller == result_get_service_items_dependent
