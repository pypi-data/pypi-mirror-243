...
class OIDCProvider(BaseProvider):
    ...
    def initiate_login(cls, provider):
        ...
        try:
            ...
            # Attempt to register the client if not done yet, as there is no central
            # place where all clients are registered initially.
    ...
    def authenticate(cls, *, provider):
        ...
        try:
            token_data = get_oidc_client(provider).authorize_access_token()
