...
conf = {
    bstack11l1l1l_opy_ (u"ࠪࡥࡵࡶ࡟ࡢࡷࡷࡳࡲࡧࡴࡦࠩ๳"): False,
    bstack11l1l1l_opy_ (u"ࠫࡧࡹࡴࡢࡥ࡮ࡣࡸ࡫ࡳࡴ࡫ࡲࡲࠬ๴"): True,
}
class Config(object):
    instance = None
    def __init__(self):
        self._11lllll11l_opy_ = conf
    @classmethod
    ...
    def get_property(self, property_name):
        return self._11lllll11l_opy_.get(property_name, None)
    def bstack1lllll1ll_opy_(self, property_name, bstack11lllll111_opy_):
        self._11lllll11l_opy_[property_name] = bstack11lllll111_opy_