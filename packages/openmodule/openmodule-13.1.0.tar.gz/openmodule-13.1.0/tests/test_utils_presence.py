...
class PresenceMessageTest(TestCase):
    def test_enter_time_default(self):
        msg = PresenceEnterMessage.parse_obj(
            {"all_ids": {
                "lpr": [{"alternatives": [{"confidence": 0.20645777329012063, "plate": "K 510 BV"}],
                         "confidence": 0.20645777329012063,
                         "country": {"code": "A", "confidence": 0.9156234893865384, "state": "K"},
                         "id": "K 510 BV", "no_countrylogic_id": "K 510 BV", "track_id": 1700560556852837123,
                         "type": "lpr"}]},
                "enter_direction": "forward",
                "gateway": {"direction": "in", "gate": "einfahrt"}, "last_update": 1700560557.237208,
                "make_model": {"make": "UNKNOWN", "make_confidence": -1.0, "model": "UNKNOWN",
                               "model_confidence": -1.0},
                "medium": {
                    "lpr": {"alternatives": [{"confidence": 0.20645777329012063, "plate": "K 510 BV"}],
                            "changed": False,
                            "confidence": 0.20645777329012063,
                            "country": {"code": "A", "confidence": 0.9156234893865384, "state": "K"}, "id": "K 510 BV",
                            "no_countrylogic_id": "K 510 BV", "track_id": 1700560556852837123, "type": "lpr"}},
                "name": "enter-om_alpr_tracking_2", "present-area-name": "einfahrt", "source": "einfahrt",
                "timestamp": 1700560557.237477, "type": "enter", "vehicle_id": 1700560557231782099})
        self.assertEqual(datetime(2023, 11, 21, 9, 55, 57, 231782), msg.enter_time)

    def test_leave_time_default(self):
        msg = PresenceLeaveMessage.parse_obj(
            {"all_ids": {
                "lpr": [{"alternatives": [{"confidence": 0.20645777329012063, "plate": "K 510 BV"}],
                         "confidence": 0.20645777329012063,
                         "country": {"code": "A", "confidence": 0.9156234893865384, "state": "K"},
                         "id": "K 510 BV", "no_countrylogic_id": "K 510 BV", "track_id": 1700560556852837123,
                         "type": "lpr"}]},
                "enter_direction": "forward", "num-presents": 0,
                "gateway": {"direction": "in", "gate": "einfahrt"}, "last_update": 1700560557.237208,
                "make_model": {"make": "UNKNOWN", "make_confidence": -1.0, "model": "UNKNOWN",
                               "model_confidence": -1.0},
                "medium": {
                    "lpr": {"alternatives": [{"confidence": 0.20645777329012063, "plate": "K 510 BV"}],
                            ...
                            "country": {"code": "A", "confidence": 0.9156234893865384, "state": "K"}, "id": "K 510 BV",
                            "no_countrylogic_id": "K 510 BV", "track_id": 1700560556852837123, "type": "lpr"}},
                "name": "leave-om_alpr_tracking_2", "present-area-name": "einfahrt", "source": "einfahrt",
                "timestamp": 1700560557.231782, "type": "leave", "vehicle_id": 1700560557231782099})
