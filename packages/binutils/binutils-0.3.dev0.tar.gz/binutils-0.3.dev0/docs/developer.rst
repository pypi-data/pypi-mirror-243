...
.. warning::
   ...
   `binutils` package. If you just want to write code that uses it
...
In your terminal, change to the directory where you cloned `binutils`, and type::

    conda env create -f environment.yml

This will create a conda virtual environment called `binutils-dev` with all
the binutils dependencies and a few useful packages for development and
interaction.
...
* On Windows, in your Anaconda Prompt, run ``activate binutils-dev``
* On MacOSX and Linux, in your Terminal, run ``source activate binutils-dev``
...
type::
    ...
    conda list -n binutils-dev

If later you want to leave the `binutils-dev` virtual environment:
...
then on, all the binutils binaries and the library itself will be
...
.. _available on GitHub: https://gitlab.com/jdhp/binutils
...
.. _TODO.md: https://gitlab.com/jdhp/binutils/blob/master/TODO.md
