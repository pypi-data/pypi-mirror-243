        ...
        def test_cases() -> None:
            for test_case in expected_io:
                if len(test_case) == 2:
                    ...
                    parse_case(args=test_case[0], kwargs=test_case[1], expect=test_case[2])
...
def test(
    cases: Iterable[Case],
) -> Callable[[Callable[Param, RetType]], Callable[Param, RetType]]:  # returns a decorator [parametrized decorator implementation]
