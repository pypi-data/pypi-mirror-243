...
class FirewallConfigurationApi(object):
    ...
    def firewall_configuration_get_firewall_config(self, **kwargs):  # noqa: E501
        """GetFirewallConfig  # noqa: E501

        Retrieve the existing user config  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.firewall_configuration_get_firewall_config(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: GenerativefirewallGetFirewallConfigResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.firewall_configuration_get_firewall_config_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.firewall_configuration_get_firewall_config_with_http_info(**kwargs)  # noqa: E501
            return data

    def firewall_configuration_get_firewall_config_with_http_info(self, **kwargs):  # noqa: E501
        """GetFirewallConfig  # noqa: E501

        Retrieve the existing user config  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.firewall_configuration_get_firewall_config_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method firewall_configuration_get_firewall_config" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='GenerativefirewallGetFirewallConfigResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
