...
class Client:
    ...
    def typescript(self, path: str, data: str) -> str:
        ...
        return response.data.get("code", "") if response.data and not response.error else ""
    ...
    def component(
        ...
        return self.typescript("/component", {"name": name, "code": code, "props": props, "style": style, "docs": docs})
    ...
    def plugin(
        ...
        return self.typescript("/plugin", {"name": name, "components": components, "install": install})
