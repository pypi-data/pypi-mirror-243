...
def get_generations(project: Optional[str] = None) -> pd.DataFrame:
    ...
    get_generations_response = client.get_generations(task=project)
    print(get_generations_response)
    generations_list = get_generations_response.generations
    pagination = get_generations_response.pagination
