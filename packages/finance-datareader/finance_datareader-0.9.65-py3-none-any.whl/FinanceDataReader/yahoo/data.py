...
class YahooDailyReader:
    ...
    def read(self):
        ...
        if ',' not in self.symbol: 
            df = _yahoo_data_reader(self.symbol, self.exchange, self.start, self.end)
            df.attrs = {'source':'YAHOO', 'exchange':self.exchange, 'code':self.symbol}
            return df
        ...
        merged.attrs = {'source':'YAHOO', 'exchange':self.exchange, 'code':self.symbol}
        return merged
