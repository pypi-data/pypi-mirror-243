...
class BMProjectHandler():
    ...
    def __init__(self, project_name, project_type, output_folder=""):
        ...
        self.__project_path = os.getcwd() + '/' + output_folder + '/'
        self.__project_full_path = self.__project_path + self.__project_name + '/'
    ...
    def __apply_configurations(self):
        try:
            os.chdir(self.__project_full_path)
    ...
    def setup_project(self, project_specs):
        ...
        if (self.__project_type == "neuralnetwork"):
            try:
                nn_handler = NeuranNetworkHandler(self.__project_full_path, project_specs)
    ...
    def __build_firmware(self, oncloud=False):
        ...
        if oncloud == False:
            try:
                ...
                board_in_use = ''
                with open(self.__project_full_path+"/local.mk", 'r') as f:
                    for line in f:
                        if "BOARD" in line:
