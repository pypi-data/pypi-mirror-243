...
class Backend(BaseModel, RemoteObject):
    ...
    date_createds: Optional[datetime]
    ...
    remote_backend_id: Optional[str] = Field(
        default=None, alias=AliasChoices("remote_backend_id", "remoteBackendId")
    )
    remote_backend_status: Optional[str] = Field(
    ...
    def remote_status(self) -> str:
        ...
        return self.remote_backend_status
