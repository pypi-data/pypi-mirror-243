        ...
        if (
            ...
            for val in vals:
                ...
                if (
                    ...
                    and val != original_paths_by_outname[outname]
                ):
                    i = 0
                ...
                original_paths_by_outname[outname] = val
            ...
            if len(newvals) == 0:
                ...
                if not isinstance(vals[0], _File):
                    original_paths[name] = {newvals[0]: vals[0]}
            else:
                arguments[name] = newvals
                original_paths[name] = {
                    nv: v for nv, v in zip(newvals, vals) if not isinstance(v, _File)
                }
