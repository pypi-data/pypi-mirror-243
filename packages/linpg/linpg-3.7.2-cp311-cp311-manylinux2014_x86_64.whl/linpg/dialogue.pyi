...
class DialogNavigationWindow(AbstractFrame):
    ...
    def __update_node_pos(self, key: str = ..., offset_x: int = ..., offset_y: int = ...) -> int: ...
    def __draw_node(self, _surface: ImageSurface, key: str = ...) -> None: ...
...
class VisualNovelCharacterImageManager:
    ...
    @classmethod
    def __fade_in_characters_this_round(cls, _surface: ImageSurface, _start: int = ...) -> None: ...
    @classmethod
    def __fade_out_characters_last_round(cls, _surface: ImageSurface, _start: int = ...) -> None: ...
    @classmethod
...
class VisualNovelEditor(AbstractVisualNovelPlayer):
    ...
    def __make_connection(self, key1: str | None, key2: str | None, addNode: bool = ...) -> None: ...
    def __get_last_id(self) -> str: ...
    def __generate_a_new_recommended_key(self, index: int = ...) -> str: ...
