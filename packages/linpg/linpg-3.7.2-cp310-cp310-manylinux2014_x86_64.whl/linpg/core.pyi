...
class Square(GameObject2d):
    ...
    def draw_outline(self, _surface: ImageSurface, color: color_liked = ..., thickness: int = ..., radius: int = ..., offSet: tuple[int, int] = ...) -> None: ...
    def display(self, _surface: ImageSurface, offSet: tuple[int, int] = ...) -> None: ...
