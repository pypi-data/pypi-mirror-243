...
class AbstractTileMap(Rectangle, SurfaceWithLocalPos):
    ...
    def render(self, _surface: ImageSurface, screen_to_move_x: int = ..., screen_to_move_y: int = ...) -> tuple[int, int]: ...
    ...
    def find_path(self, start: tuple[int, int], goal: tuple[int, int], lenMax: int | None = ..., map2d: numpy.ndarray | None = ...) -> list[tuple[int, int]]: ...
