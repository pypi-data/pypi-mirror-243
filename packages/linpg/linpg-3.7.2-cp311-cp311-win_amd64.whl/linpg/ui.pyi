...
class SingleLineInputBox(AbstractInputBox):
    ...
    def _draw_content(self, _surface: ImageSurface, with_holder: bool = ...) -> None: ...
    _active: bool
    def display(self, _surface: ImageSurface, offSet: tuple[int, int] = ...) -> None: ...
...
class UiGenerator:
    ...
    @classmethod
    def __generate_container(cls, data: dict, custom_values: dict, max_width: int = ..., max_height: int = ...) -> GameObjectsDictContainer: ...
    @classmethod
    def __generate(cls, data: dict, custom_values: dict, max_width: int = ..., max_height: int = ...) -> GameObject2d: ...
    @classmethod
