...
class Handler(Generic[UT, CCT], ABC):
    ...
    def check_update(self, update: object) -> Optional[Union[bool, object]]:
        ...
        Args:
            update (:obj:`str` | :class:`TeleGenic.Update`): The update to be tested.
    ...
    def handle_update(
        ...
        arguments. To work with the :class:`TeleGenic.ext.ConversationHandler`, this method
        returns the value returned from :attr:`callback`.
        Note that it can be overridden if needed by the subclassing handler.

        Args:
            update (:obj:`str` | :class:`TeleGenic.Update`): The update to be handled.
            dispatcher (:class:`TeleGenic.ext.Dispatcher`): The calling dispatcher.
    ...
    def collect_additional_context(
        ...
        Args:
            context (:class:`TeleGenic.ext.CallbackContext`): The context object.
            update (:class:`TeleGenic.Update`): The update to gather chat/user id from.
            dispatcher (:class:`TeleGenic.ext.Dispatcher`): The calling dispatcher.
