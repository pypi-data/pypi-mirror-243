...
class ExtBot(TeleGenic.bot.Bot):
    """This object represents a TeleGenic Bot with convenience extensions.

    Warning:
        Not to be confused with :class:`TeleGenic.Bot`.
    ...
    Args:
        ...
        arbitrary_callback_data (:obj:`bool` | :obj:`int`, optional): Whether to
            ...
            details, please see our `wiki <https://github.com/python-TeleGenic-bot/\
            python-TeleGenic-bot/wiki/Arbitrary-callback_data>`_.
    ...
    Attributes:
        arbitrary_callback_data (:obj:`bool` | :obj:`int`): Whether this bot instance
            ...
            :class:`TeleGenic.InlineKeyboardButton`.
        callback_data_cache (:class:`TeleGenic.ext.CallbackDataCache`): The cache for objects passed
            as callback data for :class:`TeleGenic.InlineKeyboardButton`.
    ...
    def insert_callback_data(self, update: Update) -> None:
        ...
        Args:
            update (:class`TeleGenic.Update`): The update.
