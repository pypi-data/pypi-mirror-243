...
class Filters:
    ...
    class regex(MessageFilter):
        ...
        To get the groups and groupdict matched, see :attr:`TeleGenic.ext.CallbackContext.matches`.
    ...
    audio = _Audio()
    """Messages that contain :class:`TeleGenic.Audio`."""
...
officedocument.wordprocessingml.document")``.
    ...
    """Messages that contain :class:`TeleGenic.Animation`."""
    ...
    photo = _Photo()
    """Messages that contain :class:`TeleGenic.PhotoSize`."""
    ...
    sticker = _Sticker()
    """Messages that contain :class:`TeleGenic.Sticker`."""
    ...
    video = _Video()
    """Messages that contain :class:`TeleGenic.Video`."""
    ...
    voice = _Voice()
    """Messages that contain :class:`TeleGenic.Voice`."""
    ...
    """Messages that contain :class:`TeleGenic.VideoNote`."""
    ...
    contact = _Contact()
    """Messages that contain :class:`TeleGenic.Contact`."""
    ...
    location = _Location()
    """Messages that contain :class:`TeleGenic.Location`."""
    ...
    :attr:`attachment menu <TeleGenic.User.added_to_attachment_menu>` as
    :attr:`TeleGenic.Update.effective_user`.
    ...
    :attr:`TeleGenic Premium user <TeleGenic.User.is_premium>` as
    :attr:`TeleGenic.Update.effective_user`.
    ...
    venue = _Venue()
    """Messages that contain :class:`TeleGenic.Venue`."""
    ...
    class _StatusUpdate(UpdateFilter):
        ...
        """Messages that contain :attr:`TeleGenic.Message.new_chat_members`."""
        ...
        """Messages that contain :attr:`TeleGenic.Message.left_chat_member`."""
        ...
        """Messages that contain :attr:`TeleGenic.Message.new_chat_title`."""
        ...
        """Messages that contain :attr:`TeleGenic.Message.new_chat_photo`."""
        ...
        """Messages that contain :attr:`TeleGenic.Message.delete_chat_photo`."""
        ...
        """Messages that contain :attr:`TeleGenic.Message.group_chat_created`,
            :attr: `TeleGenic.Message.supergroup_chat_created` or
            :attr: `TeleGenic.Message.channel_chat_created`."""
        ...
        migrate = _Migrate()
        """Messages that contain :attr:`TeleGenic.Message.migrate_from_chat_id` or
            :attr:`TeleGenic.Message.migrate_to_chat_id`."""
        ...
        """Messages that contain :attr:`TeleGenic.Message.pinned_message`."""
        ...
        """Messages that contain :attr:`TeleGenic.Message.connected_website`."""
        ...
        """Messages that contain :attr:`TeleGenic.Message.proximity_alert_triggered`."""
        ...
        """Messages that contain :attr:`TeleGenic.Message.voice_chat_scheduled`."""
        ...
        """Messages that contain :attr:`TeleGenic.Message.voice_chat_started`."""
        ...
        """Messages that contain :attr:`TeleGenic.Message.voice_chat_ended`."""
        ...
        """Messages that contain :attr:`TeleGenic.Message.voice_chat_participants_invited`."""
        ...
        """Messages that contain :attr:`TeleGenic.Message.video_chat_scheduled`."""
        ...
        """Messages that contain :attr:`TeleGenic.Message.video_chat_started`."""
        ...
        """Messages that contain :attr:`TeleGenic.Message.video_chat_participants_invited`."""
        ...
        """Messages that contain :attr:`TeleGenic.Message.web_app_data`."""
        ...
        """Messages that contain :attr:`TeleGenic.Message.forum_topic_created`."""
        ...
        """Messages that contain :attr:`TeleGenic.Message.forum_topic_closed`."""
        ...
        """Messages that contain :attr:`TeleGenic.Message.forum_topic_reopened`."""
    ...
    Attributes:
        chat_created: Messages that contain
            :attr:`TeleGenic.Message.group_chat_created`,
            :attr:`TeleGenic.Message.supergroup_chat_created` or
            :attr:`TeleGenic.Message.channel_chat_created`.
        connected_website: Messages that contain
            :attr:`TeleGenic.Message.connected_website`.
        delete_chat_photo: Messages that contain
            :attr:`TeleGenic.Message.delete_chat_photo`.
        left_chat_member: Messages that contain
            :attr:`TeleGenic.Message.left_chat_member`.
        migrate: Messages that contain
            :attr:`TeleGenic.Message.migrate_to_chat_id` or
            :attr:`TeleGenic.Message.migrate_from_chat_id`.
        new_chat_members: Messages that contain
            :attr:`TeleGenic.Message.new_chat_members`.
        new_chat_photo: Messages that contain
            :attr:`TeleGenic.Message.new_chat_photo`.
        new_chat_title: Messages that contain
            :attr:`TeleGenic.Message.new_chat_title`.
        ...
        pinned_message: Messages that contain
            :attr:`TeleGenic.Message.pinned_message`.
        proximity_alert_triggered: Messages that contain
            :attr:`TeleGenic.Message.proximity_alert_triggered`.
        voice_chat_scheduled: Messages that contain
            :attr:`TeleGenic.Message.voice_chat_scheduled`.

            .. versionadded:: 13.5
            .. deprecated:: 13.12
        voice_chat_started: Messages that contain
            :attr:`TeleGenic.Message.voice_chat_started`.

            .. versionadded:: 13.4
            .. deprecated:: 13.12
        voice_chat_ended: Messages that contain
            :attr:`TeleGenic.Message.voice_chat_ended`.

            .. versionadded:: 13.4
            .. deprecated:: 13.12
        voice_chat_participants_invited: Messages that contain
            :attr:`TeleGenic.Message.voice_chat_participants_invited`.

            .. versionadded:: 13.4
            .. deprecated:: 13.12
        video_chat_scheduled: Messages that contain
            :attr:`TeleGenic.Message.video_chat_scheduled`.

            .. versionadded:: 13.12
        video_chat_started: Messages that contain
            :attr:`TeleGenic.Message.video_chat_started`.

            .. versionadded:: 13.12
        video_chat_ended: Messages that contain
            :attr:`TeleGenic.Message.video_chat_ended`.

            .. versionadded:: 13.12
        video_chat_participants_invited: Messages that contain
            :attr:`TeleGenic.Message.video_chat_participants_invited`.

            .. versionadded:: 13.12
        web_app_data: Messages that contain
            :attr:`TeleGenic.Message.web_app_data`.

            .. versionadded:: 13.12
        forum_topic_created: Messages that contain
            :attr:`TeleGenic.Message.forum_topic_created`.

            .. versionadded:: 13.15
        forum_topic_closed: Messages that contain
            :attr:`TeleGenic.Message.forum_topic_closed`.

            .. versionadded:: 13.15
        forum_topic_reopened: Messages that contain
            :attr:`TeleGenic.Message.forum_topic_reopened`.
    ...
    game = _Game()
    """Messages that contain :class:`TeleGenic.Game`."""

    class entity(MessageFilter):
        """
        Filters messages to only allow those which have a :class:`TeleGenic.MessageEntity`
    ...
    class caption_entity(MessageFilter):
        """
        Filters media messages to only allow those which have a :class:`TeleGenic.MessageEntity`
        where their `type` matches `entity_type`.
    ...
    Note:
        DEPRECATED. Use
        :attr:`TeleGenic.ext.Filters.chat_type.private` instead.
    """
    ...
    Note:
        DEPRECATED. Use
        :attr:`TeleGenic.ext.Filters.chat_type.groups` instead.
    """
    ...
    class user(_ChatUserBaseFilter):
        ...
        Args:
            user_id(:class:`TeleGenic.utils.types.SLT[int]`, optional):
                Which user ID(s) to allow through.
            username(:class:`TeleGenic.utils.types.SLT[str]`, optional):
    ...
    class via_bot(_ChatUserBaseFilter):
        ...
        Args:
            bot_id(:class:`TeleGenic.utils.types.SLT[int]`, optional):
    ...
    class chat(_ChatUserBaseFilter):
        ...
        Args:
            chat_id(:class:`TeleGenic.utils.types.SLT[int]`, optional):
    ...
    class forwarded_from(_ChatUserBaseFilter):
        ...
        or username(s) based on :attr:`TeleGenic.Message.forward_from` and
        :attr:`TeleGenic.Message.forward_from_chat`.
        ...
        Note:
            ...
            :attr:`TeleGenic.Message.forwarded_from` and
            :attr:`TeleGenic.Message.forwarded_from_chat` are :obj:`None`. However, this behaviour
            is undocumented and might be changed by TeleGenic.
    ...
    class sender_chat(_ChatUserBaseFilter):
        ...
        Note:
            ...
            group). Since v13.9, the field :attr:`TeleGenic.Message.is_automatic_forward` will be
    ...
    """Messages that contain :attr:`TeleGenic.Message.is_automatic_forward`.
    ...
    """Messages that contain :attr:`TeleGenic.Message.is_topic_message`.
    ...
    """Messages that contain :attr:`TeleGenic.Message.has_protected_content`.
    ...
    invoice = _Invoice()
    """Messages that contain :class:`TeleGenic.Invoice`."""
    ...
    """Messages that confirm a :class:`TeleGenic.SuccessfulPayment`."""
    ...
    """Messages that contain a :class:`TeleGenic.PassportData`"""
    ...
    poll = _Poll()
    """Messages that contain a :class:`TeleGenic.Poll`."""
    ...
    Args:
        update (:class:`TeleGenic.utils.types.SLT[int]`, optional):
    ...
    class language(MessageFilter):
        ...
        Note:
            According to official TeleGenic API documentation, not every single user has the
        ...
        Args:
            lang (:class:`TeleGenic.utils.types.SLT[str]`):
    ...
    """Messages that contain :meth:`TeleGenic.Message.effective_attachment`.
    ...
    Attributes:
        message: Updates with :attr:`TeleGenic.Update.message`
        edited_message: Updates with :attr:`TeleGenic.Update.edited_message`
        messages: Updates with either :attr:`TeleGenic.Update.message` or
            :attr:`TeleGenic.Update.edited_message`
        channel_post: Updates with :attr:`TeleGenic.Update.channel_post`
        edited_channel_post: Updates with
            :attr:`TeleGenic.Update.edited_channel_post`
        channel_posts: Updates with either :attr:`TeleGenic.Update.channel_post` or
            :attr:`TeleGenic.Update.edited_channel_post`
    """
