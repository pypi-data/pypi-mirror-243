...
from TeleGenic import MessageEntity, TelegramObject, User, constants
...
class PollOption(TelegramObject):
    ...
    """:const:`TeleGenic.constants.MAX_POLL_OPTION_LENGTH`"""
...
class PollAnswer(TelegramObject):
    ...
    Attributes:
        ...
        user (:class:`TeleGenic.User`): The user, who changed the answer to the poll.
...
class Poll(TelegramObject):
    ...
    Attributes:
        ...
        explanation_entities (List[:class:`TeleGenic.MessageEntity`]): Optional. Special entities
    ...
    def parse_explanation_entities(self, types: List[str] = None) -> Dict[MessageEntity, str]:
        ...
        Args:
            types (List[:obj:`str`], optional): List of ``MessageEntity`` types as strings. If the
                    ...
                    Defaults to :attr:`TeleGenic.MessageEntity.ALL_TYPES`.
    ...
    """:const:`TeleGenic.constants.POLL_REGULAR`"""
    QUIZ: ClassVar[str] = constants.POLL_QUIZ
    """:const:`TeleGenic.constants.POLL_QUIZ`"""
    MAX_QUESTION_LENGTH: ClassVar[int] = constants.MAX_POLL_QUESTION_LENGTH
    """:const:`TeleGenic.constants.MAX_POLL_QUESTION_LENGTH`"""
