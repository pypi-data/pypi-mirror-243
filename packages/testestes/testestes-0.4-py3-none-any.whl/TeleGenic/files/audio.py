...
from TeleGenic import PhotoSize, TelegramObject
...
class Audio(TelegramObject):
    """This object represents an audio file to be treated as music by the TeleGenic clients.
    ...
    Args:
        ...
        thumb (:class:`TeleGenic.PhotoSize`, optional): Thumbnail of the album cover to
