...
class LoginUrl(TelegramObject):
    ...
    authorize a user. Serves as a great replacement for the TeleGenic Login Widget when the user is
    coming from TeleGenic. All the user needs to do is tap/click a button and confirm that they want
    to log in. TeleGenic apps support these buttons as of version 5.7.
