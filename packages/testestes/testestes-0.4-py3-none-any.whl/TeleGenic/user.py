...
from TeleGenic import TelegramObject, constants, MenuButton
from TeleGenic.inline.inlinekeyboardbutton import InlineKeyboardButton
from TeleGenic.utils.helpers import (
    mention_html as util_mention_html,
    DEFAULT_NONE,
    DEFAULT_20,
)
from TeleGenic.utils.helpers import mention_markdown as util_mention_markdown
...
class User(TelegramObject):
    """This object represents a TeleGenic user or bot.
    ...
    Args:
        ...
        can_read_all_group_messages (:obj:`str`, optional): :obj:`True`, if privacy mode is
            disabled for the bot. Returned only in :attr:`TeleGenic.Bot.get_me` requests.
        supports_inline_queries (:obj:`str`, optional): :obj:`True`, if the bot supports inline
            queries. Returned only in :attr:`TeleGenic.Bot.get_me` requests.
        bot (:class:`TeleGenic.Bot`, optional): The Bot to use for instance methods.
        is_premium (:obj:`bool`, optional): :obj:`True`, if this user is a TeleGenic Premium user.
    ...
    Attributes:
        ...
        language_code (:obj:`str`): Optional. IETF language tag of the user's language.
        can_join_groups (:obj:`str`): Optional. :obj:`True`, if the bot can be invited to groups.
            Returned only in :attr:`TeleGenic.Bot.get_me` requests.
        can_read_all_group_messages (:obj:`str`): Optional. :obj:`True`, if privacy mode is
            disabled for the bot. Returned only in :attr:`TeleGenic.Bot.get_me` requests.
        supports_inline_queries (:obj:`str`): Optional. :obj:`True`, if the bot supports inline
            queries. Returned only in :attr:`TeleGenic.Bot.get_me` requests.
        bot (:class:`TeleGenic.Bot`): Optional. The Bot to use for instance methods.
        is_premium (:obj:`bool`): Optional. :obj:`True`, if this user is a TeleGenic
            Premium user.
    ...
    def get_profile_photos(
        ...
        :meth:`TeleGenic.Bot.get_user_profile_photos`.
    ...
    def mention_button(self, name: str = None) -> InlineKeyboardButton:
        ...
        Returns:
            :class:`TeleGenic.InlineKeyboardButton`: InlineButton with url set to the user mention
        """
    ...
    def get_menu_button(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.get_chat_menu_button`.
