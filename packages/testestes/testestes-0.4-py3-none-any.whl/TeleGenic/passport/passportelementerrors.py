...
class PassportElementError(TelegramObject):
    ...
    This object represents an error in the TeleGenic Passport element which was submitted that
    ...
    Args:
        ...
        type (:obj:`str`): The section of the user's TeleGenic Passport which has the error.
...
class PassportElementErrorDataField(PassportElementError):
    ...
    Args:
        type (:obj:`str`): The section of the user's TeleGenic Passport which has the error, one of
...
class PassportElementErrorFile(PassportElementError):
    ...
    Args:
        type (:obj:`str`): The section of the user's TeleGenic Passport which has the issue, one of
...
class PassportElementErrorTranslationFile(PassportElementError):
    ...
    Args:
        type (:obj:`str`): Type of element of the user's TeleGenic Passport which has the issue,
