...
from TeleGenic.forumtopic import ForumTopicClosed, ForumTopicCreated, ForumTopicReopened
...
from TeleGenic.utils.types import JSONDict, FileInput, ODVInput, DVInput
...
class Message(TelegramObject):
    ...
    Args:
        ...
        from_user (:class:`TeleGenic.User`, optional): Sender of the message; empty for messages
            sent to channels. For backward compatibility, this will contain a fake sender user in
            non-channel chats, if the message was sent on behalf of a chat.
        sender_chat (:class:`TeleGenic.Chat`, optional): Sender of the message, sent on behalf of a
        ...
        chat (:class:`TeleGenic.Chat`): Conversation the message belongs to.
        forward_from (:class:`TeleGenic.User`, optional): For forwarded messages, sender of
            the original message.
        forward_from_chat (:class:`TeleGenic.Chat`, optional): For messages forwarded from channels
        ...
        is_automatic_forward (:obj:`bool`, optional): :obj:`True`, if the message is a channel post
            ...
            .. versionadded:: 13.9
        reply_to_message (:class:`TeleGenic.Message`, optional): For replies, the original message.
        ...
        text (str, optional): For text messages, the actual UTF-8 text of the message, 0-4096
            characters. Also found as :attr:`TeleGenic.constants.MAX_MESSAGE_LENGTH`.
        entities (List[:class:`TeleGenic.MessageEntity`], optional): For text messages, special
        ...
        caption_entities (List[:class:`TeleGenic.MessageEntity`]): Optional. For Messages with a
        ...
        audio (:class:`TeleGenic.Audio`, optional): Message is an audio file, information
            about the file.
        document (:class:`TeleGenic.Document`, optional): Message is a general file, information
            about the file.
        animation (:class:`TeleGenic.Animation`, optional): Message is an animation, information
            about the animation. For backward compatibility, when this field is set, the document
            field will also be set.
        game (:class:`TeleGenic.Game`, optional): Message is a game, information about the game.
        photo (List[:class:`TeleGenic.PhotoSize`], optional): Message is a photo, available
            sizes of the photo.
        sticker (:class:`TeleGenic.Sticker`, optional): Message is a sticker, information
            about the sticker.
        video (:class:`TeleGenic.Video`, optional): Message is a video, information about the video.
        voice (:class:`TeleGenic.Voice`, optional): Message is a voice message, information about
            the file.
        video_note (:class:`TeleGenic.VideoNote`, optional): Message is a video note, information
            about the video message.
        new_chat_members (List[:class:`TeleGenic.User`], optional): New members that were added to
        ...
        contact (:class:`TeleGenic.Contact`, optional): Message is a shared contact, information
            about the contact.
        location (:class:`TeleGenic.Location`, optional): Message is a shared location, information
            about the location.
        venue (:class:`TeleGenic.Venue`, optional): Message is a venue, information about the venue.
            For backward compatibility, when this field is set, the location field will also be
            set.
        left_chat_member (:class:`TeleGenic.User`, optional): A member was removed from the group,
            information about them (this member may be the bot itself).
        new_chat_title (:obj:`str`, optional): A chat title was changed to this value.
        new_chat_photo (List[:class:`TeleGenic.PhotoSize`], optional): A chat photo was changed to
            this value.
        ...
        message_auto_delete_timer_changed (:class:`TeleGenic.MessageAutoDeleteTimerChanged`, \
        ...
        pinned_message (:class:`TeleGenic.Message`, optional): Specified message was pinned. Note
            that the Message object in this field will not contain further :attr:`reply_to_message`
            fields even if it is itself a reply.
        invoice (:class:`TeleGenic.Invoice`, optional): Message is an invoice for a payment,
            information about the invoice.
        successful_payment (:class:`TeleGenic.SuccessfulPayment`, optional): Message is a service
        ...
        passport_data (:class:`TeleGenic.PassportData`, optional): TeleGenic Passport data.
        poll (:class:`TeleGenic.Poll`, optional): Message is a native poll,
            information about the poll.
        dice (:class:`TeleGenic.Dice`, optional): Message is a dice with random value from 1 to 6.
        via_bot (:class:`TeleGenic.User`, optional): Message was sent through an inline bot.
        proximity_alert_triggered (:class:`TeleGenic.ProximityAlertTriggered`, optional): Service
            message. A user in the chat triggered another user's proximity alert while sharing
            Live Location.
        voice_chat_scheduled (:class:`TeleGenic.VoiceChatScheduled`, optional): Service message:
            voice chat scheduled.

            .. versionadded:: 13.5
            .. deprecated:: 13.12
        voice_chat_started (:class:`TeleGenic.VoiceChatStarted`, optional): Service message: voice
            chat started.

            .. versionadded:: 13.4
            .. deprecated:: 13.12
        voice_chat_ended (:class:`TeleGenic.VoiceChatEnded`, optional): Service message: voice chat
            ended.

            .. versionadded:: 13.4
            .. deprecated:: 13.12
        voice_chat_participants_invited (:class:`TeleGenic.VoiceChatParticipantsInvited` optional):
            Service message: new participants invited to a voice chat.

            .. versionadded:: 13.4
            .. deprecated:: 13.12
        video_chat_scheduled (:class:`TeleGenic.VideoChatScheduled`, optional): Service message:
            video chat scheduled.

            .. versionadded:: 13.12
        video_chat_started (:class:`TeleGenic.VideaChatStarted`, optional): Service message: video
            chat started.

            .. versionadded:: 13.12
        video_chat_ended (:class:`TeleGenic.VideaChatEnded`, optional): Service message: video chat
            ended.

            .. versionadded:: 13.12
        video_chat_participants_invited (:class:`TeleGenic.VideoChatParticipantsInvited` optional):
            Service message: new participants invited to a video chat.

            .. versionadded:: 13.12
        web_app_data (:class:`TeleGenic.WebAppData`, optional): Service message: data sent by a Web
            App.
            .. versionadded:: 13.12
        ...
        message_thread_id (:obj:`int`, optional): Unique identifier of a message thread to which
            ...
            .. versionadded:: 13.15
        forum_topic_created (:class:`TeleGenic.ForumTopicCreated`, optional): Service message:
            forum topic created

            .. versionadded:: 13.15
        forum_topic_closed (:class:`TeleGenic.ForumTopicClosed`, optional): Service message:
            forum topic closed

            .. versionadded:: 13.15
        forum_topic_reopened (:class:`TeleGenic.ForumTopicReopened`, optional): Service message:
    ...
    Attributes:
        ...
        chat (:class:`TeleGenic.Chat`): Conversation the message belongs to.
        forward_from (:class:`TeleGenic.User`): Optional. Sender of the original message.
        forward_from_chat (:class:`TeleGenic.Chat`): Optional. For messages forwarded from channels
            or from anonymous administrators, information about the original sender chat.
        ...
        entities (List[:class:`TeleGenic.MessageEntity`]): Optional. Special entities like
            ...
            properly.
        caption_entities (List[:class:`TeleGenic.MessageEntity`]): Optional. Special entities like
            ...
            to use properly.
        audio (:class:`TeleGenic.Audio`): Optional. Information about the file.
        document (:class:`TeleGenic.Document`): Optional. Information about the file.
        animation (:class:`TeleGenic.Animation`) Optional. Information about the file.
            For backward compatibility, when this field is set, the document field will also be
            set.
        game (:class:`TeleGenic.Game`): Optional. Information about the game.
        photo (List[:class:`TeleGenic.PhotoSize`]): Optional. Available sizes of the photo.
        sticker (:class:`TeleGenic.Sticker`): Optional. Information about the sticker.
        video (:class:`TeleGenic.Video`): Optional. Information about the video.
        voice (:class:`TeleGenic.Voice`): Optional. Information about the file.
        video_note (:class:`TeleGenic.VideoNote`): Optional. Information about the video message.
        new_chat_members (List[:class:`TeleGenic.User`]): Optional. Information about new members to
        ...
        caption (:obj:`str`): Optional. Caption for the document, photo or video, 0-1024
            characters.
        contact (:class:`TeleGenic.Contact`): Optional. Information about the contact.
        location (:class:`TeleGenic.Location`): Optional. Information about the location.
        venue (:class:`TeleGenic.Venue`): Optional. Information about the venue.
        left_chat_member (:class:`TeleGenic.User`): Optional. Information about the user that left
        ...
        pinned_message (:class:`TeleGenic.message`): Optional. Specified message was pinned.
        invoice (:class:`TeleGenic.Invoice`): Optional. Information about the invoice.
        successful_payment (:class:`TeleGenic.SuccessfulPayment`): Optional. Information about the
            payment.
        connected_website (:obj:`str`): Optional. The domain name of the website on which the user
            has logged in.
        ...
        poll (:class:`TeleGenic.Poll`): Optional. Message is a native poll,
            information about the poll.
        dice (:class:`TeleGenic.Dice`): Optional. Message is a dice.
        via_bot (:class:`TeleGenic.User`): Optional. Bot through which the message was sent.
        proximity_alert_triggered (:class:`TeleGenic.ProximityAlertTriggered`): Optional. Service
            message. A user in the chat triggered another user's proximity alert while sharing
            Live Location.
        voice_chat_scheduled (:class:`TeleGenic.VoiceChatScheduled`): Optional. Service message:
        ...
        video_chat_scheduled (:class:`TeleGenic.VideoChatScheduled`): Optional. Service message:
            ...
            .. versionadded:: 13.12
        video_chat_started (:class:`TeleGenic.VideoChatStarted`): Optional. Service message: video
            chat started.

            .. versionadded:: 13.12
        video_chat_ended (:class:`TeleGenic.VideoChatEnded`): Optional. Service message: video chat
            ended.
    ...
    def chat_id(self) -> int:
        """:obj:`int`: Shortcut for :attr:`TeleGenic.Chat.id` for :attr:`chat`."""
        return self.chat.id
    ...
    def effective_attachment(
        ...
        """
        :class:`TeleGenic.Audio`
            or :class:`TeleGenic.Contact`
            or :class:`TeleGenic.Document`
            or :class:`TeleGenic.Animation`
            or :class:`TeleGenic.Game`
            or :class:`TeleGenic.Invoice`
            or :class:`TeleGenic.Location`
            or List[:class:`TeleGenic.PhotoSize`]
            or :class:`TeleGenic.Sticker`
            or :class:`TeleGenic.SuccessfulPayment`
            or :class:`TeleGenic.Venue`
            or :class:`TeleGenic.Video`
            or :class:`TeleGenic.VideoNote`
            or :class:`TeleGenic.Voice`: The attachment that this message was sent with. May be
    ...
    def reply_text(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.send_message`.
        ...
        Returns:
            :class:`TeleGenic.Message`: On success, instance representing the message posted.
    ...
    def reply_markdown(
        ...
        Note:
            :attr:`TeleGenic.ParseMode.MARKDOWN` is a legacy mode, retained by TeleGenic for
    ...
    def reply_media_group(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.send_media_group`.
    ...
    def reply_photo(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.send_photo`.
    ...
    def reply_audio(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.send_audio`.
    ...
    def reply_document(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.send_document`.
    ...
    def reply_animation(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.send_animation`.
    ...
    def reply_sticker(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.send_sticker`.
    ...
    def reply_video(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.send_video`.
    ...
    def reply_video_note(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.send_video_note`.
    ...
    def reply_voice(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.send_voice`.
    ...
    def reply_location(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.send_location`.
    ...
    def reply_venue(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.send_venue`.
    ...
    def reply_contact(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.send_contact`.
    ...
    def reply_poll(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.send_poll`.
    ...
    def reply_dice(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.send_dice`.
    ...
    def reply_chat_action(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.send_chat_action`.
    ...
    def reply_game(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.send_game`.
    ...
    def reply_invoice(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.send_invoice`.
    ...
    def forward(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.forward_message`.
        ...
        Returns:
            :class:`TeleGenic.Message`: On success, instance representing the message forwarded.
    ...
    def copy(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.copy_message`.
    ...
    def edit_text(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.edit_message_text`.
    ...
    def edit_caption(
        ...
        :meth:`TeleGenic.Bot.edit_message_caption`.
    ...
    def edit_media(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.edit_message_media`.
    ...
    def edit_reply_markup(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.edit_message_reply_markup`.
    ...
    def edit_live_location(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.edit_message_live_location`.
    ...
    def stop_live_location(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.stop_message_live_location`.
    ...
    def set_game_score(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.set_game_score`.
    ...
    def get_game_high_scores(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.get_game_high_scores`.
    ...
    def delete(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.delete_message`.
    ...
    def stop_poll(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.stop_poll`.
    ...
    def pin(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.pin_chat_message`.
    ...
    def unpin(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.unpin_chat_message`.
    ...
    def edit_forum_topic(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.edit_forum_topic`.
    ...
    def close_forum_topic(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.close_forum_topic`.
    ...
    def reopen_forum_topic(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.reopen_forum_topic`.
    ...
    def delete_forum_topic(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.delete_forum_topic`.
    ...
    def unpin_all_forum_topic_messages(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.unpin_all_forum_topic_messages`.
    ...
    def parse_entity(self, entity: MessageEntity) -> str:
        """Returns the text from a given :class:`TeleGenic.MessageEntity`.

        Note:
            This method is present because TeleGenic calculates the offset and length in
            UTF-16 codepoint pairs, which some versions of Python don't handle automatically.
            (That is, you can't just slice ``Message.text`` with the offset and length.)

        Args:
            entity (:class:`TeleGenic.MessageEntity`): The entity to extract the text from. It must
    ...
    def parse_entities(self, types: List[str] = None) -> Dict[MessageEntity, str]:
        """
        Returns a :obj:`dict` that maps :class:`TeleGenic.MessageEntity` to :obj:`str`.
        It contains entities from this message filtered by their
        :attr:`TeleGenic.MessageEntity.type` attribute as the key, and the text that each entity
        ...
        Args:
            types (List[:obj:`str`], optional): List of :class:`TeleGenic.MessageEntity` types as
                ...
                in :class:`TeleGenic.MessageEntity`.

        Returns:
            Dict[:class:`TeleGenic.MessageEntity`, :obj:`str`]: A dictionary of entities mapped to
    ...
    def text_html_urled(self) -> str:
        ...
        This also formats :attr:`TeleGenic.MessageEntity.URL` as a hyperlink.
    ...
    def caption_html_urled(self) -> str:
        ...
        Use this if you want to retrieve the message caption with the caption entities formatted as
        HTML. This also formats :attr:`TeleGenic.MessageEntity.URL` as a hyperlink.
    ...
    def text_markdown(self) -> str:
        ...
        using :class:`TeleGenic.ParseMode.MARKDOWN`.
    ...
    def text_markdown_v2(self) -> str:
        """Creates an Markdown-formatted string from the markup entities found in the message
        using :class:`TeleGenic.ParseMode.MARKDOWN_V2`.
    ...
    def caption_markdown(self) -> str:
        ...
        caption using :class:`TeleGenic.ParseMode.MARKDOWN`.
    ...
    def caption_markdown_v2(self) -> str:
        """Creates an Markdown-formatted string from the markup entities found in the message's
        caption using :class:`TeleGenic.ParseMode.MARKDOWN_V2`.
    ...
    def caption_markdown_urled(self) -> str:
        ...
        Use this if you want to retrieve the message caption with the caption entities formatted as
        Markdown. This also formats :attr:`TeleGenic.MessageEntity.URL` as a hyperlink.
