...
class Dice(TelegramObject):
    ...
    Note:
        ...
        can be found at our `wiki <https://github.com/python-TeleGenic-bot/python-telegram-bot/\
        wiki/Code-snippets#map-a-slot-machine-dice-value-to-the-corresponding-symbols>`_.
        However, this behaviour is undocumented and might be changed by TeleGenic.
