...
from TeleGenic import TelegramObject, constants, WebAppInfo
...
class MenuButton(TelegramObject):
    ...
    * :class:`TeleGenic.MenuButtonCommands`
    * :class:`TeleGenic.MenuButtonWebApp`
    * :class:`TeleGenic.MenuButtonDefault`

    If a menu button other than :class:`TeleGenic.MenuButtonDefault` is set for a private chat,
    ...
    """:const:`TeleGenic.constants.MENU_BUTTON_COMMANDS`"""
    WEB_APP: ClassVar[str] = constants.MENU_BUTTON_WEB_APP
    """:const:`TeleGenic.constants.MENU_BUTTON_WEB_APP`"""
    DEFAULT: ClassVar[str] = constants.MENU_BUTTON_DEFAULT
    """:const:`TeleGenic.constants.MENU_BUTTON_DEFAULT`"""
...
class MenuButtonCommands(MenuButton):
    ...
    Attributes:
        type (:obj:`str`): :const:`TeleGenic.constants.MENU_BUTTON_COMMANDS`.
    """
...
class MenuButtonWebApp(MenuButton):
    ...
    Args:
        ...
        web_app (:class:`TeleGenic.WebAppInfo`): Description of the Web App that will be launched
            when the user presses the button. The Web App will be able to send an arbitrary
            message on behalf of the user using the method :meth:`~TeleGenic.Bot.answerWebAppQuery`.

    Attributes:
        type (:obj:`str`): :const:`TeleGenic.constants.MENU_BUTTON_WEB_APP`.
        text (:obj:`str`): Text of the button.
        web_app (:class:`TeleGenic.WebAppInfo`): Description of the Web App that will be launched
            when the user presses the button. The Web App will be able to send an arbitrary
            message on behalf of the user using the method :meth:`~TeleGenic.Bot.answerWebAppQuery`.
...
class MenuButtonDefault(MenuButton):
    ...
    Attributes:
        type (:obj:`str`): :const:`TeleGenic.constants.MENU_BUTTON_DEFAULT`.
    """
