...
from TeleGenic.utils.helpers import DEFAULT_NONE, parse_file_input
from TeleGenic.utils.types import FileInput, JSONDict, ODVInput


class InputMedia(TelegramObject):
    """Base class for TeleGenic InputMedia Objects.

    See :class:`TeleGenic.InputMediaAnimation`, :class:`TeleGenic.InputMediaAudio`,
    :class:`TeleGenic.InputMediaDocument`, :class:`TeleGenic.InputMediaPhoto` and
    :class:`TeleGenic.InputMediaVideo` for detailed use.
...
class InputMediaAnimation(InputMedia):
    ...
    Note:
        When using a :class:`TeleGenic.Animation` for the :attr:`media` attribute. It will take the
        width, height and duration from that video, unless otherwise specified with the optional
        arguments.

    Args:
        media (:obj:`str` | `filelike object` | :obj:`bytes` | :class:`pathlib.Path` | \
            :class:`TeleGenic.Animation`): File to send. Pass a
            file_id to send a file that exists on the TeleGenic servers (recommended), pass an HTTP
            URL for TeleGenic to get a file from the Internet. Lastly you can pass an existing
            :class:`TeleGenic.Animation` object to send.
    ...
    Attributes:
        ...
        media (:obj:`str` | :class:`TeleGenic.InputFile`): Animation to send.
        caption (:obj:`str`): Optional. Caption of the document to be sent.
        parse_mode (:obj:`str`): Optional. The parse mode to use for text formatting.
        caption_entities (List[:class:`TeleGenic.MessageEntity`]): Optional. List of special
            entities that appear in the caption.
        thumb (:class:`TeleGenic.InputFile`): Optional. Thumbnail of the file to send.
        width (:obj:`int`): Optional. Animation width.
        height (:obj:`int`): Optional. Animation height.
        duration (:obj:`int`): Optional. Animation duration.
...
class InputMediaPhoto(InputMedia):
    ...
    Args:
        media (:obj:`str` | `filelike object` | :obj:`bytes` | :class:`pathlib.Path` | \
            :class:`TeleGenic.PhotoSize`): File to send. Pass a
            file_id to send a file that exists on the TeleGenic servers (recommended), pass an HTTP
            URL for TeleGenic to get a file from the Internet. Lastly you can pass an existing
            :class:`TeleGenic.PhotoSize` object to send.
    ...
    Attributes:
        type (:obj:`str`): ``photo``.
        media (:obj:`str` | :class:`TeleGenic.InputFile`): Photo to send.
        caption (:obj:`str`): Optional. Caption of the document to be sent.
        parse_mode (:obj:`str`): Optional. The parse mode to use for text formatting.
        caption_entities (List[:class:`TeleGenic.MessageEntity`]): Optional. List of special
            entities that appear in the caption.
...
class InputMediaVideo(InputMedia):
    ...
    Note:
        *  When using a :class:`TeleGenic.Video` for the :attr:`media` attribute. It will take the
           width, height and duration from that video, unless otherwise specified with the optional
           arguments.
    ...
    Args:
        media (:obj:`str` | `filelike object` | :obj:`bytes` | :class:`pathlib.Path` | \
            :class:`TeleGenic.Video`): File to send. Pass a
            file_id to send a file that exists on the TeleGenic servers (recommended), pass an HTTP
            URL for TeleGenic to get a file from the Internet. Lastly you can pass an existing
            :class:`TeleGenic.Video` object to send.
    ...
    Attributes:
        type (:obj:`str`): ``video``.
        media (:obj:`str` | :class:`TeleGenic.InputFile`): Video file to send.
        caption (:obj:`str`): Optional. Caption of the document to be sent.
        parse_mode (:obj:`str`): Optional. The parse mode to use for text formatting.
        caption_entities (List[:class:`TeleGenic.MessageEntity`]): Optional. List of special
            entities that appear in the caption.
...
class InputMediaAudio(InputMedia):
    ...
    Note:
        When using a :class:`TeleGenic.Audio` for the :attr:`media` attribute. It will take the
    ...
    Args:
        media (:obj:`str` | `filelike object` | :obj:`bytes` | :class:`pathlib.Path` | \
            ...
            file_id to send a file that exists on the TeleGenic servers (recommended), pass an HTTP
            URL for TeleGenic to get a file from the Internet. Lastly you can pass an existing
            :class:`TeleGenic.Audio` object to send.
    ...
    Attributes:
        type (:obj:`str`): ``audio``.
        media (:obj:`str` | :class:`TeleGenic.InputFile`): Audio file to send.
        caption (:obj:`str`): Optional. Caption of the document to be sent.
        parse_mode (:obj:`str`): Optional. The parse mode to use for text formatting.
        caption_entities (List[:class:`TeleGenic.MessageEntity`]): Optional. List of special
            entities that appear in the caption.
...
class InputMediaDocument(InputMedia):
    ...
    Args:
        media (:obj:`str` | `filelike object` | :obj:`bytes` | :class:`pathlib.Path` | \
            :class:`TeleGenic.Document`): File to send. Pass a
            file_id to send a file that exists on the TeleGenic servers (recommended), pass an HTTP
            URL for TeleGenic to get a file from the Internet. Lastly you can pass an existing
            :class:`TeleGenic.Document` object to send.
    ...
    Attributes:
        ...
        media (:obj:`str` | :class:`TeleGenic.InputFile`): File to send.
        caption (:obj:`str`): Optional. Caption of the document to be sent.
        parse_mode (:obj:`str`): Optional. The parse mode to use for text formatting.
        caption_entities (List[:class:`TeleGenic.MessageEntity`]): Optional. List of special
            entities that appear in the caption.
