...
from TeleGenic import PhotoSize, TelegramObject, constants
...
class Sticker(TelegramObject):
    ...
    Args:
        ...
        premium_animation (:class:`TeleGenic.File`, optional): For premium regular stickers,
    ...
    """:const:`TeleGenic.constants.STICKER_REGULAR`

    .. versionadded:: 13.14
    """
    MASK: ClassVar[str] = constants.STICKER_MASK
    """:const:`TeleGenic.constants.STICKER_MASK`

    .. versionadded:: 13.14
    """
    CUSTOM_EMOJI: ClassVar[str] = constants.STICKER_CUSTOM_EMOJI
    """:const:`TeleGenic.constants.STICKER_CUSTOM_EMOJI`
...
class StickerSet(TelegramObject):
    ...
    Args:
        ...
        sticker_type (:obj:`str`, optional): Type of stickers in the set, currently one of
            :attr:`TeleGenic.Sticker.REGULAR`, :attr:`TeleGenic.Sticker.MASK`,
            :attr:`TeleGenic.Sticker.CUSTOM_EMOJI`.

            .. versionadded:: 13.14
        thumb (:class:`TeleGenic.PhotoSize`, optional): Sticker set thumbnail in the ``.WEBP``,
            ``.TGS``, or ``.WEBM`` format.
