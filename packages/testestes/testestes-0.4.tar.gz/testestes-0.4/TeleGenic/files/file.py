...
from TeleGenic import TelegramObject
from TeleGenic.passport.credentials import decrypt
from TeleGenic.utils.helpers import is_local_file

if TYPE_CHECKING:
    from TeleGenic import Bot, FileCredentials
...
class File(TelegramObject):
    ...
    link expires, a new one can be requested by calling :meth:`TeleGenic.Bot.get_file`.
    ...
    Note:
        ...
        * If you obtain an instance of this class from :attr:`TeleGenic.PassportFile.get_file`,
    ...
    Args:
        ...
        bot (:obj:`TeleGenic.Bot`, optional): Bot to use with shortcut method.
    ...
    def download(
        ...
        original filename as reported by TeleGenic. If the file has no filename, it the file ID will
