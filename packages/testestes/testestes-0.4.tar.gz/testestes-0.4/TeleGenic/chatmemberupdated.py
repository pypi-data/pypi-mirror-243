...
from TeleGenic import TelegramObject, User, Chat, ChatMember, ChatInviteLink
...
class ChatMemberUpdated(TelegramObject):
    ...
    Args:
        chat (:class:`TeleGenic.Chat`): Chat the user belongs to.
        from_user (:class:`TeleGenic.User`): Performer of the action, which resulted in the change.
        date (:class:`datetime.datetime`): Date the change was done in Unix time. Converted to
            :class:`datetime.datetime`.
        old_chat_member (:class:`TeleGenic.ChatMember`): Previous information about the chat member.
        new_chat_member (:class:`TeleGenic.ChatMember`): New information about the chat member.
        invite_link (:class:`TeleGenic.ChatInviteLink`, optional): Chat invite link, which was used
    ...
    def difference(
        ...
        Note:
            To determine, if the :attr:`TeleGenic.ChatMember.user` attribute has changed, *every*
