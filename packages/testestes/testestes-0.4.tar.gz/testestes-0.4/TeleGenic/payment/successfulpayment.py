...
from TeleGenic import OrderInfo, TelegramObject
...
class SuccessfulPayment(TelegramObject):
    ...
    considered equal, if their :attr:`TeleGenic_payment_charge_id` and
    ...
    Args:
        ...
        shipping_option_id (:obj:`str`, optional): Identifier of the shipping option chosen by the
            user.
        order_info (:class:`TeleGenic.OrderInfo`, optional): Order info provided by the user.
        TeleGenic_payment_charge_id (:obj:`str`): TeleGenic payment identifier.
