...
class Defaults:
    ...
    Parameters:
        ...
        timeout (:obj:`int` | :obj:`float`, optional): If this value is specified, use it as the
            ...
            Note:
                Will *not* be used for :meth:`TeleGenic.Bot.get_updates`!
    ...
    def parse_mode(self) -> Optional[str]:
        """:obj:`str`: Optional. Send Markdown or HTML, if you want TeleGenic apps to show
        bold, italic, fixed-width text or URLs in your bot's message.
        """
    ...
    def explanation_parse_mode(self) -> Optional[str]:
        ...
        the corresponding parameter of :meth:`TeleGenic.Bot.send_poll`.
        """
        return self._parse_mode
