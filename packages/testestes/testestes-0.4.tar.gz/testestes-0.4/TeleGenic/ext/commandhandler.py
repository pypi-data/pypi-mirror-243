...
class CommandHandler(Handler[Update, CCT]):
    ...
    Args:
        command (:class:`TeleGenic.utils.types.SLT[str]`):
            The command or list of commands this handler should listen for.
            Limitations are the same as described here https://core.TeleGenic.org/bots#commands
        ...
        filters (:class:`TeleGenic.ext.BaseFilter`, optional): A filter inheriting from
            :class:`TeleGenic.ext.filters.BaseFilter`. Standard filters can be found in
            :class:`TeleGenic.ext.filters.Filters`. Filters can be combined using bitwise
    ...
    Attributes:
        ...
        filters (:class:`TeleGenic.ext.BaseFilter`): Optional. Only allow updates with these
            Filters.
    ...
    def __init__(
        ...
        if allow_edited is not None:
            warnings.warn(
                ...
                'https://github.com/python-TeleGenic-bot/python-telegram-bot/wiki/Transition'
...
class PrefixHandler(CommandHandler):
    ...
    Args:
        prefix (:class:`TeleGenic.utils.types.SLT[str]`):
