...
class MessageHandler(Handler[Update, CCT]):
    """Handler class to handle TeleGenic messages. They might contain text, media or status updates.
    ...
    Args:
        filters (:class:`TeleGenic.ext.BaseFilter`, optional): A filter inheriting from
            ...
            :attr:`TeleGenic.ext.filters.Filters.update`. This defaults to all message_type updates
    ...
    Attributes:
        filters (:obj:`Filter`): Only allow updates with these Filters. See
            :mod:`TeleGenic.ext.filters` for a full list of all available filters.
