...
class InlineQueryHandler(Handler[Update, CCT]):
    """
    Handler class to handle TeleGenic inline queries. Optionally based on a regex. Read the
    ...
    Warning:
        ...
        * :attr:`TeleGenic.InlineQuery.chat_type` will not be set for inline queries from secret
    ...
    Args:
        ...
        pattern (:obj:`str` | :obj:`Pattern`, optional): Regex pattern. If not :obj:`None`,
            ``re.match`` is used on :attr:`TeleGenic.InlineQuery.query` to determine if an update
            should be handled by this handler.
        chat_types (List[:obj:`str`], optional): List of allowed chat types. If passed, will only
            handle inline queries with the appropriate :attr:`TeleGenic.InlineQuery.chat_type`.
    ...
    Attributes:
        ...
        pattern (:obj:`str` | :obj:`Pattern`): Optional. Regex pattern to test
            :attr:`TeleGenic.InlineQuery.query` against.
