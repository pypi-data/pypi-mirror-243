...
class JobQueue:
    ...
    Attributes:
        ...
        bot (:class:`TeleGenic.Bot`): The bot instance that should be passed to the jobs.
    ...
    def set_dispatcher(self, dispatcher: 'Dispatcher') -> None:
        ...
        :class:`TeleGenic.Bot` to the JobQueue, which is deprecated.

        Args:
            dispatcher (:class:`TeleGenic.ext.Dispatcher`): The dispatcher.
    ...
    def run_once(
        ...
        Args:
            callback (:obj:`callable`): The callback function that should be executed by the new
                ...
                ``context.job`` is the :class:`TeleGenic.ext.Job` instance. It can be used to access
        ...
        Returns:
            :class:`TeleGenic.ext.Job`: The new ``Job`` instance that has been added to the job
            queue.
...
class Job:
    """This class is a convenience wrapper for the jobs held in a :class:`TeleGenic.ext.JobQueue`.
    ...
    Note:
        * All attributes and instance methods of :attr:`job` are also directly available as
          attributes/methods of the corresponding :class:`TeleGenic.ext.Job` object.
        * Two instances of :class:`TeleGenic.ext.Job` are considered equal, if their corresponding
          ``job`` attributes have the same ``id``.
        * If :attr:`job` isn't passed on initialization, it must be set manually afterwards for
          this :class:`TeleGenic.ext.Job` to be useful.
    ...
    Args:
        callback (:obj:`callable`): The callback function that should be executed by the new job.
            ...
            a ``context.job`` is the :class:`TeleGenic.ext.Job` instance. It can be used to access
            its ``job.context`` or change it to a repeating job.
        context (:obj:`object`, optional): Additional data needed for the callback function. Can be
            accessed through ``job.context`` in the callback. Defaults to :obj:`None`.
        name (:obj:`str`, optional): The name of the new job. Defaults to ``callback.__name__``.
        job_queue (:class:`TeleGenic.ext.JobQueue`, optional): The ``JobQueue`` this job belongs to.
