...
class Promise:
    ...
    Args:
        ...
        update (:class:`TeleGenic.Update` | :obj:`object`, optional): The update this promise is
            associated with.
    ...
    def add_done_callback(self, callback: Callable) -> None:
        """
        Callback to be run when :class:`TeleGenic.ext.utils.promise.Promise` becomes done.
