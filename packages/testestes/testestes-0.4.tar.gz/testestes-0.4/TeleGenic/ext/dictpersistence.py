...
class DictPersistence(BasePersistence):
    ...
    Warning:
        :class:`DictPersistence` will try to replace :class:`TeleGenic.Bot` instances by
    ...
    def callback_data(self) -> Optional[CDCData]:
        """:class:`TeleGenic.ext.utils.types.CDCData`: The meta data on the stored callback data.
    ...
    def update_user_data(self, user_id: int, data: Dict) -> None:
        ...
        Args:
            ...
            data (:obj:`dict`): The :attr:`TeleGenic.ext.Dispatcher.user_data` ``[user_id]``.
        """
    ...
    def update_chat_data(self, chat_id: int, data: Dict) -> None:
        ...
        Args:
            ...
            data (:obj:`dict`): The :attr:`TeleGenic.ext.Dispatcher.chat_data` ``[chat_id]``.
        """
    ...
    def update_bot_data(self, data: Dict) -> None:
        ...
        Args:
            data (:obj:`dict`): The :attr:`TeleGenic.ext.Dispatcher.bot_data`.
        """
