...
try:
    import TeleGenic.vendor.ptb_urllib3.urllib3 as urllib3
    import TeleGenic.vendor.ptb_urllib3.urllib3.contrib.appengine as appengine
    from TeleGenic.vendor.ptb_urllib3.urllib3.connection import HTTPConnection
    from TeleGenic.vendor.ptb_urllib3.urllib3.fields import RequestField
    ...
    try:
        ...
        warnings.warn(
            'TeleGenic is using upstream urllib3. This is allowed but not '
            'supported by TeleGenic maintainers.'
        )
    except ImportError:
        warnings.warn(
...
from TeleGenic import InputFile, TelegramError
from TeleGenic.error import (
    BadRequest,
    ChatMigrated,
    Conflict,
    InvalidToken,
