...
from TeleGenic import ChatPhoto, TelegramObject, constants, MenuButton
from TeleGenic.utils.types import JSONDict, FileInput, ODVInput, DVInput
from TeleGenic.utils.deprecate import TelegramDeprecationWarning
...
class Chat(TelegramObject):
    ...
    Args:
        ...
        photo (:class:`TeleGenic.ChatPhoto`, optional): Chat photo.
            Returned only in :meth:`TeleGenic.Bot.get_chat`.
        bio (:obj:`str`, optional): Bio of the other party in a private chat. Returned only in
            :meth:`TeleGenic.Bot.get_chat`.
        has_private_forwards (:obj:`bool`, optional): :obj:`True`, if privacy settings of the other
            ...
            with the user. Returned only in :meth:`TeleGenic.Bot.get_chat`.

            .. versionadded:: 13.9
        description (:obj:`str`, optional): Description, for groups, supergroups and channel chats.
            Returned only in :meth:`TeleGenic.Bot.get_chat`.
        invite_link (:obj:`str`, optional): Primary invite link, for groups, supergroups and
            channel. Returned only in :meth:`TeleGenic.Bot.get_chat`.
        pinned_message (:class:`TeleGenic.Message`, optional): The most recent pinned message
            (by sending date). Returned only in :meth:`TeleGenic.Bot.get_chat`.
        permissions (:class:`TeleGenic.ChatPermissions`): Optional. Default chat member permissions,
            for groups and supergroups. Returned only in :meth:`TeleGenic.Bot.get_chat`.
        ...
        has_protected_content (:obj:`bool`, optional): :obj:`True`, if messages from the chat can't
            be forwarded to other chats. Returned only in :meth:`TeleGenic.Bot.get_chat`.
        ...
        can_set_sticker_set (:obj:`bool`, optional): :obj:`True`, if the bot can change group the
            sticker set. Returned only in :meth:`TeleGenic.Bot.get_chat`.
        linked_chat_id (:obj:`int`, optional): Unique identifier for the linked chat, i.e. the
            ...
            chats. Returned only in :meth:`TeleGenic.Bot.get_chat`.
        location (:class:`TeleGenic.ChatLocation`, optional): For supergroups, the location to which
            the supergroup is connected. Returned only in :meth:`TeleGenic.Bot.get_chat`.
        ...
        has_restricted_voice_and_video_messages (:obj:`bool`, optional): :obj:`True`, if the
            ...
            in the private chat. Returned only in :meth:`TeleGenic.Bot.get_chat`.
        ...
        active_usernames (List[:obj:`str`], optional):  If set, the list of all `active chat
            ...
            only in :meth:`TeleGenic.Bot.get_chat`.
    ...
    """:const:`TeleGenic.constants.CHAT_SENDER`

    .. versionadded:: 13.5
    """
    PRIVATE: ClassVar[str] = constants.CHAT_PRIVATE
    """:const:`TeleGenic.constants.CHAT_PRIVATE`"""
    GROUP: ClassVar[str] = constants.CHAT_GROUP
    """:const:`TeleGenic.constants.CHAT_GROUP`"""
    SUPERGROUP: ClassVar[str] = constants.CHAT_SUPERGROUP
    """:const:`TeleGenic.constants.CHAT_SUPERGROUP`"""
    CHANNEL: ClassVar[str] = constants.CHAT_CHANNEL
    """:const:`TeleGenic.constants.CHAT_CHANNEL`"""
    ...
    def __init__(
        ...
        **_kwargs: Any,
        ...
        # TODO: Remove (also from tests), when TeleGenic drops this completely
    ...
    def de_json(cls, data: Optional[JSONDict], bot: 'Bot') -> Optional['Chat']:
        """See :meth:`TeleGenic.telegramObject.de_json`."""
        ...
        from TeleGenic import Message  # pylint: disable=C0415
    ...
    def leave(self, timeout: ODVInput[float] = DEFAULT_NONE, api_kwargs: JSONDict = None) -> bool:
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.leave_chat`.
    ...
    def get_administrators(
        ...
        :meth:`TeleGenic.Bot.get_chat_administrators`.

        Returns:
            List[:class:`TeleGenic.ChatMember`]: A list of administrators in a chat. An Array of
            :class:`TeleGenic.ChatMember` objects that contains information about all
    ...
    def get_members_count(
        ...
        """
        Deprecated, use :func:`~TeleGenic.Chat.get_member_count` instead.
    ...
    def get_member_count(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.get_chat_member_count`.
    ...
    def get_member(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.get_chat_member`.
    ...
    def kick_member(
        ...
        """
        Deprecated, use :func:`~TeleGenic.Chat.ban_member` instead.
    ...
    def ban_member(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.ban_chat_member`.
    ...
    def ban_sender_chat(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.ban_chat_sender_chat`.
    ...
    def unban_sender_chat(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.unban_chat_sender_chat`.
    ...
    def unban_member(
        ...
        For the documentation of the arguments, please see :meth:`TeleGenic.Bot.unban_chat_member`.
    ...
    def promote_member(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.promote_chat_member`.
    ...
    def restrict_member(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.restrict_chat_member`.
    ...
    def set_permissions(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.set_chat_permissions`.
    ...
    def set_administrator_custom_title(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.set_chat_administrator_custom_title`.
    ...
    def pin_message(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.pin_chat_message`.
    ...
    def unpin_message(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.unpin_chat_message`.
    ...
    def unpin_all_messages(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.unpin_all_chat_messages`.
    ...
    def send_media_group(
        ...
        Returns:
            List[:class:`TeleGenic.Message`]: On success, instance representing the message posted.
    ...
    def export_invite_link(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.export_chat_invite_link`.
    ...
    def create_invite_link(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.create_chat_invite_link`.
    ...
    def edit_invite_link(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.edit_chat_invite_link`.

        .. versionadded:: 13.4

        .. versionchanged:: 13.8
           Edited signature according to the changes of :meth:`TeleGenic.Bot.edit_chat_invite_link`.
    ...
    def revoke_invite_link(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.revoke_chat_invite_link`.
    ...
    def set_menu_button(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.set_chat_menu_button`.
    ...
    def create_forum_topic(
        ...
        For the documentation of the arguments, please see
        :meth:`TeleGenic.Bot.create_forum_topic`.
