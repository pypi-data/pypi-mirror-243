...
from TeleGenic import TelegramObject, KeyboardButtonPollType, WebAppInfo
...
class KeyboardButton(TelegramObject):
    ...
    Note:
        ...
        * :attr:`web_app` option will only work in TeleGenic versions released after 16 April, 2022.
