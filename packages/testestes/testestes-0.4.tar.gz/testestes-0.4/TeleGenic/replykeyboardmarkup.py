...
from TeleGenic import KeyboardButton, ReplyMarkup
...
class ReplyKeyboardMarkup(ReplyMarkup):
    ...
    Args:
        keyboard (List[List[:obj:`str` | :class:`TeleGenic.KeyboardButton`]]): Array of button rows,
                each represented by an Array of :class:`TeleGenic.KeyboardButton` objects.
    ...
    Attributes:
        keyboard (List[List[:class:`TeleGenic.KeyboardButton` | :obj:`str`]]): Array of button rows.
        ...
        for row in keyboard:
            ...
            for button in row:
                if isinstance(button, KeyboardButton):
                    button_row.append(button)  # TeleGenic.KeyboardButton
                else:
    ...
    def from_button(
        ...
        **kwargs: object,
        ...
        Args:
            button (:class:`TeleGenic.KeyboardButton` | :obj:`str`): The button to use in
                the markup.
            resize_keyboard (:obj:`bool`, optional): Requests clients to resize the keyboard
    ...
    def from_row(
        ...
        **kwargs: object,
        ...
        Args:
            button_row (List[:class:`TeleGenic.KeyboardButton` | :obj:`str`]): The button to use in
                the markup.
            resize_keyboard (:obj:`bool`, optional): Requests clients to resize the keyboard
                vertically for optimal fit (e.g., make the keyboard smaller if there are just two
                rows of buttons). Defaults to :obj:`False`, in which case the custom keyboard is
    ...
    def from_column(
        ...
        **kwargs: object,
        ...
        Args:
            button_column (List[:class:`TeleGenic.KeyboardButton` | :obj:`str`]): The button to use
                in the markup.
            resize_keyboard (:obj:`bool`, optional): Requests clients to resize the keyboard
                vertically for optimal fit (e.g., make the keyboard smaller if there are just two
                rows of buttons). Defaults to :obj:`False`, in which case the custom keyboard is
