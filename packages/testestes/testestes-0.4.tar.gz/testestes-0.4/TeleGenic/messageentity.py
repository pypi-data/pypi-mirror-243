...
from TeleGenic import TelegramObject, User, constants
...
class MessageEntity(TelegramObject):
    ...
    Args:
        ...
        user (:class:`TeleGenic.User`, optional): For :attr:`TEXT_MENTION` only, the mentioned
             user.
        language (:obj:`str`, optional): For :attr:`PRE` only, the programming language of
         ...
         custom_emoji_id (:obj:`str`, optional): For :attr:`CUSTOM_EMOJI` only, unique identifier
            of the custom emoji. Use :meth:`TeleGenic.Bot.get_custom_emoji_stickers` to get full
    ...
    Attributes:
        ...
        user (:class:`TeleGenic.User`): Optional. The mentioned user.
