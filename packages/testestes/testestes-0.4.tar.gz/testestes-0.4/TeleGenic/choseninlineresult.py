...
from TeleGenic import Location, TelegramObject, User
...
class ChosenInlineResult(TelegramObject):
    ...
    Args:
        ...
        from_user (:class:`TeleGenic.User`): The user that chose the result.
    ...
    Attributes:
        result_id (:obj:`str`): The unique identifier for the result that was chosen.
        from_user (:class:`TeleGenic.User`): The user that chose the result.
        location (:class:`TeleGenic.Location`): Optional. Sender location.
