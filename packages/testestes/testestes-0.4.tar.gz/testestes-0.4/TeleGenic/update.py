...
from TeleGenic.poll import PollAnswer
from TeleGenic.utils.types import JSONDict

if TYPE_CHECKING:
    from TeleGenic import Bot, Chat, User  # noqa
...
class Update(TelegramObject):
    ...
    Args:
        update_id (:obj:`int`): The update's unique identifier. Update identifiers start from a
            ...
            sequentially.
        message (:class:`TeleGenic.Message`, optional): New incoming message of any kind - text,
            photo, sticker, etc.
        edited_message (:class:`TeleGenic.Message`, optional): New version of a message that is
            known to the bot and was edited.
        channel_post (:class:`TeleGenic.Message`, optional): New incoming channel post of any kind
            - text, photo, sticker, etc.
        edited_channel_post (:class:`TeleGenic.Message`, optional): New version of a channel post
            that is known to the bot and was edited.
        inline_query (:class:`TeleGenic.InlineQuery`, optional): New incoming inline query.
        chosen_inline_result (:class:`TeleGenic.ChosenInlineResult`, optional): The result of an
            inline query that was chosen by a user and sent to their chat partner.
        callback_query (:class:`TeleGenic.CallbackQuery`, optional): New incoming callback query.
        shipping_query (:class:`TeleGenic.ShippingQuery`, optional): New incoming shipping query.
            Only for invoices with flexible price.
        pre_checkout_query (:class:`TeleGenic.PreCheckoutQuery`, optional): New incoming
            pre-checkout query. Contains full information about checkout.
        poll (:class:`TeleGenic.Poll`, optional): New poll state. Bots receive only updates about
            stopped polls and polls, which are sent by the bot.
        poll_answer (:class:`TeleGenic.PollAnswer`, optional): A user changed their answer
            in a non-anonymous poll. Bots receive new votes only in polls that were sent
            by the bot itself.
        my_chat_member (:class:`TeleGenic.ChatMemberUpdated`, optional): The bot's chat member
            ...
            .. versionadded:: 13.4
        chat_member (:class:`TeleGenic.ChatMemberUpdated`, optional): A chat member's status was
            ...
            updates (see :meth:`TeleGenic.Bot.get_updates`, :meth:`TeleGenic.Bot.set_webhook`,
            :meth:`TeleGenic.ext.Updater.start_polling` and
            :meth:`TeleGenic.ext.Updater.start_webhook`).

            .. versionadded:: 13.4
        chat_join_request (:class:`TeleGenic.ChatJoinRequest`, optional): A request to join the
    ...
    Attributes:
        ...
        message (:class:`TeleGenic.Message`): Optional. New incoming message.
        edited_message (:class:`TeleGenic.Message`): Optional. New version of a message.
        channel_post (:class:`TeleGenic.Message`): Optional. New incoming channel post.
        edited_channel_post (:class:`TeleGenic.Message`): Optional. New version of a channel post.
        inline_query (:class:`TeleGenic.InlineQuery`): Optional. New incoming inline query.
        chosen_inline_result (:class:`TeleGenic.ChosenInlineResult`): Optional. The result of an
        ...
        pre_checkout_query (:class:`TeleGenic.PreCheckoutQuery`): Optional. New incoming
            pre-checkout query.
        poll (:class:`TeleGenic.Poll`): Optional. New poll state. Bots receive only updates
    ...
    """:const:`TeleGenic.constants.UPDATE_MESSAGE`

    .. versionadded:: 13.5"""
    EDITED_MESSAGE = constants.UPDATE_EDITED_MESSAGE
    """:const:`TeleGenic.constants.UPDATE_EDITED_MESSAGE`

    .. versionadded:: 13.5"""
    CHANNEL_POST = constants.UPDATE_CHANNEL_POST
    """:const:`TeleGenic.constants.UPDATE_CHANNEL_POST`

    .. versionadded:: 13.5"""
    EDITED_CHANNEL_POST = constants.UPDATE_EDITED_CHANNEL_POST
    """:const:`TeleGenic.constants.UPDATE_EDITED_CHANNEL_POST`

    .. versionadded:: 13.5"""
    INLINE_QUERY = constants.UPDATE_INLINE_QUERY
    """:const:`TeleGenic.constants.UPDATE_INLINE_QUERY`

    .. versionadded:: 13.5"""
    CHOSEN_INLINE_RESULT = constants.UPDATE_CHOSEN_INLINE_RESULT
    """:const:`TeleGenic.constants.UPDATE_CHOSEN_INLINE_RESULT`

    .. versionadded:: 13.5"""
    CALLBACK_QUERY = constants.UPDATE_CALLBACK_QUERY
    """:const:`TeleGenic.constants.UPDATE_CALLBACK_QUERY`

    .. versionadded:: 13.5"""
    SHIPPING_QUERY = constants.UPDATE_SHIPPING_QUERY
    """:const:`TeleGenic.constants.UPDATE_SHIPPING_QUERY`

    .. versionadded:: 13.5"""
    PRE_CHECKOUT_QUERY = constants.UPDATE_PRE_CHECKOUT_QUERY
    """:const:`TeleGenic.constants.UPDATE_PRE_CHECKOUT_QUERY`

    .. versionadded:: 13.5"""
    POLL = constants.UPDATE_POLL
    """:const:`TeleGenic.constants.UPDATE_POLL`

    .. versionadded:: 13.5"""
    POLL_ANSWER = constants.UPDATE_POLL_ANSWER
    """:const:`TeleGenic.constants.UPDATE_POLL_ANSWER`

    .. versionadded:: 13.5"""
    MY_CHAT_MEMBER = constants.UPDATE_MY_CHAT_MEMBER
    """:const:`TeleGenic.constants.UPDATE_MY_CHAT_MEMBER`

    .. versionadded:: 13.5"""
    CHAT_MEMBER = constants.UPDATE_CHAT_MEMBER
    """:const:`TeleGenic.constants.UPDATE_CHAT_MEMBER`

    .. versionadded:: 13.5"""
    CHAT_JOIN_REQUEST = constants.UPDATE_CHAT_JOIN_REQUEST
    """:const:`TeleGenic.constants.UPDATE_CHAT_JOIN_REQUEST`

    .. versionadded:: 13.8"""
    ALL_TYPES = constants.UPDATE_ALL_TYPES
    """:const:`TeleGenic.constants.UPDATE_ALL_TYPES`
    ...
    def effective_user(self) -> Optional['User']:
        """
        :class:`TeleGenic.User`: The user that sent this update, no matter what kind of update this
    ...
    def effective_chat(self) -> Optional['Chat']:
        """
        :class:`TeleGenic.Chat`: The chat that this update was sent in, no matter what kind of
    ...
    def effective_message(self) -> Optional[Message]:
        """
        :class:`TeleGenic.Message`: The message included in this update, no matter what kind of
            update this is. Will be :obj:`None` for :attr:`inline_query`,
            :attr:`chosen_inline_result`, :attr:`callback_query` from inline messages,
            ...
            :attr:`TeleGenic.ChatPermissions.can_invite_users` administrator right in the chat.
