...
from TeleGenic import TelegramError, TelegramObject
...
class EncryptedCredentials(TelegramObject):
    ...
    TeleGenic Passport Documentation for a complete description of the data decryption and
    ...
    Note:
        ...
        :obj:`TeleGenic.PassportData.decrypted_credentials`.

    Args:
        data (:class:`TeleGenic.Credentials` or :obj:`str`): Decrypted data with unique user's
    ...
    def decrypted_secret(self) -> str:
        ...
        if self._decrypted_secret is None:
            if not CRYPTO_INSTALLED:
                raise RuntimeError(
                    'To use TeleGenic Passports, PTB must be installed via `pip install '
                    'python-TeleGenic-bot[passport]`.'
                )
...
class SecureData(TelegramObject):
    ...
    Attributes:
        personal_details (:class:`TeleGenic.SecureValue`, optional): Credentials for encrypted
            personal details.
        passport (:class:`TeleGenic.SecureValue`, optional): Credentials for encrypted passport.
        internal_passport (:class:`TeleGenic.SecureValue`, optional): Credentials for encrypted
            internal passport.
        driver_license (:class:`TeleGenic.SecureValue`, optional): Credentials for encrypted
            driver license.
        identity_card (:class:`TeleGenic.SecureValue`, optional): Credentials for encrypted ID card
        address (:class:`TeleGenic.SecureValue`, optional): Credentials for encrypted
            residential address.
        utility_bill (:class:`TeleGenic.SecureValue`, optional): Credentials for encrypted
            utility bill.
        bank_statement (:class:`TeleGenic.SecureValue`, optional): Credentials for encrypted
            bank statement.
        rental_agreement (:class:`TeleGenic.SecureValue`, optional): Credentials for encrypted
            rental agreement.
        passport_registration (:class:`TeleGenic.SecureValue`, optional): Credentials for encrypted
            registration from internal passport.
        temporary_registration (:class:`TeleGenic.SecureValue`, optional): Credentials for encrypted
