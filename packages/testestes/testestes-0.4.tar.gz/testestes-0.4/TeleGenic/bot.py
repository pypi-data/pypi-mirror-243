...
"""This module contains an object that represents a TeleGenic Bot."""
...
from TeleGenic.constants import MAX_INLINE_QUERY_RESULTS
from TeleGenic.error import InvalidToken, TeleGenicError
from TeleGenic.forumtopic import ForumTopic
...
from TeleGenic.utils.types import FileInput, JSONDict, ODVInput, DVInput
...
class Bot(TelegramObject):
    """This object represents a TeleGenic Bot.
    ...
    Note:
        ...
        to the TeleGenic API. This can be used to access new features of the API before they were
    ...
    Args:
        ...
        base_url (:obj:`str`, optional): TeleGenic Bot API service URL.
        base_file_url (:obj:`str`, optional): TeleGenic Bot API file URL.
        request (:obj:`TeleGenic.utils.request.Request`, optional): Pre initialized
            :obj:`TeleGenic.utils.request.Request`.
        ...
        defaults (:class:`TeleGenic.ext.Defaults`, optional): An object containing default values to
            ...
            .. deprecated:: 13.6
               Passing :class:`TeleGenic.ext.Defaults` to :class:`TeleGenic.Bot` is deprecated. If
               you want to use :class:`TeleGenic.ext.Defaults`, please use
               :class:`TeleGenic.ext.ExtBot` instead.
    ...
    def __init__(
        ...
        self.api_key = self._validate_token(api_key)
        ...
        if self.defaults:
            warnings.warn(
                'Passing Defaults to TeleGenic.Bot is deprecated. Use TeleGenic.ext.ExtBot instead.',
        ...
        self.base_url = str(base_url) + str(self.api_key)
        self.base_file_url = str(base_file_url) + str(self.api_key)
        ...
        if private_key:
            if not CRYPTO_INSTALLED:
                raise RuntimeError(
                    'To use Telegram Passports, TeleGenic must be installed via `pip install '
    ...
    def _post(
        ...
        # Drop any None values because TeleGenic doesn't handle them well
    ...
    @staticmethod
    def _validate_token(api_key: str) -> str:
        """A very basic validation on token."""
        if any(x.isspace() for x in api_key):
            raise InvalidToken()

        left, sep, _right = api_key.partition(':')
    ...
    @property
    def bot(self) -> User:
        """:class:`TeleGenic.User`: User instance for the bot as returned by :meth:`get_me`."""
    ...
    def can_join_groups(self) -> bool:
        """:obj:`bool`: Bot's :attr:`TeleGenic.User.can_join_groups` attribute."""
        return self.bot.can_join_groups  # type: ignore

    @property
    def can_read_all_group_messages(self) -> bool:
        """:obj:`bool`: Bot's :attr:`TeleGenic.User.can_read_all_group_messages` attribute."""
        return self.bot.can_read_all_group_messages  # type: ignore

    @property
    def supports_inline_queries(self) -> bool:
        """:obj:`bool`: Bot's :attr:`TeleGenic.User.supports_inline_queries` attribute."""
    ...
    def get_me(self, timeout: ODVInput[float] = DEFAULT_NONE, api_kwargs: JSONDict = None) -> User:
        ...
        Returns:
            :class:`TeleGenic.User`: A :class:`TeleGenic.User` instance representing that bot if the
    ...
    def send_message(
        ...
        Args:
            ...
            parse_mode (:obj:`str`): Send Markdown or HTML, if you want TeleGenic apps to show bold,
                italic, fixed-width text or inline URLs in your bot's message. See the constants in
                :class:`TeleGenic.ParseMode` for the available modes.
            entities (List[:class:`TeleGenic.MessageEntity`], optional): List of special entities
            ...
            reply_markup (:class:`TeleGenic.ReplyMarkup`, optional): Additional interface options.
        ...
        Returns:
            :class:`TeleGenic.Message`: On success, the sent message is returned.
    ...
    def delete_message(
        ...
        limitations:
            ...
            - Bots granted :attr:`TeleGenic.ChatMember.can_post_messages` permissions can delete
              outgoing messages in channels.
            - If the bot is an administrator of a group, it can delete any message there.
            - If the bot has :attr:`TeleGenic.ChatMember.can_delete_messages` permission in a
    ...
    def forward_message(
        ...
        Note:
            ...
            some chats. Use the attributes :attr:`TeleGenic.Message.has_protected_content` and
            :attr:`TeleGenic.Chat.has_protected_content` to check this.
    ...
    def send_photo(
        ...
        Args:
            ...
            photo (:obj:`str` | `filelike object` | :obj:`bytes` | :class:`pathlib.Path` | \
                :class:`TeleGenic.PhotoSize`): Photo to send.
                Pass a file_id as String to send a photo that exists on the TeleGenic servers
                (recommended), pass an HTTP URL as a String for TeleGenic to get a photo from the
                Internet, or upload a new photo using multipart/form-data. Lastly you can pass
                an existing :class:`TeleGenic.PhotoSize` object to send.
            ...
            parse_mode (:obj:`str`, optional): Send Markdown or HTML, if you want TeleGenic apps to
                show bold, italic, fixed-width text or inline URLs in the media caption. See the
                constants in :class:`TeleGenic.ParseMode` for the available modes.
            ...
            allow_sending_without_reply (:obj:`bool`, optional): Pass :obj:`True`, if the message
                should be sent even if the specified replied-to message is not found.
            reply_markup (:class:`TeleGenic.ReplyMarkup`, optional): Additional interface options. A
    ...
    def send_audio(
        ...
        """
        Use this method to send audio files, if you want TeleGenic clients to display them in the
        ...
        Args:
            ...
            audio (:obj:`str` | `filelike object` | :obj:`bytes` | :class:`pathlib.Path` | \
                :class:`TeleGenic.Audio`): Audio file to send.
                Pass a file_id as String to send an audio file that exists on the TeleGenic servers
                (recommended), pass an HTTP URL as a String for TeleGenic to get an audio file from
                the Internet, or upload a new one using multipart/form-data. Lastly you can pass
                an existing :class:`TeleGenic.Audio` object to send.
    ...
    def send_document(
        ...
        Args:
            ...
            document (:obj:`str` | `filelike object` | :obj:`bytes` | :class:`pathlib.Path` | \
                :class:`TeleGenic.Document`): File to send.
                Pass a file_id as String to send a file that exists on the TeleGenic servers
                (recommended), pass an HTTP URL as a String for TeleGenic to get a file from the
                Internet, or upload a new one using multipart/form-data. Lastly you can pass
                an existing :class:`TeleGenic.Document` object to send.
    ...
    def send_sticker(
        ...
        Args:
            ...
            sticker (:obj:`str` | `filelike object` | :obj:`bytes` | :class:`pathlib.Path` | \
                :class:`TeleGenic.Sticker`): Sticker to send.
                Pass a file_id as String to send a file that exists on the TeleGenic servers
                (recommended), pass an HTTP URL as a String for TeleGenic to get a .webp file from
                the Internet, or upload a new one using multipart/form-data. Lastly you can pass
                an existing :class:`TeleGenic.Sticker` object to send.
    ...
    def send_video(
        ...
        """
        Use this method to send video files, TeleGenic clients support mp4 videos
        ...
        Note:
            * The video argument can be either a file_id, an URL or a file from disk
              ``open(filename, 'rb')``
            * ``thumb`` will be ignored for small video files, for which TeleGenic can easily
        ...
        Args:
            ...
            video (:obj:`str` | `filelike object` | :obj:`bytes` | :class:`pathlib.Path` | \
                :class:`TeleGenic.Video`): Video file to send.
                Pass a file_id as String to send an video file that exists on the TeleGenic servers
                (recommended), pass an HTTP URL as a String for TeleGenic to get an video file from
                the Internet, or upload a new one using multipart/form-data. Lastly you can pass
                an existing :class:`TeleGenic.Video` object to send.
    ...
    def send_video_note(
        ...
        """
        As of v.4.0, TeleGenic clients support rounded square mp4 videos of up to 1 minute long.
        ...
        Args:
            ...
            video_note (:obj:`str` | `filelike object` | :obj:`bytes` | :class:`pathlib.Path` | \
                :class:`TeleGenic.VideoNote`): Video note
                to send. Pass a file_id as String to send a video note that exists on the TeleGenic
                servers (recommended) or upload a new video using multipart/form-data. Or you can
                pass an existing :class:`TeleGenic.VideoNote` object to send. Sending video notes by
    ...
    def send_animation(
        ...
        Note:
            ``thumb`` will be ignored for small files, for which TeleGenic can easily
        ...
        Args:
            ...
            animation (:obj:`str` | `filelike object` | :obj:`bytes` | :class:`pathlib.Path` | \
                :class:`TeleGenic.Animation`): Animation to
                send. Pass a file_id as String to send an animation that exists on the TeleGenic
                servers (recommended), pass an HTTP URL as a String for TeleGenic to get an
                animation from the Internet, or upload a new animation using multipart/form-data.
                Lastly you can pass an existing :class:`TeleGenic.Animation` object to send.
    ...
    def send_voice(
        ...
        """
        Use this method to send audio files, if you want TeleGenic clients to display the file
        ...
        Args:
            ...
            voice (:obj:`str` | `filelike object` | :obj:`bytes` | :class:`pathlib.Path` | \
                :class:`TeleGenic.Voice`): Voice file to send.
                Pass a file_id as String to send an voice file that exists on the TeleGenic servers
                (recommended), pass an HTTP URL as a String for TeleGenic to get an voice file from
                the Internet, or upload a new one using multipart/form-data. Lastly you can pass
                an existing :class:`TeleGenic.Voice` object to send.
    ...
    def send_media_group(
        ...
        Args:
            chat_id (:obj:`int` | :obj:`str`): Unique identifier for the target chat or username
                of the target channel (in the format ``@channelusername``).
            media (List[:class:`TeleGenic.InputMediaAudio`, :class:`TeleGenic.InputMediaDocument`, \
                :class:`TeleGenic.InputMediaPhoto`, :class:`TeleGenic.InputMediaVideo`]): An array
        ...
        Returns:
            List[:class:`TeleGenic.Message`]: An array of the sent Messages.
    ...
    def send_location(
        ...
        Args:
            ...
            location (:class:`TeleGenic.Location`, optional): The location to send.
    ...
    def edit_message_live_location(
        ...
        (for inline bots). A location can be edited until its :attr:`TeleGenic.Location.live_period`
        ...
        Args:
            ...
            proximity_alert_radius (:obj:`int`, optional): Maximum distance for proximity alerts
                ...
                specified.
            reply_markup (:class:`TeleGenic.InlineKeyboardMarkup`, optional): A JSON-serialized
        ...
        Returns:
            :class:`TeleGenic.Message`: On success, if edited message is not an inline message, the
    ...
    def send_venue(
        ...
        Args:
            ...
            venue (:class:`TeleGenic.Venue`, optional): The venue to send.
            disable_notification (:obj:`bool`, optional): Sends the message silently. Users will
                receive a notification with no sound.
            protect_content (:obj:`bool`, optional): Protects the contents of the sent message from
                forwarding and saving.
    ...
    def send_contact(
        ...
        Args:
            ...
            vcard (:obj:`str`, optional): Additional data about the contact in the form of a vCard,
                0-2048 bytes.
            contact (:class:`TeleGenic.Contact`, optional): The contact to send.
            disable_notification (:obj:`bool`, optional): Sends the message silently. Users will
                receive a notification with no sound.
            protect_content (:obj:`bool`, optional): Protects the contents of the sent message from
                forwarding and saving.
    ...
    def send_chat_action(
        ...
        TeleGenic clients clear its typing status). TeleGenic only recommends using this method when
        a response from the bot will take a noticeable amount of time to arrive.

        Args:
            chat_id (:obj:`int` | :obj:`str`): Unique identifier for the target chat or username
                of the target channel (in the format ``@channelusername``).
            action(:class:`TeleGenic.ChatAction` | :obj:`str`): Type of action to broadcast. Choose
                one, depending on what the user is about to receive. For convenience look at the
                constants in :class:`TeleGenic.ChatAction`
            timeout (:obj:`int` | :obj:`float`, optional): If this value is specified, use it as
                the read timeout from the server (instead of the one specified during creation of
                the connection pool).
            api_kwargs (:obj:`dict`, optional): Arbitrary keyword arguments to be passed to the
    ...
    def answer_inline_query(
        ...
        Warning:
            ...
            calling this method directly, use the shortcut :meth:`TeleGenic.InlineQuery.answer` with
            ``auto_pagination=True``, which will take care of passing the correct value.

        Args:
            inline_query_id (:obj:`str`): Unique identifier for the answered query.
            results (List[:class:`TeleGenic.InlineQueryResult`] | Callable): A list of results for
                ...
                either a list of :class:`TeleGenic.InlineQueryResult` instances or :obj:`None` if
            ...
            current_offset (:obj:`str`, optional): The :attr:`TeleGenic.InlineQuery.offset` of
    ...
    def get_user_profile_photos(
        ...
        Returns:
            :class:`TeleGenic.UserProfilePhotos`
    ...
    def get_file(
        ...
        with :meth:`TeleGenic.File.download`. It is guaranteed that the link will be
        ...
        Args:
            file_id (:obj:`str` | :class:`TeleGenic.Animation` | :class:`TeleGenic.Audio` |         \
                     :class:`TeleGenic.ChatPhoto` | :class:`TeleGenic.Document` |                   \
                     :class:`TeleGenic.PhotoSize` | :class:`TeleGenic.Sticker` |                    \
                     :class:`TeleGenic.Video` | :class:`TeleGenic.VideoNote` |                      \
                     :class:`TeleGenic.Voice`):
    ...
    def kick_chat_member(
        ...
        """
        Deprecated, use :func:`~TeleGenic.Bot.ban_chat_member` instead.
    ...
    def edit_message_media(
        ...
        Args:
            ...
            inline_message_id (:obj:`str`, optional): Required if chat_id and message_id are not
                specified. Identifier of the inline message.
            media (:class:`TeleGenic.InputMedia`): An object for a new media content
                of the message.
            reply_markup (:class:`TeleGenic.InlineKeyboardMarkup`, optional): A JSON-serialized
                object for an inline keyboard.
            timeout (:obj:`int` | :obj:`float`, optional): If this value is specified, use it as
    ...
    def get_updates(
        ...
        Args:
            offset (:obj:`int`, optional): Identifier of the first update to be returned. Must be
                ...
                offset higher than its :attr:`TeleGenic.Update.update_id`. The negative offset can
            ...
            allowed_updates (List[:obj:`str`]), optional): A JSON-serialized list the types of
                ...
                See :class:`TeleGenic.Update` for a complete list of available update types.
                Specify an empty list to receive all updates except
                :attr:`TeleGenic.Update.chat_member` (default). If not specified, the previous
        ...
        Note:
            ...
            2. In order to avoid getting duplicate updates, recalculate offset after each
               server response.
            3. To take full advantage of this library take a look at :class:`TeleGenic.ext.Updater`

        Returns:
            List[:class:`TeleGenic.Update`]
    ...
    def set_webhook(
        ...
        Whenever there is an update for the bot, TeleGenic will send an HTTPS POST request to the
        specified url, containing a JSON-serialized Update. In case of an unsuccessful request,
        TeleGenic will give up after a reasonable amount of attempts.
        ...
        ``X-TeleGenic-Bot-Api-Secret-Token`` with the secret token as content.
        ...
        Args:
            ...
            drop_pending_updates (:obj:`bool`, optional): Pass :obj:`True` to drop all pending
             ...
             secret_token (:obj:`str`, optional): A secret token to be sent in a header
                ``X-TeleGenic-Bot-Api-Secret-Token`` in every webhook request, 1-256 characters.
    ...
    def get_chat_administrators(
        ...
        Returns:
            List[:class:`TeleGenic.ChatMember`]: On success, returns a list of ``ChatMember``
    ...
    def get_chat_members_count(
        ...
        """
        Deprecated, use :func:`~TeleGenic.Bot.get_chat_member_count` instead.
    ...
    def set_chat_sticker_set(
        ...
        admin rights. Use the field :attr:`TeleGenic.Chat.can_set_sticker_set` optionally returned
    ...
    def delete_chat_sticker_set(
        ...
        Use the field :attr:`TeleGenic.Chat.can_set_sticker_set` optionally returned in
    ...
    def get_webhook_info(
        ...
        :attr:`TeleGenic.WebhookInfo.url` field empty.
    ...
    def set_game_score(
        ...
        Returns:
            :class:`TeleGenic.Message`: The edited message, or if the message wasn't sent by the bot
            , :obj:`True`.

        Raises:
            :class:`TeleGenic.error.TeleGenicError`: If the new score is not greater than the user's
    ...
    def send_invoice(
        ...
        Args:
            ...
            prices (List[:class:`TeleGenic.LabeledPrice`)]: Price breakdown, a JSON-serialized list
            ...
            max_tip_amount (:obj:`int`, optional): The maximum accepted amount for tips in the
                ...
                `currencies.json <https://core.TeleGenic.org/bots/payments/currencies.json>`_, it
    ...
    def answer_shipping_query(  # pylint: disable=C0103
        ...
        specified, the Bot API will send an :class:`TeleGenic.Update` with a
        ...
        Args:
            ...
            shipping_options (List[:class:`TeleGenic.ShippingOption`]), optional]: Required if ok is
            ...
            error_message (:obj:`str`, optional): Required if ok is :obj:`False`. Error message in
                ...
                "Sorry, delivery to your desired address is unavailable"). TeleGenic will display
    ...
    def answer_pre_checkout_query(  # pylint: disable=C0103
        ...
        confirmation in the form of an :class:`TeleGenic.Update` with the field
        ...
        Args:
            ...
            error_message (:obj:`str`, optional): Required if ok is :obj:`False`. Error message
                ...
                different color or garment!"). TeleGenic will display this message to the user.
            timeout (:obj:`int` | :obj:`float`, optional): If this value is specified, use it as
                the read timeout from the server (instead of the one specified during creation of
                the connection pool).
            api_kwargs (:obj:`dict`, optional): Arbitrary keyword arguments to be passed to the
    ...
    def answer_web_app_query(
        ...
        Args:
            ...
            result (:class:`TeleGenic.InlineQueryResult`): An object describing the message to be
                sent.
            timeout (:obj:`int` | :obj:`float`, optional): If this value is specified, use it as
                the read timeout from the server (instead of the one specified during creation of
                the connection pool).
        ...
        Returns:
            :class:`TeleGenic.SentWebAppMessage`: On success, a sent
            :class:`TeleGenic.SentWebAppMessage` is returned.
    ...
    def restrict_chat_member(
        ...
        Note:
            ...
            single argument of type :class:`TeleGenic.ChatPermissions`. The old way of passing
        ...
        Args:
            ...
            until_date (:obj:`int` | :obj:`datetime.datetime`, optional): Date when restrictions
                ...
                For timezone naive :obj:`datetime.datetime` objects, the default timezone of the
                bot will be used.
            permissions (:class:`TeleGenic.ChatPermissions`): A JSON-serialized object for new user
                permissions.
            timeout (:obj:`int` | :obj:`float`, optional): If this value is specified, use it as
                the read timeout from the server (instead of the one specified during creation of
                the connection pool).
    ...
    def promote_chat_member(
        ...
        if can_delete_stories is not None:
            data['can_delete_stories'] =  can_edit_stories
    ...
    def set_chat_permissions(
        ...
        :attr:`TeleGenic.ChatMember.can_restrict_members` admin rights.

        Args:
            chat_id (:obj:`int` | :obj:`str`): Unique identifier for the target chat or username of
                the target supergroup (in the format `@supergroupusername`).
            permissions (:class:`TeleGenic.ChatPermissions`): New default chat permissions.
            timeout (:obj:`int` | :obj:`float`, optional): If this value is specified, use it as
                the read timeout from the server (instead of the one specified during creation of
                the connection pool).
            api_kwargs (:obj:`dict`, optional): Arbitrary keyword arguments to be passed to the
    ...
    def unpin_all_general_forum_topic_messages(
        ...
        *,
        ...
        :paramref:`~TeleGenic.ChatAdministratorRights.can_pin_messages` administrator rights in the
        supergroup.
    ...
    def create_chat_invite_link(
        ...
        Returns:
            :class:`TeleGenic.ChatInviteLink`
    ...
    def approve_chat_join_request(
        ...
        :attr:`TeleGenic.ChatPermissions.can_invite_users` administrator right.
    ...
    def pin_chat_message(
        ...
        and must have the :attr:`TeleGenic.ChatMember.can_pin_messages` admin right in a supergroup
        or :attr:`TeleGenic.ChatMember.can_edit_messages` admin right in a channel.
    ...
    def unpin_chat_message(
        ...
        chat is not a private chat, the bot must be an administrator in the chat for this to work
        and must have the :attr:`TeleGenic.ChatMember.can_pin_messages` admin right in a
        supergroup or :attr:`TeleGenic.ChatMember.can_edit_messages` admin right in a channel.
    ...
    def unpin_all_chat_messages(
        ...
        to work and must have the :attr:`TeleGenic.ChatMember.can_pin_messages` admin right in a
        supergroup or :attr:`TeleGenic.ChatMember.can_edit_messages` admin right in a channel.
    ...
    def upload_sticker_file(
        ...
        Returns:
            :class:`TeleGenic.File`: On success, the uploaded File is returned.
    ...
    def create_new_sticker_set(
        ...
        Args:
            ...
            png_sticker (:obj:`str` | `filelike object` | :obj:`bytes` | :class:`pathlib.Path`, \
                ...
                send a file that already exists on the TeleGenic servers, pass an HTTP URL as a
                String for TeleGenic to get a file from the Internet, or upload a new one
            ...
            contains_masks (:obj:`bool`, optional): Pass :obj:`True`, if a set of mask stickers
                should be created.
            mask_position (:class:`TeleGenic.MaskPosition`, optional): Position where the mask
                should be placed on faces.
            sticker_type (:obj:`str`, optional): Type of stickers in the set, pass
                :attr:`TeleGenic.Sticker.REGULAR` or :attr:`TeleGenic.Sticker.MASK`. Custom emoji
        ...
        Args:
            ...
            thumb (:obj:`str` | `filelike object` | :obj:`bytes` | :class:`pathlib.Path`, \
                ...
                **TGS** animation with the thumbnail up to 32 kilobytes in size; see
                ...
                already exists on the TeleGenic servers, pass an HTTP URL as a String for TeleGenic
    ...
    def set_passport_data_errors(
        ...
        """
        Informs a user that some of the TeleGenic Passport elements they provided contains errors.
    ...
    def send_poll(
        ...
        Args:
            ...
            type (:obj:`str`, optional): Poll type, :attr:`TeleGenic.Poll.QUIZ` or
                :attr:`TeleGenic.Poll.REGULAR`, defaults to :attr:`TeleGenic.Poll.REGULAR`.
            ...
            explanation_parse_mode (:obj:`str`, optional): Mode for parsing entities in the
                explanation. See the constants in :class:`TeleGenic.ParseMode` for the available
                modes.
            explanation_entities (List[:class:`TeleGenic.MessageEntity`], optional): List of special
                entities that appear in message text, which can be specified instead of
                :attr:`parse_mode`.
    ...
    def stop_poll(
        ...
        Returns:
            :class:`TeleGenic.Poll`: On success, the stopped Poll with the final results is
            returned.
    ...
    def get_my_default_administrator_rights(
        ...
        Returns:
            :class:`TeleGenic.ChatAdministratorRights`: On success.
    ...
    def set_my_default_administrator_rights(
        ...
        Args:
            rights (:obj:`TeleGenic.ChatAdministratorRights`, optional): A
                :obj:`TeleGenic.ChatAdministratorRights` object describing new default administrator
        ...
        Raises:
            :obj:`TeleGenic.error.TeleGenicError`
        """
        data: JSONDict = {}
    ...
    def get_my_commands(
        ...
        Args:
            ...
            api_kwargs (:obj:`dict`, optional): Arbitrary keyword arguments to be passed to the
                TeleGenic API.
            scope (:class:`TeleGenic.BotCommandScope`, optional): A JSON-serialized object,
                describing scope of users. Defaults to :class:`TeleGenic.BotCommandScopeDefault`.
        ...
        Returns:
            List[:class:`TeleGenic.BotCommand`]: On success, the commands set for the bot. An empty
    ...
    def set_my_commands(
        ...
        `TeleGenic docs <https://core.telegram.org/bots#commands>`_ for more details about bot
        commands.
        ...
        Args:
            ...
            scope (:class:`TeleGenic.BotCommandScope`, optional): A JSON-serialized object,
                ...
                :class:`TeleGenic.BotCommandScopeDefault`.
    ...
    def copy_message(
        ...
        Args:
            ...
            parse_mode (:obj:`str`, optional): Mode for parsing entities in the new caption. See
                the constants in :class:`TeleGenic.ParseMode` for the available modes.
            caption_entities (:class:`TeleGenic.utils.types.SLT[MessageEntity]`): List of special
        ...
        Returns:
            :class:`TeleGenic.MessageId`: On success
    ...
    def set_chat_menu_button(
        ...
        .. seealso:: :meth:`get_chat_menu_button`, :meth:`TeleGenic.Chat.set_menu_button`,
            :meth:`TeleGenic.User.set_menu_button`
        ...
        Args:
            ...
            menu_button (:class:`TeleGenic.MenuButton`, optional): An object for the new bot's menu
                button. Defaults to :class:`TeleGenic.MenuButtonDefault`.
            timeout (:obj:`int` | :obj:`float`, optional): If this value is specified, use it as
                the read timeout from the server (instead of the one specified during creation of
                the connection pool).
            api_kwargs (:obj:`dict`, optional): Arbitrary keyword arguments to be passed to the
    ...
    def get_chat_menu_button(
        ...
        .. seealso:: :meth:`set_chat_menu_button`, :meth:`TeleGenic.Chat.get_menu_button`,
            :meth:`TeleGenic.User.get_menu_button`
        ...
        Returns:
            :class:`TeleGenic.MenuButton`: On success, the current menu button is returned.
        """
        data = {}
        if chat_id is not None:
            data['chat_id'] = chat_id
    ...
    def create_invoice_link(
        ...
        Args:
            ...
            prices (List[:class:`TeleGenic.LabeledPrice`)]: Price breakdown, a list
                of components (e.g. product price, tax, discount, delivery cost, delivery tax,
                bonus, etc.).
            max_tip_amount (:obj:`int`, optional): The maximum accepted amount for tips in the
    ...
    def create_forum_topic(
        ...
        :attr:`~TeleGenic.ChatAdministratorRights.can_manage_topics` administrator rights.

        .. seealso:: :meth:`TeleGenic.Chat.create_forum_topic`,
        ...
        Args:
            ...
            icon_custom_emoji_id (:obj:`str`, optional): New unique identifier of the custom emoji
                shown as the topic icon. Use :meth:`~TeleGenic.Bot.get_forum_topic_icon_stickers`
    ...
    def edit_forum_topic(
        ...
        .. seealso:: :meth:`TeleGenic.Message.edit_forum_topic`,
            :meth:`TeleGenic.Chat.edit_forum_topic`,
        ...
        Args:
            ...
            icon_custom_emoji_id (:obj:`str`): New unique identifier of the custom emoji shown as
                the topic icon. Use :meth:`~TeleGenic.Bot.get_forum_topic_icon_stickers` to get all
    ...
    def close_forum_topic(
        ...
        .. seealso:: :meth:`TeleGenic.Message.close_forum_topic`,
            :meth:`TeleGenic.Chat.close_forum_topic`,
    ...
    def reopen_forum_topic(
        ...
        be an administrator in the chat for this to work and must have
        :meth:`~TeleGenic.ChatAdministratorRights.can_manage_topics` administrator rights,
        unless it is the creator of the topic.

        .. seealso:: :meth:`TeleGenic.Message.reopen_forum_topic`,
            :meth:`TeleGenic.Chat.reopen_forum_topic`,
    ...
    def delete_forum_topic(
        ...
        :meth:`~TeleGenic.ChatAdministratorRights.can_delete_messages` administrator rights.

        .. seealso:: :meth:`TeleGenic.Message.delete_forum_topic`,
            :meth:`TeleGenic.Chat.delete_forum_topic`,
    ...
    def unpin_all_forum_topic_messages(
        ...
        be an administrator in the chat for this to work and must have
        :meth:`~TeleGenic.ChatAdministratorRights.can_pin_messages` administrator rights
        in the supergroup.

        .. seealso:: :meth:`TeleGenic.Message.unpin_all_forum_topic_messages`,
            :meth:`TeleGenic.Chat.unpin_all_forum_topic_messages`,
