...
from TeleGenic import TelegramObject, WebAppInfo, CallbackGame, LoginUrl
...
class InlineKeyboardButton(TelegramObject):
    ...
    Note:
        ...
        * If your bot allows for arbitrary callback data, in keyboards returned in a response
          from TeleGenic, :attr:`callback_data` maybe be an instance of
          :class:`TeleGenic.ext.InvalidCallbackData`. This will be the case, if the data
        ...
        * Since Bot API 5.5, it's now allowed to mention users by their ID in inline keyboards.
          This will only work in TeleGenic versions released after December 7, 2021.
    ...
    Args:
        ...
        login_url (:class:`TeleGenic.LoginUrl`, optional): An ``HTTPS`` URL used to automatically
            authorize the user. Can be used as a replacement for the TeleGenic Login Widget.
        ...
        web_app (:obj:`TeleGenic.WebAppInfo`, optional): Description of the `Web App
            ...
            using the method :meth:`~TeleGenic.Bot.answer_web_app_query`. Available only in
        ...
        callback_game (:class:`TeleGenic.CallbackGame`, optional): Description of the game that will
