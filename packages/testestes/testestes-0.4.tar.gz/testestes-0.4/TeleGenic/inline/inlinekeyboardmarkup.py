...
from TeleGenic import InlineKeyboardButton, ReplyMarkup
...
class InlineKeyboardMarkup(ReplyMarkup):
    ...
    Args:
        inline_keyboard (List[List[:class:`TeleGenic.InlineKeyboardButton`]]): List of button rows,
    ...
    def from_button(cls, button: InlineKeyboardButton, **kwargs: object) -> 'InlineKeyboardMarkup':
        ...
        Args:
            button (:class:`TeleGenic.InlineKeyboardButton`): The button to use in the markup
            **kwargs (:obj:`dict`): Arbitrary keyword arguments.
    ...
    def from_row(
        ...
        Args:
            button_row (List[:class:`TeleGenic.InlineKeyboardButton`]): The button to use in the
                markup
            **kwargs (:obj:`dict`): Arbitrary keyword arguments.
    ...
    def from_column(
        ...
        Args:
            button_column (List[:class:`TeleGenic.InlineKeyboardButton`]): The button to use in the
                markup
            **kwargs (:obj:`dict`): Arbitrary keyword arguments.
