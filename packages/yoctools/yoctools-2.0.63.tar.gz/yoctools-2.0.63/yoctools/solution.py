...
def riscv_cpu_id(cpu):
    ...
    if a == 'rv32emc' or a == 'rv32ec' or a == 'rv32i' or a == 'rv32iac' \
        ...
        return 'rv32_16gpr'
    elif a == 'e906' or a == 'e906p' or a == 'e907' or a == 'e907p':
        return 'rv32_32gpr'
    elif a == 'e907f' or a == 'e907fp' or a == 'e906f' or a == 'e906fp':
        return 'rv32f_32gpr'
    elif a == 'e906fd' or a == 'e906fdp' or a == 'e907fd' or a == 'e907fdp':
        return 'rv32fd_32gpr'
    elif a == 'c906' or a == 'c908i':
        return 'rv64_32gpr'
    elif a == 'c906fd' or a == 'c906fdv' \
        or a == 'c908' or a == 'c908v' \
        or a == 'c910' or a == 'c910v2' \
        or a == 'c920' or a == 'c920v2' \
        or a == 'r910' or a == 'r920':
        return 'rv64fd_32gpr'
    else:
