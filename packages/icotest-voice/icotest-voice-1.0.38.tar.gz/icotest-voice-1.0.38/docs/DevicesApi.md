...
command = 'command_example' # str | the AT command to run (do not add \"AT+\", it will be done for you)
 ...
 **command** | **str**| the AT command to run (do not add \&quot;AT+\&quot;, it will be done for you) | 
