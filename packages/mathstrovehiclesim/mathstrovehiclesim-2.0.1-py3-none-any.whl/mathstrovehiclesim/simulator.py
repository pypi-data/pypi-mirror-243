        ...
        if self.show_landing_page:
            ...
            if self.running:
                ...
                if self.signs_finished:
                    ...
                    panel_background = pygame.transform.scale(panel_background, (mathstrovehiclesim.globals.STEMHACK_PARAMETER_PANEL_BLACK_RECT_WIDTH, mathstrovehiclesim.globals.STEMHACK_PARAMETER_PANEL_BLACK_RECT_HEIGHT))
                    ...
                    font = pygame.font.Font('freesansbold.ttf', mathstrovehiclesim.globals.STEMHACK_PANEL_FONT_SIZE)
                    text = font.render(f"MODEL SCORE: {self.model_accuracy_score:.2f}", True, mathstrovehiclesim.globals.BLACK)
                    ...
                    text = font.render(f"PREDICTED TYPE: {user_type}", True, mathstrovehiclesim.globals.BLACK)
                    ...
                    text = font.render(f"HOST SPEED: {self.host_vehicle.get_speed()}", True, mathstrovehiclesim.globals.BLACK)
                    ...
                    text = font.render(f"GIVEN ACTION: {user_action}", True, mathstrovehiclesim.globals.BLACK)
