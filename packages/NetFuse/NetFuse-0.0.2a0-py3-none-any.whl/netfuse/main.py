...
@click.option("-d", "--dry", required=False, is_flag=True, help="Dry run without updating file")
@click.option("-p", "--path", required=False, default=settings.etc_hosts, help="Path for the hosts file")
@click.option("-o", "--output", required=False, default=settings.etc_hosts, help="Output filename")
