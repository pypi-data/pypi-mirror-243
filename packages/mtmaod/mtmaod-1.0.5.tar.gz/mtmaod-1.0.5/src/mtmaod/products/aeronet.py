...
class LEVReader:
    ...
    def interp_aod_xxxtime(self, srcdata=None, objtime=None,  method="average", time_range=(-1800, 1800)):
        ...
        if (pd.api.types.is_datetime64_dtype(srcdata.index) or pd.api.types.is_datetime64tz_dtype(srcdata.index)) and "timestamp" not in srcdata.columns:
