...
class Plugin(ad.Plugin):
    ...
    def on_plugins_loaded(self, site):
        ...
        def url2html(ar, s, cmdname, mentions):
        ...
        def py2html(parser, s, cmdname, mentions):
        ...
        def show2html(ar, s, cmdname, mentions):
        ...
        if False:
            # letting site users execute arbitrary code is a security risk
            def eval2html(ar, s, cmdname, mentions):
