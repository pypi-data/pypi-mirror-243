...
class BotAddressbook:
    ...
    def __init__(self):
        ...
        """
        The __init__ function is called when the class is instantiated.
        It sets up the AddressBook object and assigns it to self.addressbook.
    ...
    def handle(self, command):
        ...
        try:
            if command == '1':
                ...
                if pattern:
                    self.addressbook.find_info(parameter, pattern)
                else:
                ...
                print(Fore.WHITE + f'  all names:  {", ".join(all_records)}')
                ...
                if name in all_records:
                    ...
                    self.addressbook.edit(name, parameter, new_value)
                else:
                    log('record not found')
                    print(Fore.RED + '  record not found')

            elif command == '5':
                print(self.addressbook.congratulate())

            elif command == '6':
                all_titles = []
                for key in self.addressbook:
                    all_titles.append(key['name'])
                print(Fore.WHITE + f'  all names:  {", ".join(all_titles)}')
                print(Fore.GREEN + '  enter the name for birthday')
                name = input(Fore.BLUE + '  >>>: ')
                if name:
                    self.addressbook.days_to_birthday(name)
                else:
                ...
                if file_name:
                    self.addressbook.save(file_name)
                ...
                file_name = input(Fore.BLUE + '  >>>: ').strip()
                if file_name:
                    self.addressbook.load(file_name)
...
def addressbook():
    ...
    if os.path.exists(f'{file_name}.bin'):
        addressbot.addressbook.load(file_name)
    else:
        addressbot.addressbook.save(file_name)
    ...
    def handle(self, command):
        ...
        try:
            ...
            if command == '1':
                ...
                self.notebook.find_note_by_word(word)

            elif command == '5':
                print(Fore.GREEN + '  enter the tag to find note')
                tag = input(Fore.BLUE + '  >>>: ')
                self.notebook.find_note_by_tag(tag)
                ...
                while True:
                    ...
                    clear_all = input(Fore.BLUE + '  >>>: ')
                    if clear_all == 'y':
                        self.notebook.clear_book()
                        print(Fore.RED + '  notebook cleared')
                ...
                if file_name:
                    ...
                    print(Fore.RED + f'  notebook {file_name} saved')
                else:
                ...
                if file_name:
                    ...
                    print(Fore.RED + f'  notebook {file_name} loaded')
                else:
                    print(Fore.RED + '  please enter file name')
